	agilex_hps u0 (
		...
		.h2f_lw_axi_clk       (_connected_to_h2f_lw_axi_clk_),       //   input,     width = 1,  h2f_lw_axi_clock.clk
		.h2f_lw_axi_rst_n     (_connected_to_h2f_lw_axi_rst_n_),     //   input,     width = 1,  h2f_lw_axi_reset.reset_n
		.h2f_lw_AWID          (_connected_to_h2f_lw_AWID_),          //  output,     width = 4, h2f_lw_axi_master.awid
		.h2f_lw_AWADDR        (_connected_to_h2f_lw_AWADDR_),        //  output,    width = 21,                  .awaddr
		.h2f_lw_AWLEN         (_connected_to_h2f_lw_AWLEN_),         //  output,     width = 8,                  .awlen
		.h2f_lw_AWSIZE        (_connected_to_h2f_lw_AWSIZE_),        //  output,     width = 3,                  .awsize
		.h2f_lw_AWBURST       (_connected_to_h2f_lw_AWBURST_),       //  output,     width = 2,                  .awburst
		.h2f_lw_AWLOCK        (_connected_to_h2f_lw_AWLOCK_),        //  output,     width = 1,                  .awlock
		.h2f_lw_AWCACHE       (_connected_to_h2f_lw_AWCACHE_),       //  output,     width = 4,                  .awcache
		.h2f_lw_AWPROT        (_connected_to_h2f_lw_AWPROT_),        //  output,     width = 3,                  .awprot
		.h2f_lw_AWVALID       (_connected_to_h2f_lw_AWVALID_),       //  output,     width = 1,                  .awvalid
		.h2f_lw_AWREADY       (_connected_to_h2f_lw_AWREADY_),       //   input,     width = 1,                  .awready
		.h2f_lw_WDATA         (_connected_to_h2f_lw_WDATA_),         //  output,    width = 32,                  .wdata
		.h2f_lw_WSTRB         (_connected_to_h2f_lw_WSTRB_),         //  output,     width = 4,                  .wstrb
		.h2f_lw_WLAST         (_connected_to_h2f_lw_WLAST_),         //  output,     width = 1,                  .wlast
		.h2f_lw_WVALID        (_connected_to_h2f_lw_WVALID_),        //  output,     width = 1,                  .wvalid
		.h2f_lw_WREADY        (_connected_to_h2f_lw_WREADY_),        //   input,     width = 1,                  .wready
		.h2f_lw_BID           (_connected_to_h2f_lw_BID_),           //   input,     width = 4,                  .bid
		.h2f_lw_BRESP         (_connected_to_h2f_lw_BRESP_),         //   input,     width = 2,                  .bresp
		.h2f_lw_BVALID        (_connected_to_h2f_lw_BVALID_),        //   input,     width = 1,                  .bvalid
		.h2f_lw_BREADY        (_connected_to_h2f_lw_BREADY_),        //  output,     width = 1,                  .bready
		.h2f_lw_ARID          (_connected_to_h2f_lw_ARID_),          //  output,     width = 4,                  .arid
		.h2f_lw_ARADDR        (_connected_to_h2f_lw_ARADDR_),        //  output,    width = 21,                  .araddr
		.h2f_lw_ARLEN         (_connected_to_h2f_lw_ARLEN_),         //  output,     width = 8,                  .arlen
		.h2f_lw_ARSIZE        (_connected_to_h2f_lw_ARSIZE_),        //  output,     width = 3,                  .arsize
		.h2f_lw_ARBURST       (_connected_to_h2f_lw_ARBURST_),       //  output,     width = 2,                  .arburst
		.h2f_lw_ARLOCK        (_connected_to_h2f_lw_ARLOCK_),        //  output,     width = 1,                  .arlock
		.h2f_lw_ARCACHE       (_connected_to_h2f_lw_ARCACHE_),       //  output,     width = 4,                  .arcache
		.h2f_lw_ARPROT        (_connected_to_h2f_lw_ARPROT_),        //  output,     width = 3,                  .arprot
		.h2f_lw_ARVALID       (_connected_to_h2f_lw_ARVALID_),       //  output,     width = 1,                  .arvalid
		.h2f_lw_ARREADY       (_connected_to_h2f_lw_ARREADY_),       //   input,     width = 1,                  .arready
		.h2f_lw_RID           (_connected_to_h2f_lw_RID_),           //   input,     width = 4,                  .rid
		.h2f_lw_RDATA         (_connected_to_h2f_lw_RDATA_),         //   input,    width = 32,                  .rdata
		.h2f_lw_RRESP         (_connected_to_h2f_lw_RRESP_),         //   input,     width = 2,                  .rresp
		.h2f_lw_RLAST         (_connected_to_h2f_lw_RLAST_),         //   input,     width = 1,                  .rlast
		.h2f_lw_RVALID        (_connected_to_h2f_lw_RVALID_),        //   input,     width = 1,                  .rvalid
		.h2f_lw_RREADY        (_connected_to_h2f_lw_RREADY_),        //  output,     width = 1,                  .rready
