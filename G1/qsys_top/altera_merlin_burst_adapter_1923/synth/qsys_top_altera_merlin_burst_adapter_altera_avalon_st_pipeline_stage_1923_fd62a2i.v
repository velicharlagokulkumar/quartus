// qsys_top_altera_merlin_burst_adapter_altera_avalon_st_pipeline_stage_1923_fd62a2i.v

// Generated using ACDS version 22.4 94

`timescale 1 ps / 1 ps
module qsys_top_altera_merlin_burst_adapter_altera_avalon_st_pipeline_stage_1923_fd62a2i #(
		parameter SYMBOLS_PER_BEAT = 1,
		parameter BITS_PER_SYMBOL  = 245,
		...
		input  wire [244:0] in_data,           //          .data
		input  wire [3:0]   in_channel,        //          .channel
		input  wire         out_ready,         //   source0.ready
		output wire         out_valid,         //          .valid
		output wire         out_startofpacket, //          .startofpacket
		output wire         out_endofpacket,   //          .endofpacket
		output wire [244:0] out_data,          //          .data
	...
	qsys_top_altera_avalon_st_pipeline_stage_1920_zterisq #(
		...
		.in_data           (in_data),           //   input,  width = 245,          .data
		...
		.out_data          (out_data),          //  output,  width = 245,          .data
