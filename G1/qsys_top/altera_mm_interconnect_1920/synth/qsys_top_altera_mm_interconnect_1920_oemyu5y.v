// qsys_top_altera_mm_interconnect_1920_oemyu5y.v
...
`timescale 1 ps / 1 ps
module qsys_top_altera_mm_interconnect_1920_oemyu5y (
		...
		output wire [15:0]  ocm_s1_address,                                                             //                                                               ocm_s1.address
	...
	wire    [1:0] router_src_channel;                                         // router:src_channel -> agilex_hps_h2f_axi_master_wr_limiter:cmd_sink_channel
	...
	wire    [1:0] agilex_hps_h2f_axi_master_wr_limiter_rsp_src_channel;       // agilex_hps_h2f_axi_master_wr_limiter:rsp_src_channel -> agilex_hps_h2f_axi_master_agent:write_rp_channel
	...
	wire    [1:0] router_001_src_channel;                                     // router_001:src_channel -> agilex_hps_h2f_axi_master_rd_limiter:cmd_sink_channel
	...
	wire    [1:0] agilex_hps_h2f_axi_master_rd_limiter_rsp_src_channel;       // agilex_hps_h2f_axi_master_rd_limiter:rsp_src_channel -> agilex_hps_h2f_axi_master_agent:read_rp_channel
	...
	wire          router_002_src_valid;                                       // router_002:src_valid -> ocm_s1_rsp_width_adapter:in_valid
	wire  [134:0] router_002_src_data;                                        // router_002:src_data -> ocm_s1_rsp_width_adapter:in_data
	wire          router_002_src_ready;                                       // ocm_s1_rsp_width_adapter:in_ready -> router_002:src_ready
	wire    [1:0] router_002_src_channel;                                     // router_002:src_channel -> ocm_s1_rsp_width_adapter:in_channel
	wire          router_002_src_startofpacket;                               // router_002:src_startofpacket -> ocm_s1_rsp_width_adapter:in_startofpacket
	wire          router_002_src_endofpacket;                                 // router_002:src_endofpacket -> ocm_s1_rsp_width_adapter:in_endofpacket
	wire          ocm_s1_rsp_width_adapter_src_valid;                         // ocm_s1_rsp_width_adapter:out_valid -> rsp_demux:sink_valid
	wire  [242:0] ocm_s1_rsp_width_adapter_src_data;                          // ocm_s1_rsp_width_adapter:out_data -> rsp_demux:sink_data
	wire          ocm_s1_rsp_width_adapter_src_ready;                         // rsp_demux:sink_ready -> ocm_s1_rsp_width_adapter:out_ready
	wire    [1:0] ocm_s1_rsp_width_adapter_src_channel;                       // ocm_s1_rsp_width_adapter:out_channel -> rsp_demux:sink_channel
	wire          ocm_s1_rsp_width_adapter_src_startofpacket;                 // ocm_s1_rsp_width_adapter:out_startofpacket -> rsp_demux:sink_startofpacket
	wire          ocm_s1_rsp_width_adapter_src_endofpacket;                   // ocm_s1_rsp_width_adapter:out_endofpacket -> rsp_demux:sink_endofpacket
	wire          router_003_src_valid;                                       // router_003:src_valid -> pio_0_s1_rsp_width_adapter:in_valid
	wire  [134:0] router_003_src_data;                                        // router_003:src_data -> pio_0_s1_rsp_width_adapter:in_data
	wire          router_003_src_ready;                                       // pio_0_s1_rsp_width_adapter:in_ready -> router_003:src_ready
	wire    [1:0] router_003_src_channel;                                     // router_003:src_channel -> pio_0_s1_rsp_width_adapter:in_channel
	wire          router_003_src_startofpacket;                               // router_003:src_startofpacket -> pio_0_s1_rsp_width_adapter:in_startofpacket
	wire          router_003_src_endofpacket;                                 // router_003:src_endofpacket -> pio_0_s1_rsp_width_adapter:in_endofpacket
	wire          pio_0_s1_rsp_width_adapter_src_valid;                       // pio_0_s1_rsp_width_adapter:out_valid -> rsp_demux_001:sink_valid
	wire  [242:0] pio_0_s1_rsp_width_adapter_src_data;                        // pio_0_s1_rsp_width_adapter:out_data -> rsp_demux_001:sink_data
	wire          pio_0_s1_rsp_width_adapter_src_ready;                       // rsp_demux_001:sink_ready -> pio_0_s1_rsp_width_adapter:out_ready
	wire    [1:0] pio_0_s1_rsp_width_adapter_src_channel;                     // pio_0_s1_rsp_width_adapter:out_channel -> rsp_demux_001:sink_channel
	...
	wire          cmd_mux_src_valid;                                          // cmd_mux:src_valid -> ocm_s1_cmd_width_adapter:in_valid
	wire  [242:0] cmd_mux_src_data;                                           // cmd_mux:src_data -> ocm_s1_cmd_width_adapter:in_data
	wire          cmd_mux_src_ready;                                          // ocm_s1_cmd_width_adapter:in_ready -> cmd_mux:src_ready
	wire    [1:0] cmd_mux_src_channel;                                        // cmd_mux:src_channel -> ocm_s1_cmd_width_adapter:in_channel
	wire          cmd_mux_src_startofpacket;                                  // cmd_mux:src_startofpacket -> ocm_s1_cmd_width_adapter:in_startofpacket
	wire          cmd_mux_src_endofpacket;                                    // cmd_mux:src_endofpacket -> ocm_s1_cmd_width_adapter:in_endofpacket
	wire          ocm_s1_cmd_width_adapter_src_valid;                         // ocm_s1_cmd_width_adapter:out_valid -> ocm_s1_burst_adapter:sink0_valid
	wire  [134:0] ocm_s1_cmd_width_adapter_src_data;                          // ocm_s1_cmd_width_adapter:out_data -> ocm_s1_burst_adapter:sink0_data
	wire          ocm_s1_cmd_width_adapter_src_ready;                         // ocm_s1_burst_adapter:sink0_ready -> ocm_s1_cmd_width_adapter:out_ready
	wire    [1:0] ocm_s1_cmd_width_adapter_src_channel;                       // ocm_s1_cmd_width_adapter:out_channel -> ocm_s1_burst_adapter:sink0_channel
	wire          ocm_s1_cmd_width_adapter_src_startofpacket;                 // ocm_s1_cmd_width_adapter:out_startofpacket -> ocm_s1_burst_adapter:sink0_startofpacket
	wire          ocm_s1_cmd_width_adapter_src_endofpacket;                   // ocm_s1_cmd_width_adapter:out_endofpacket -> ocm_s1_burst_adapter:sink0_endofpacket
	wire          cmd_mux_001_src_valid;                                      // cmd_mux_001:src_valid -> pio_0_s1_cmd_width_adapter:in_valid
	wire  [242:0] cmd_mux_001_src_data;                                       // cmd_mux_001:src_data -> pio_0_s1_cmd_width_adapter:in_data
	wire          cmd_mux_001_src_ready;                                      // pio_0_s1_cmd_width_adapter:in_ready -> cmd_mux_001:src_ready
	wire    [1:0] cmd_mux_001_src_channel;                                    // cmd_mux_001:src_channel -> pio_0_s1_cmd_width_adapter:in_channel
	...
	wire    [1:0] agilex_hps_h2f_axi_master_wr_limiter_cmd_src_channel;       // agilex_hps_h2f_axi_master_wr_limiter:cmd_src_channel -> limiter_pipeline:in_channel
	...
	wire  [242:0] limiter_pipeline_source0_data;                              // limiter_pipeline:out_data -> cmd_demux:sink_data
	...
	wire  [242:0] rsp_mux_src_data;                                           // rsp_mux:src_data -> limiter_pipeline_001:in_data
	...
	wire    [1:0] limiter_pipeline_001_source0_channel;                       // limiter_pipeline_001:out_channel -> agilex_hps_h2f_axi_master_wr_limiter:rsp_sink_channel
	...
	wire    [1:0] agilex_hps_h2f_axi_master_rd_limiter_cmd_src_channel;       // agilex_hps_h2f_axi_master_rd_limiter:cmd_src_channel -> limiter_pipeline_002:in_channel
	...
	wire  [242:0] limiter_pipeline_002_source0_data;                          // limiter_pipeline_002:out_data -> cmd_demux_001:sink_data
	...
	wire  [242:0] rsp_mux_001_src_data;                                       // rsp_mux_001:src_data -> limiter_pipeline_003:in_data
	...
	wire    [1:0] limiter_pipeline_003_source0_channel;                       // limiter_pipeline_003:out_channel -> agilex_hps_h2f_axi_master_rd_limiter:rsp_sink_channel
	...
	wire    [1:0] ocm_s1_burst_adapter_source0_channel;                       // ocm_s1_burst_adapter:source0_channel -> agent_pipeline:in_channel
	...
	wire    [1:0] agent_pipeline_source0_channel;                             // agent_pipeline:out_channel -> ocm_s1_agent:cp_channel
	...
	wire  [134:0] agent_pipeline_001_source0_data;                            // agent_pipeline_001:out_data -> router_002:sink_data
	...
	wire    [1:0] pio_0_s1_burst_adapter_source0_channel;                     // pio_0_s1_burst_adapter:source0_channel -> agent_pipeline_002:in_channel
	...
	wire    [1:0] agent_pipeline_002_source0_channel;                         // agent_pipeline_002:out_channel -> pio_0_s1_agent:cp_channel
	...
	wire  [134:0] agent_pipeline_003_source0_data;                            // agent_pipeline_003:out_data -> router_003:sink_data
	...
	wire  [242:0] cmd_demux_src0_data;                                        // cmd_demux:src0_data -> mux_pipeline:in_data
	...
	wire  [242:0] mux_pipeline_source0_data;                                  // mux_pipeline:out_data -> cmd_mux:sink0_data
	...
	wire  [242:0] cmd_demux_001_src0_data;                                    // cmd_demux_001:src0_data -> mux_pipeline_001:in_data
	...
	wire  [242:0] mux_pipeline_001_source0_data;                              // mux_pipeline_001:out_data -> cmd_mux:sink1_data
	...
	wire  [242:0] cmd_demux_src1_data;                                        // cmd_demux:src1_data -> mux_pipeline_002:in_data
	...
	wire  [242:0] mux_pipeline_002_source0_data;                              // mux_pipeline_002:out_data -> cmd_mux_001:sink0_data
	...
	wire  [242:0] cmd_demux_001_src1_data;                                    // cmd_demux_001:src1_data -> mux_pipeline_003:in_data
	...
	wire  [242:0] mux_pipeline_003_source0_data;                              // mux_pipeline_003:out_data -> cmd_mux_001:sink1_data
	...
	wire  [242:0] rsp_demux_src0_data;                                        // rsp_demux:src0_data -> mux_pipeline_004:in_data
	...
	wire  [242:0] mux_pipeline_004_source0_data;                              // mux_pipeline_004:out_data -> rsp_mux:sink0_data
	...
	wire  [242:0] rsp_demux_001_src0_data;                                    // rsp_demux_001:src0_data -> mux_pipeline_005:in_data
	...
	wire  [242:0] mux_pipeline_005_source0_data;                              // mux_pipeline_005:out_data -> rsp_mux:sink1_data
	...
	wire  [242:0] rsp_demux_src1_data;                                        // rsp_demux:src1_data -> mux_pipeline_006:in_data
	...
	wire  [242:0] mux_pipeline_006_source0_data;                              // mux_pipeline_006:out_data -> rsp_mux_001:sink0_data
	...
	wire  [242:0] rsp_demux_001_src1_data;                                    // rsp_demux_001:src1_data -> mux_pipeline_007:in_data
	...
	wire  [242:0] mux_pipeline_007_source0_data;                              // mux_pipeline_007:out_data -> rsp_mux_001:sink1_data
	...
	qsys_top_altera_merlin_slave_translator_191_x56fcki #(
		...
		.av_address             (ocm_s1_address),                                                             //  output,  width = 16,      avalon_anti_slave_0.address
	...
	qsys_top_altera_merlin_axi_master_ni_1941_dfsyzvi #(
		...
		.write_rp_channel       (agilex_hps_h2f_axi_master_wr_limiter_rsp_src_channel),                        //   input,    width = 2,                 .channel
		...
		.read_rp_channel        (agilex_hps_h2f_axi_master_rd_limiter_rsp_src_channel),                        //   input,    width = 2,                 .channel
	...
	qsys_top_altera_merlin_router_1921_kxgdrsa router (
	...
	qsys_top_altera_merlin_router_1921_kxgdrsa router_001 (
	...
	qsys_top_altera_merlin_router_1921_pov5cdi router_003 (
	...
	qsys_top_altera_merlin_traffic_limiter_191_6blplji #(
		...
		.cmd_src_channel        (agilex_hps_h2f_axi_master_wr_limiter_cmd_src_channel),                       //  output,    width = 2,          .channel
		...
		.rsp_src_channel        (agilex_hps_h2f_axi_master_wr_limiter_rsp_src_channel),                       //  output,    width = 2,          .channel
	...
	qsys_top_altera_merlin_traffic_limiter_191_6blplji #(
		...
		.cmd_src_channel        (agilex_hps_h2f_axi_master_rd_limiter_cmd_src_channel),                       //  output,    width = 2,          .channel
		...
		.rsp_sink_channel       (limiter_pipeline_003_source0_channel),                                       //   input,    width = 2,          .channel
		...
		.rsp_src_channel        (agilex_hps_h2f_axi_master_rd_limiter_rsp_src_channel),                       //  output,    width = 2,          .channel
	...
	qsys_top_altera_merlin_burst_adapter_1923_dxqle7a #(
		...
		.sink0_valid           (ocm_s1_cmd_width_adapter_src_valid),                                         //   input,    width = 1,     sink0.valid
		.sink0_data            (ocm_s1_cmd_width_adapter_src_data),                                          //   input,  width = 135,          .data
		.sink0_channel         (ocm_s1_cmd_width_adapter_src_channel),                                       //   input,    width = 2,          .channel
		.sink0_startofpacket   (ocm_s1_cmd_width_adapter_src_startofpacket),                                 //   input,    width = 1,          .startofpacket
		.sink0_endofpacket     (ocm_s1_cmd_width_adapter_src_endofpacket),                                   //   input,    width = 1,          .endofpacket
		.sink0_ready           (ocm_s1_cmd_width_adapter_src_ready),                                         //  output,    width = 1,          .ready
		...
		.source0_channel       (ocm_s1_burst_adapter_source0_channel),                                       //  output,    width = 2,          .channel
	...
	qsys_top_altera_merlin_demultiplexer_1921_or3nb5y cmd_demux (
		.clk                (clk_100_out_clk_clk),                                                        //   input,    width = 1,       clk.clk
		.reset              (agilex_hps_h2f_axi_master_translator_clk_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
		...
		.sink_data          (limiter_pipeline_source0_data),                                              //   input,  width = 243,          .data
		...
		.src1_data          (cmd_demux_src1_data),                                                        //  output,  width = 243,          .data
		.src1_channel       (cmd_demux_src1_channel),                                                     //  output,    width = 2,          .channel
		.src1_startofpacket (cmd_demux_src1_startofpacket),                                               //  output,    width = 1,          .startofpacket
		.src1_endofpacket   (cmd_demux_src1_endofpacket)                                                  //  output,    width = 1,          .endofpacket
	);

	qsys_top_altera_merlin_demultiplexer_1921_or3nb5y cmd_demux_001 (
		.clk                (clk_100_out_clk_clk),                                                        //   input,    width = 1,       clk.clk
		.reset              (agilex_hps_h2f_axi_master_translator_clk_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
		.sink_ready         (limiter_pipeline_002_source0_ready),                                         //  output,    width = 1,      sink.ready
		.sink_channel       (limiter_pipeline_002_source0_channel),                                       //   input,    width = 2,          .channel
		.sink_data          (limiter_pipeline_002_source0_data),                                          //   input,  width = 243,          .data
		...
		.src1_data          (cmd_demux_001_src1_data),                                                    //  output,  width = 243,          .data
	...
	qsys_top_altera_merlin_multiplexer_1921_mo5nwri cmd_mux (
		...
		.sink0_data          (mux_pipeline_source0_data),                                                  //   input,  width = 243,          .data
		...
		.sink1_data          (mux_pipeline_001_source0_data),                                              //   input,  width = 243,          .data
	...
	qsys_top_altera_merlin_multiplexer_1921_mo5nwri cmd_mux_001 (
		.clk                 (clk_100_out_clk_clk),                                                        //   input,    width = 1,       clk.clk
		.reset               (agilex_hps_h2f_axi_master_translator_clk_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
		.src_ready           (cmd_mux_001_src_ready),                                                      //   input,    width = 1,       src.ready
		.src_valid           (cmd_mux_001_src_valid),                                                      //  output,    width = 1,          .valid
		.src_data            (cmd_mux_001_src_data),                                                       //  output,  width = 243,          .data
		...
		.sink0_data          (mux_pipeline_002_source0_data),                                              //   input,  width = 243,          .data
		...
		.sink1_data          (mux_pipeline_003_source0_data),                                              //   input,  width = 243,          .data
	...
	qsys_top_altera_merlin_demultiplexer_1921_or3nb5y rsp_demux (
		.clk                (clk_100_out_clk_clk),                                                        //   input,    width = 1,       clk.clk
		.reset              (agilex_hps_h2f_axi_master_translator_clk_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
		.sink_ready         (ocm_s1_rsp_width_adapter_src_ready),                                         //  output,    width = 1,      sink.ready
		.sink_channel       (ocm_s1_rsp_width_adapter_src_channel),                                       //   input,    width = 2,          .channel
		.sink_data          (ocm_s1_rsp_width_adapter_src_data),                                          //   input,  width = 243,          .data
		.sink_startofpacket (ocm_s1_rsp_width_adapter_src_startofpacket),                                 //   input,    width = 1,          .startofpacket
		.sink_endofpacket   (ocm_s1_rsp_width_adapter_src_endofpacket),                                   //   input,    width = 1,          .endofpacket
		.sink_valid         (ocm_s1_rsp_width_adapter_src_valid),                                         //   input,    width = 1,          .valid
	...
	qsys_top_altera_merlin_demultiplexer_1921_or3nb5y rsp_demux_001 (
		.clk                (clk_100_out_clk_clk),                                                        //   input,    width = 1,       clk.clk
		.reset              (agilex_hps_h2f_axi_master_translator_clk_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
		...
		.src0_data          (rsp_demux_001_src0_data),                                                    //  output,  width = 243,          .data
		...
		.src1_data          (rsp_demux_001_src1_data),                                                    //  output,  width = 243,          .data
	...
	qsys_top_altera_merlin_multiplexer_1921_ph45pay rsp_mux (
		.clk                 (clk_100_out_clk_clk),                                                        //   input,    width = 1,       clk.clk
		.reset               (agilex_hps_h2f_axi_master_translator_clk_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
		...
		.sink0_channel       (mux_pipeline_004_source0_channel),                                           //   input,    width = 2,          .channel
		.sink0_data          (mux_pipeline_004_source0_data),                                              //   input,  width = 243,          .data
		...
		.sink1_channel       (mux_pipeline_005_source0_channel),                                           //   input,    width = 2,          .channel
		.sink1_data          (mux_pipeline_005_source0_data),                                              //   input,  width = 243,          .data
	...
	qsys_top_altera_merlin_multiplexer_1921_ph45pay rsp_mux_001 (
		.clk                 (clk_100_out_clk_clk),                                                        //   input,    width = 1,       clk.clk
		.reset               (agilex_hps_h2f_axi_master_translator_clk_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
		...
		.sink0_channel       (mux_pipeline_006_source0_channel),                                           //   input,    width = 2,          .channel
		.sink0_data          (mux_pipeline_006_source0_data),                                              //   input,  width = 243,          .data
		...
		.sink1_channel       (mux_pipeline_007_source0_channel),                                           //   input,    width = 2,          .channel
		.sink1_data          (mux_pipeline_007_source0_data),                                              //   input,  width = 243,          .data
	...
	qsys_top_altera_merlin_width_adapter_1920_o6ymenq #(
		...
		.out_endofpacket      (ocm_s1_rsp_width_adapter_src_endofpacket),                                   //  output,    width = 1,       src.endofpacket
		.out_data             (ocm_s1_rsp_width_adapter_src_data),                                          //  output,  width = 243,          .data
		.out_channel          (ocm_s1_rsp_width_adapter_src_channel),                                       //  output,    width = 2,          .channel
		.out_valid            (ocm_s1_rsp_width_adapter_src_valid),                                         //  output,    width = 1,          .valid
		.out_ready            (ocm_s1_rsp_width_adapter_src_ready),                                         //   input,    width = 1,          .ready
		.out_startofpacket    (ocm_s1_rsp_width_adapter_src_startofpacket),                                 //  output,    width = 1,          .startofpacket
	...
	qsys_top_altera_merlin_width_adapter_1920_o6ymenq #(
		...
		.in_data              (router_003_src_data),                                                        //   input,  width = 135,          .data
	...
	qsys_top_altera_merlin_width_adapter_1920_b5xd2ga #(
		...
		.out_endofpacket      (ocm_s1_cmd_width_adapter_src_endofpacket),                                   //  output,    width = 1,       src.endofpacket
		.out_data             (ocm_s1_cmd_width_adapter_src_data),                                          //  output,  width = 135,          .data
		.out_channel          (ocm_s1_cmd_width_adapter_src_channel),                                       //  output,    width = 2,          .channel
		.out_valid            (ocm_s1_cmd_width_adapter_src_valid),                                         //  output,    width = 1,          .valid
		.out_ready            (ocm_s1_cmd_width_adapter_src_ready),                                         //   input,    width = 1,          .ready
		.out_startofpacket    (ocm_s1_cmd_width_adapter_src_startofpacket),                                 //  output,    width = 1,          .startofpacket
		.in_command_size_data (3'b000)                                                                      // (terminated),                         
	);
	...
	qsys_top_altera_merlin_width_adapter_1920_b5xd2ga #(
		...
		.in_data              (cmd_mux_001_src_data),                                                       //   input,  width = 243,          .data
	...
	qsys_top_altera_avalon_st_pipeline_stage_1920_zterisq #(
		...
		.in_channel        (agilex_hps_h2f_axi_master_wr_limiter_cmd_src_channel),       //   input,    width = 2,          .channel
	...
	qsys_top_altera_avalon_st_pipeline_stage_1920_zterisq #(
		...
		.in_data           (rsp_mux_src_data),                                     //   input,  width = 243,          .data
	...
	qsys_top_altera_avalon_st_pipeline_stage_1920_zterisq #(
		...
		.in_channel        (agilex_hps_h2f_axi_master_rd_limiter_cmd_src_channel),       //   input,    width = 2,          .channel
		...
		.out_channel       (limiter_pipeline_002_source0_channel),                       //  output,    width = 2,          .channel
		.in_empty          (1'b0),                                                       // (terminated),                         
		.out_empty         (),                                                           // (terminated),                         
		.out_error         (),                                                           // (terminated),                         
		.in_error          (1'b0)                                                        // (terminated),                         
	...
	qsys_top_altera_avalon_st_pipeline_stage_1920_zterisq #(
		...
		.in_data           (rsp_mux_001_src_data),                                 //   input,  width = 243,          .data
		...
		.out_channel       (limiter_pipeline_003_source0_channel),                 //  output,    width = 2,          .channel
		.in_empty          (1'b0),                                                 // (terminated),                         
		.out_empty         (),                                                     // (terminated),                         
		.out_error         (),                                                     // (terminated),                         
		.in_error          (1'b0)                                                  // (terminated),                         
	...
	qsys_top_altera_avalon_st_pipeline_stage_1920_zterisq #(
		...
		.in_channel        (ocm_s1_burst_adapter_source0_channel),                 //   input,    width = 2,          .channel
	...
	qsys_top_altera_avalon_st_pipeline_stage_1920_zterisq #(
		...
		.in_channel        (pio_0_s1_burst_adapter_source0_channel),               //   input,    width = 2,          .channel
	...
	qsys_top_altera_avalon_st_pipeline_stage_1920_zterisq #(
		...
		.in_data           (cmd_demux_src0_data),                                  //   input,  width = 243,          .data
		...
		.out_data          (mux_pipeline_source0_data),                            //  output,  width = 243,          .data
	...
	qsys_top_altera_avalon_st_pipeline_stage_1920_zterisq #(
		...
		.in_data           (cmd_demux_001_src0_data),                              //   input,  width = 243,          .data
		...
		.out_data          (mux_pipeline_001_source0_data),                        //  output,  width = 243,          .data
	...
	qsys_top_altera_avalon_st_pipeline_stage_1920_zterisq #(
		...
		.in_data           (cmd_demux_src1_data),                                  //   input,  width = 243,          .data
		...
		.out_data          (mux_pipeline_002_source0_data),                        //  output,  width = 243,          .data
	...
	qsys_top_altera_avalon_st_pipeline_stage_1920_zterisq #(
		...
		.in_data           (cmd_demux_001_src1_data),                              //   input,  width = 243,          .data
		...
		.out_data          (mux_pipeline_003_source0_data),                        //  output,  width = 243,          .data
	...
	qsys_top_altera_avalon_st_pipeline_stage_1920_zterisq #(
		...
		.in_data           (rsp_demux_src0_data),                                  //   input,  width = 243,          .data
		...
		.out_data          (mux_pipeline_004_source0_data),                        //  output,  width = 243,          .data
		.out_channel       (mux_pipeline_004_source0_channel),                     //  output,    width = 2,          .channel
		.in_empty          (1'b0),                                                 // (terminated),                         
		.out_empty         (),                                                     // (terminated),                         
		.out_error         (),                                                     // (terminated),                         
		.in_error          (1'b0)                                                  // (terminated),                         
	...
	qsys_top_altera_avalon_st_pipeline_stage_1920_zterisq #(
		...
		.in_data           (rsp_demux_001_src0_data),                              //   input,  width = 243,          .data
		...
		.out_data          (mux_pipeline_005_source0_data),                        //  output,  width = 243,          .data
		.out_channel       (mux_pipeline_005_source0_channel),                     //  output,    width = 2,          .channel
		.in_empty          (1'b0),                                                 // (terminated),                         
		.out_empty         (),                                                     // (terminated),                         
		.out_error         (),                                                     // (terminated),                         
		.in_error          (1'b0)                                                  // (terminated),                         
	...
	qsys_top_altera_avalon_st_pipeline_stage_1920_zterisq #(
		...
		.in_data           (rsp_demux_src1_data),                                  //   input,  width = 243,          .data
		...
		.out_data          (mux_pipeline_006_source0_data),                        //  output,  width = 243,          .data
		.out_channel       (mux_pipeline_006_source0_channel),                     //  output,    width = 2,          .channel
		.in_empty          (1'b0),                                                 // (terminated),                         
		.out_empty         (),                                                     // (terminated),                         
		.out_error         (),                                                     // (terminated),                         
		.in_error          (1'b0)                                                  // (terminated),                         
	...
	qsys_top_altera_avalon_st_pipeline_stage_1920_zterisq #(
		...
		.in_data           (rsp_demux_001_src1_data),                              //   input,  width = 243,          .data
		...
		.out_data          (mux_pipeline_007_source0_data),                        //  output,  width = 243,          .data
		.out_channel       (mux_pipeline_007_source0_channel),                     //  output,    width = 2,          .channel
		.in_empty          (1'b0),                                                 // (terminated),                         
		.out_empty         (),                                                     // (terminated),                         
		.out_error         (),                                                     // (terminated),                         
		.in_error          (1'b0)                                                  // (terminated),                         
