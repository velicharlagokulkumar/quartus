// qsys_top_altera_mm_interconnect_1920_nv5eshy.v
...
`timescale 1 ps / 1 ps
module qsys_top_altera_mm_interconnect_1920_nv5eshy (
		...
		output wire [3:0]  axi_conduit_merger_0_altera_axi_slave_awid,                      //                     axi_conduit_merger_0_altera_axi_slave.awid
		...
		output wire [3:0]  axi_conduit_merger_0_altera_axi_slave_wid,                       //                                                          .wid
		...
		input  wire [3:0]  axi_conduit_merger_0_altera_axi_slave_bid,                       //                                                          .bid
		...
		output wire [3:0]  axi_conduit_merger_0_altera_axi_slave_arid,                      //                                                          .arid
		...
		input  wire [3:0]  axi_conduit_merger_0_altera_axi_slave_rid,                       //                                                          .rid
	...
	wire  [124:0] rsp_mux_src_data;                                                      // rsp_mux:src_data -> dma_0_write_master_agent:rp_data
	...
	wire  [124:0] dma_0_write_master_agent_cp_data;                                      // dma_0_write_master_agent:cp_data -> router:sink_data
	...
	qsys_top_altera_merlin_master_translator_191_g7h47bq #(
		...
		.av_address             (dma_0_write_master_address),                                            //   input,  width = 32,      avalon_anti_master_0.address
	...
	qsys_top_altera_merlin_master_agent_191_mpbm6tq #(
		...
		.cp_data               (dma_0_write_master_agent_cp_data),                                      //  output,  width = 125,          .data
	...
	qsys_top_altera_merlin_axi_slave_ni_1941_fly5qya #(
		.PKT_QOS_H                   (100),
		.PKT_QOS_L                   (100),
		.PKT_THREAD_ID_H             (103),
		.PKT_THREAD_ID_L             (103),
		...
		.aresetn                (~dma_0_write_master_translator_reset_reset_bridge_in_reset_reset),   //   input,    width = 1,        reset_sink.reset_n
		...
		.awid                   (axi_conduit_merger_0_altera_axi_slave_awid),                         //  output,    width = 4, altera_axi_master.awid
		...
		.wid                    (axi_conduit_merger_0_altera_axi_slave_wid),                          //  output,    width = 4,                  .wid
		...
		.bid                    (axi_conduit_merger_0_altera_axi_slave_bid),                          //   input,    width = 4,                  .bid
		...
		.arid                   (axi_conduit_merger_0_altera_axi_slave_arid),                         //  output,    width = 4,                  .arid
		...
		.rid                    (axi_conduit_merger_0_altera_axi_slave_rid),                          //   input,    width = 4,                  .rid
	...
	qsys_top_altera_merlin_router_1921_zpn6mja router (
		...
		.sink_data          (dma_0_write_master_agent_cp_data),                                //   input,  width = 125,          .data
	...
	qsys_top_altera_merlin_router_1921_7k3c5my router_001 (
	...
	qsys_top_altera_merlin_router_1921_7k3c5my router_002 (
	...
	qsys_top_altera_merlin_demultiplexer_1921_kimbi3y cmd_demux (
		.clk                (clk_100_out_clk_clk),                                             //   input,    width = 1,       clk.clk
		.reset              (dma_0_write_master_translator_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	qsys_top_altera_merlin_multiplexer_1921_bcms7ua cmd_mux (
		.clk                 (clk_100_out_clk_clk),                                             //   input,    width = 1,       clk.clk
		.reset               (dma_0_write_master_translator_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	qsys_top_altera_merlin_multiplexer_1921_bcms7ua cmd_mux_001 (
		.clk                 (clk_100_out_clk_clk),                                             //   input,    width = 1,       clk.clk
		.reset               (dma_0_write_master_translator_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	qsys_top_altera_merlin_demultiplexer_1921_ejbibiy rsp_demux (
		.clk                (clk_100_out_clk_clk),                                             //   input,    width = 1,       clk.clk
		.reset              (dma_0_write_master_translator_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	qsys_top_altera_merlin_demultiplexer_1921_ejbibiy rsp_demux_001 (
		.clk                (clk_100_out_clk_clk),                                             //   input,    width = 1,       clk.clk
		.reset              (dma_0_write_master_translator_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	qsys_top_altera_merlin_multiplexer_1921_bacgeha rsp_mux (
		.clk                 (clk_100_out_clk_clk),                                             //   input,    width = 1,       clk.clk
		.reset               (dma_0_write_master_translator_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
