// qsys_top_altera_mm_interconnect_1920_iw3femi.v
...
`timescale 1 ps / 1 ps
module qsys_top_altera_mm_interconnect_1920_iw3femi (
		...
		input  wire [31:0]  jtag2mm_master_address,                                                     //                                                       jtag2mm_master.address
		output wire         jtag2mm_master_waitrequest,                                                 //                                                                     .waitrequest
		input  wire [3:0]   jtag2mm_master_byteenable,                                                  //                                                                     .byteenable
		input  wire         jtag2mm_master_read,                                                        //                                                                     .read
		output wire [31:0]  jtag2mm_master_readdata,                                                    //                                                                     .readdata
		output wire         jtag2mm_master_readdatavalid,                                               //                                                                     .readdatavalid
		input  wire         jtag2mm_master_write,                                                       //                                                                     .write
		input  wire [31:0]  jtag2mm_master_writedata,                                                   //                                                                     .writedata
	...
	wire          jtag2mm_master_translator_avalon_universal_master_0_waitrequest;   // jtag2mm_master_agent:av_waitrequest -> jtag2mm_master_translator:uav_waitrequest
	wire   [31:0] jtag2mm_master_translator_avalon_universal_master_0_readdata;      // jtag2mm_master_agent:av_readdata -> jtag2mm_master_translator:uav_readdata
	wire          jtag2mm_master_translator_avalon_universal_master_0_debugaccess;   // jtag2mm_master_translator:uav_debugaccess -> jtag2mm_master_agent:av_debugaccess
	wire   [31:0] jtag2mm_master_translator_avalon_universal_master_0_address;       // jtag2mm_master_translator:uav_address -> jtag2mm_master_agent:av_address
	wire          jtag2mm_master_translator_avalon_universal_master_0_read;          // jtag2mm_master_translator:uav_read -> jtag2mm_master_agent:av_read
	wire    [3:0] jtag2mm_master_translator_avalon_universal_master_0_byteenable;    // jtag2mm_master_translator:uav_byteenable -> jtag2mm_master_agent:av_byteenable
	wire          jtag2mm_master_translator_avalon_universal_master_0_readdatavalid; // jtag2mm_master_agent:av_readdatavalid -> jtag2mm_master_translator:uav_readdatavalid
	wire          jtag2mm_master_translator_avalon_universal_master_0_lock;          // jtag2mm_master_translator:uav_lock -> jtag2mm_master_agent:av_lock
	wire          jtag2mm_master_translator_avalon_universal_master_0_write;         // jtag2mm_master_translator:uav_write -> jtag2mm_master_agent:av_write
	wire   [31:0] jtag2mm_master_translator_avalon_universal_master_0_writedata;     // jtag2mm_master_translator:uav_writedata -> jtag2mm_master_agent:av_writedata
	wire    [2:0] jtag2mm_master_translator_avalon_universal_master_0_burstcount;    // jtag2mm_master_translator:uav_burstcount -> jtag2mm_master_agent:av_burstcount
	wire          rsp_mux_002_src_valid;                                             // rsp_mux_002:src_valid -> jtag2mm_master_agent:rp_valid
	wire  [134:0] rsp_mux_002_src_data;                                              // rsp_mux_002:src_data -> jtag2mm_master_agent:rp_data
	wire          rsp_mux_002_src_ready;                                             // jtag2mm_master_agent:rp_ready -> rsp_mux_002:src_ready
	wire    [2:0] rsp_mux_002_src_channel;                                           // rsp_mux_002:src_channel -> jtag2mm_master_agent:rp_channel
	wire          rsp_mux_002_src_startofpacket;                                     // rsp_mux_002:src_startofpacket -> jtag2mm_master_agent:rp_startofpacket
	wire          rsp_mux_002_src_endofpacket;                                       // rsp_mux_002:src_endofpacket -> jtag2mm_master_agent:rp_endofpacket
	...
	wire          jtag2mm_master_agent_cp_valid;                                     // jtag2mm_master_agent:cp_valid -> router_002:sink_valid
	wire  [134:0] jtag2mm_master_agent_cp_data;                                      // jtag2mm_master_agent:cp_data -> router_002:sink_data
	wire          jtag2mm_master_agent_cp_ready;                                     // router_002:sink_ready -> jtag2mm_master_agent:cp_ready
	wire          jtag2mm_master_agent_cp_startofpacket;                             // jtag2mm_master_agent:cp_startofpacket -> router_002:sink_startofpacket
	wire          jtag2mm_master_agent_cp_endofpacket;                               // jtag2mm_master_agent:cp_endofpacket -> router_002:sink_endofpacket
	...
	wire          agilex_hps_h2f_axi_master_wr_rsp_width_adapter_src_valid;          // agilex_hps_h2f_axi_master_wr_rsp_width_adapter:out_valid -> agilex_hps_h2f_axi_master_agent:write_rp_valid
	wire  [242:0] agilex_hps_h2f_axi_master_wr_rsp_width_adapter_src_data;           // agilex_hps_h2f_axi_master_wr_rsp_width_adapter:out_data -> agilex_hps_h2f_axi_master_agent:write_rp_data
	wire          agilex_hps_h2f_axi_master_wr_rsp_width_adapter_src_ready;          // agilex_hps_h2f_axi_master_agent:write_rp_ready -> agilex_hps_h2f_axi_master_wr_rsp_width_adapter:out_ready
	wire    [2:0] agilex_hps_h2f_axi_master_wr_rsp_width_adapter_src_channel;        // agilex_hps_h2f_axi_master_wr_rsp_width_adapter:out_channel -> agilex_hps_h2f_axi_master_agent:write_rp_channel
	wire          agilex_hps_h2f_axi_master_wr_rsp_width_adapter_src_startofpacket;  // agilex_hps_h2f_axi_master_wr_rsp_width_adapter:out_startofpacket -> agilex_hps_h2f_axi_master_agent:write_rp_startofpacket
	wire          agilex_hps_h2f_axi_master_wr_rsp_width_adapter_src_endofpacket;    // agilex_hps_h2f_axi_master_wr_rsp_width_adapter:out_endofpacket -> agilex_hps_h2f_axi_master_agent:write_rp_endofpacket
	...
	wire          agilex_hps_h2f_axi_master_rd_rsp_width_adapter_src_valid;          // agilex_hps_h2f_axi_master_rd_rsp_width_adapter:out_valid -> agilex_hps_h2f_axi_master_agent:read_rp_valid
	wire  [242:0] agilex_hps_h2f_axi_master_rd_rsp_width_adapter_src_data;           // agilex_hps_h2f_axi_master_rd_rsp_width_adapter:out_data -> agilex_hps_h2f_axi_master_agent:read_rp_data
	wire          agilex_hps_h2f_axi_master_rd_rsp_width_adapter_src_ready;          // agilex_hps_h2f_axi_master_agent:read_rp_ready -> agilex_hps_h2f_axi_master_rd_rsp_width_adapter:out_ready
	wire    [2:0] agilex_hps_h2f_axi_master_rd_rsp_width_adapter_src_channel;        // agilex_hps_h2f_axi_master_rd_rsp_width_adapter:out_channel -> agilex_hps_h2f_axi_master_agent:read_rp_channel
	wire          agilex_hps_h2f_axi_master_rd_rsp_width_adapter_src_startofpacket;  // agilex_hps_h2f_axi_master_rd_rsp_width_adapter:out_startofpacket -> agilex_hps_h2f_axi_master_agent:read_rp_startofpacket
	wire          agilex_hps_h2f_axi_master_rd_rsp_width_adapter_src_endofpacket;    // agilex_hps_h2f_axi_master_rd_rsp_width_adapter:out_endofpacket -> agilex_hps_h2f_axi_master_agent:read_rp_endofpacket
	wire          router_src_valid;                                                  // router:src_valid -> agilex_hps_h2f_axi_master_wr_cmd_width_adapter:in_valid
	wire  [242:0] router_src_data;                                                   // router:src_data -> agilex_hps_h2f_axi_master_wr_cmd_width_adapter:in_data
	wire          router_src_ready;                                                  // agilex_hps_h2f_axi_master_wr_cmd_width_adapter:in_ready -> router:src_ready
	wire    [2:0] router_src_channel;                                                // router:src_channel -> agilex_hps_h2f_axi_master_wr_cmd_width_adapter:in_channel
	wire          router_src_startofpacket;                                          // router:src_startofpacket -> agilex_hps_h2f_axi_master_wr_cmd_width_adapter:in_startofpacket
	wire          router_src_endofpacket;                                            // router:src_endofpacket -> agilex_hps_h2f_axi_master_wr_cmd_width_adapter:in_endofpacket
	...
	wire          router_001_src_valid;                                              // router_001:src_valid -> agilex_hps_h2f_axi_master_rd_cmd_width_adapter:in_valid
	wire  [242:0] router_001_src_data;                                               // router_001:src_data -> agilex_hps_h2f_axi_master_rd_cmd_width_adapter:in_data
	wire          router_001_src_ready;                                              // agilex_hps_h2f_axi_master_rd_cmd_width_adapter:in_ready -> router_001:src_ready
	wire    [2:0] router_001_src_channel;                                            // router_001:src_channel -> agilex_hps_h2f_axi_master_rd_cmd_width_adapter:in_channel
	wire          router_001_src_startofpacket;                                      // router_001:src_startofpacket -> agilex_hps_h2f_axi_master_rd_cmd_width_adapter:in_startofpacket
	wire          router_001_src_endofpacket;                                        // router_001:src_endofpacket -> agilex_hps_h2f_axi_master_rd_cmd_width_adapter:in_endofpacket
	...
	wire  [134:0] rsp_demux_src0_data;                                               // rsp_demux:src0_data -> mux_pipeline_003:in_data
	...
	wire  [134:0] mux_pipeline_003_source0_data;                                     // mux_pipeline_003:out_data -> rsp_mux:sink0_data
	...
	wire  [134:0] rsp_demux_src1_data;                                               // rsp_demux:src1_data -> mux_pipeline_004:in_data
	...
	wire  [134:0] mux_pipeline_004_source0_data;                                     // mux_pipeline_004:out_data -> rsp_mux_001:sink0_data
	...
	wire  [134:0] rsp_demux_src2_data;                                               // rsp_demux:src2_data -> mux_pipeline_005:in_data
	...
	wire  [134:0] mux_pipeline_005_source0_data;                                     // mux_pipeline_005:out_data -> rsp_mux_002:sink0_data
	...
	qsys_top_altera_merlin_master_translator_191_g7h47bq #(
		...
		.uav_address            (jtag2mm_master_translator_avalon_universal_master_0_address),                //  output,  width = 32, avalon_universal_master_0.address
		.uav_burstcount         (jtag2mm_master_translator_avalon_universal_master_0_burstcount),             //  output,   width = 3,                          .burstcount
		.uav_read               (jtag2mm_master_translator_avalon_universal_master_0_read),                   //  output,   width = 1,                          .read
		.uav_write              (jtag2mm_master_translator_avalon_universal_master_0_write),                  //  output,   width = 1,                          .write
		.uav_waitrequest        (jtag2mm_master_translator_avalon_universal_master_0_waitrequest),            //   input,   width = 1,                          .waitrequest
		.uav_readdatavalid      (jtag2mm_master_translator_avalon_universal_master_0_readdatavalid),          //   input,   width = 1,                          .readdatavalid
		.uav_byteenable         (jtag2mm_master_translator_avalon_universal_master_0_byteenable),             //  output,   width = 4,                          .byteenable
		.uav_readdata           (jtag2mm_master_translator_avalon_universal_master_0_readdata),               //   input,  width = 32,                          .readdata
		.uav_writedata          (jtag2mm_master_translator_avalon_universal_master_0_writedata),              //  output,  width = 32,                          .writedata
		.uav_lock               (jtag2mm_master_translator_avalon_universal_master_0_lock),                   //  output,   width = 1,                          .lock
		.uav_debugaccess        (jtag2mm_master_translator_avalon_universal_master_0_debugaccess),            //  output,   width = 1,                          .debugaccess
		.av_address             (jtag2mm_master_address),                                                     //   input,  width = 32,      avalon_anti_master_0.address
		.av_waitrequest         (jtag2mm_master_waitrequest),                                                 //  output,   width = 1,                          .waitrequest
		.av_byteenable          (jtag2mm_master_byteenable),                                                  //   input,   width = 4,                          .byteenable
		.av_read                (jtag2mm_master_read),                                                        //   input,   width = 1,                          .read
		.av_readdata            (jtag2mm_master_readdata),                                                    //  output,  width = 32,                          .readdata
		.av_readdatavalid       (jtag2mm_master_readdatavalid),                                               //  output,   width = 1,                          .readdatavalid
		.av_write               (jtag2mm_master_write),                                                       //   input,   width = 1,                          .write
		.av_writedata           (jtag2mm_master_writedata),                                                   //   input,  width = 32,                          .writedata
	...
	qsys_top_altera_merlin_axi_master_ni_1941_dfsyzvi #(
		...
		.write_rp_valid         (agilex_hps_h2f_axi_master_wr_rsp_width_adapter_src_valid),                    //   input,    width = 1,         write_rp.valid
		.write_rp_data          (agilex_hps_h2f_axi_master_wr_rsp_width_adapter_src_data),                     //   input,  width = 243,                 .data
		.write_rp_channel       (agilex_hps_h2f_axi_master_wr_rsp_width_adapter_src_channel),                  //   input,    width = 3,                 .channel
		.write_rp_startofpacket (agilex_hps_h2f_axi_master_wr_rsp_width_adapter_src_startofpacket),            //   input,    width = 1,                 .startofpacket
		.write_rp_endofpacket   (agilex_hps_h2f_axi_master_wr_rsp_width_adapter_src_endofpacket),              //   input,    width = 1,                 .endofpacket
		.write_rp_ready         (agilex_hps_h2f_axi_master_wr_rsp_width_adapter_src_ready),                    //  output,    width = 1,                 .ready
		...
		.read_rp_valid          (agilex_hps_h2f_axi_master_rd_rsp_width_adapter_src_valid),                    //   input,    width = 1,          read_rp.valid
		.read_rp_data           (agilex_hps_h2f_axi_master_rd_rsp_width_adapter_src_data),                     //   input,  width = 243,                 .data
		.read_rp_channel        (agilex_hps_h2f_axi_master_rd_rsp_width_adapter_src_channel),                  //   input,    width = 3,                 .channel
		.read_rp_startofpacket  (agilex_hps_h2f_axi_master_rd_rsp_width_adapter_src_startofpacket),            //   input,    width = 1,                 .startofpacket
		.read_rp_endofpacket    (agilex_hps_h2f_axi_master_rd_rsp_width_adapter_src_endofpacket),              //   input,    width = 1,                 .endofpacket
		.read_rp_ready          (agilex_hps_h2f_axi_master_rd_rsp_width_adapter_src_ready),                    //  output,    width = 1,                 .ready
	...
	qsys_top_altera_merlin_master_agent_191_mpbm6tq #(
		...
		.WUNIQUE_VALUE             (0),
		.SYNC_RESET                (1)
	) jtag2mm_master_agent (
		.clk                   (clk_100_out_clk_clk),                                                        //   input,    width = 1,       clk.clk
		.reset                 (agilex_hps_h2f_axi_master_translator_clk_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
		.av_address            (jtag2mm_master_translator_avalon_universal_master_0_address),                //   input,   width = 32,        av.address
		.av_write              (jtag2mm_master_translator_avalon_universal_master_0_write),                  //   input,    width = 1,          .write
		.av_read               (jtag2mm_master_translator_avalon_universal_master_0_read),                   //   input,    width = 1,          .read
		.av_writedata          (jtag2mm_master_translator_avalon_universal_master_0_writedata),              //   input,   width = 32,          .writedata
		.av_readdata           (jtag2mm_master_translator_avalon_universal_master_0_readdata),               //  output,   width = 32,          .readdata
		.av_waitrequest        (jtag2mm_master_translator_avalon_universal_master_0_waitrequest),            //  output,    width = 1,          .waitrequest
		.av_readdatavalid      (jtag2mm_master_translator_avalon_universal_master_0_readdatavalid),          //  output,    width = 1,          .readdatavalid
		.av_byteenable         (jtag2mm_master_translator_avalon_universal_master_0_byteenable),             //   input,    width = 4,          .byteenable
		.av_burstcount         (jtag2mm_master_translator_avalon_universal_master_0_burstcount),             //   input,    width = 3,          .burstcount
		.av_debugaccess        (jtag2mm_master_translator_avalon_universal_master_0_debugaccess),            //   input,    width = 1,          .debugaccess
		.av_lock               (jtag2mm_master_translator_avalon_universal_master_0_lock),                   //   input,    width = 1,          .lock
		.cp_valid              (jtag2mm_master_agent_cp_valid),                                              //  output,    width = 1,        cp.valid
		.cp_data               (jtag2mm_master_agent_cp_data),                                               //  output,  width = 135,          .data
		.cp_startofpacket      (jtag2mm_master_agent_cp_startofpacket),                                      //  output,    width = 1,          .startofpacket
		.cp_endofpacket        (jtag2mm_master_agent_cp_endofpacket),                                        //  output,    width = 1,          .endofpacket
		.cp_ready              (jtag2mm_master_agent_cp_ready),                                              //   input,    width = 1,          .ready
	...
	qsys_top_altera_merlin_router_1921_iin7ita router (
	...
	qsys_top_altera_merlin_router_1921_iin7ita router_001 (
	...
	qsys_top_altera_merlin_router_1921_hvjibhi router_002 (
		.sink_ready         (jtag2mm_master_agent_cp_ready),                                              //  output,    width = 1,      sink.ready
		.sink_valid         (jtag2mm_master_agent_cp_valid),                                              //   input,    width = 1,          .valid
		.sink_data          (jtag2mm_master_agent_cp_data),                                               //   input,  width = 135,          .data
		.sink_startofpacket (jtag2mm_master_agent_cp_startofpacket),                                      //   input,    width = 1,          .startofpacket
		.sink_endofpacket   (jtag2mm_master_agent_cp_endofpacket),                                        //   input,    width = 1,          .endofpacket
		.clk                (clk_100_out_clk_clk),                                                        //   input,    width = 1,       clk.clk
		.reset              (agilex_hps_h2f_axi_master_translator_clk_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	qsys_top_altera_merlin_demultiplexer_1921_3ixqtja cmd_demux (
		.clk                (clk_100_out_clk_clk),                                                        //   input,    width = 1,       clk.clk
		.reset              (agilex_hps_h2f_axi_master_translator_clk_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	qsys_top_altera_merlin_demultiplexer_1921_3ixqtja cmd_demux_001 (
		.clk                (clk_100_out_clk_clk),                                                        //   input,    width = 1,       clk.clk
		.reset              (agilex_hps_h2f_axi_master_translator_clk_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	qsys_top_altera_merlin_multiplexer_1921_zpzkjtq rsp_mux (
		.clk                 (clk_100_out_clk_clk),                                                        //   input,    width = 1,       clk.clk
		.reset               (agilex_hps_h2f_axi_master_translator_clk_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	qsys_top_altera_merlin_multiplexer_1921_zpzkjtq rsp_mux_001 (
		.clk                 (clk_100_out_clk_clk),                                                        //   input,    width = 1,       clk.clk
		.reset               (agilex_hps_h2f_axi_master_translator_clk_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
		...
		.sink0_data          (mux_pipeline_004_source0_data),                                              //   input,  width = 135,          .data
	...
	qsys_top_altera_merlin_width_adapter_1920_b5xd2ga #(
		...
		.in_channel           (router_src_channel),                                                         //   input,    width = 3,          .channel
		...
		.in_data              (router_src_data),                                                            //   input,  width = 243,          .data
	...
	qsys_top_altera_merlin_width_adapter_1920_b5xd2ga #(
		...
		.in_data              (router_001_src_data),                                                        //   input,  width = 243,          .data
