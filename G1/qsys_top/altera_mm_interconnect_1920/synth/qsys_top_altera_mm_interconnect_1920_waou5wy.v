// qsys_top_altera_mm_interconnect_1920_waou5wy.v
...
`timescale 1 ps / 1 ps
module qsys_top_altera_mm_interconnect_1920_waou5wy (
		...
		output wire [13:0]  ocm_s1_address,                                                             //                                                               ocm_s1.address
		output wire         ocm_s1_write,                                                               //                                                                     .write
		input  wire [127:0] ocm_s1_readdata,                                                            //                                                                     .readdata
		output wire [127:0] ocm_s1_writedata,                                                           //                                                                     .writedata
		output wire [15:0]  ocm_s1_byteenable,                                                          //                                                                     .byteenable
	...
	wire  [127:0] ocm_s1_agent_m0_readdata;                                   // ocm_s1_translator:uav_readdata -> ocm_s1_agent:m0_readdata
	...
	wire   [15:0] ocm_s1_agent_m0_byteenable;                                 // ocm_s1_agent:m0_byteenable -> ocm_s1_translator:uav_byteenable
	...
	wire  [127:0] ocm_s1_agent_m0_writedata;                                  // ocm_s1_agent:m0_writedata -> ocm_s1_translator:uav_writedata
	wire          ocm_s1_agent_m0_write;                                      // ocm_s1_agent:m0_write -> ocm_s1_translator:uav_write
	wire    [4:0] ocm_s1_agent_m0_burstcount;                                 // ocm_s1_agent:m0_burstcount -> ocm_s1_translator:uav_burstcount
	wire          ocm_s1_agent_rf_source_valid;                               // ocm_s1_agent:rf_source_valid -> ocm_s1_agent_rsp_fifo:in_valid
	wire  [243:0] ocm_s1_agent_rf_source_data;                                // ocm_s1_agent:rf_source_data -> ocm_s1_agent_rsp_fifo:in_data
	...
	wire  [243:0] ocm_s1_agent_rsp_fifo_out_data;                             // ocm_s1_agent_rsp_fifo:out_data -> ocm_s1_agent:rf_sink_data
	...
	wire  [129:0] ocm_s1_agent_rdata_fifo_src_data;                           // ocm_s1_agent:rdata_fifo_src_data -> ocm_s1_agent_rdata_fifo:in_data
	...
	wire  [129:0] ocm_s1_agent_rdata_fifo_out_data;                           // ocm_s1_agent_rdata_fifo:out_data -> ocm_s1_agent:rdata_fifo_sink_data
	...
	wire  [242:0] router_002_src_data;                                        // router_002:src_data -> rsp_demux:sink_data
	...
	wire  [242:0] cmd_mux_src_data;                                           // cmd_mux:src_data -> ocm_s1_burst_adapter:sink0_data
	wire          cmd_mux_src_ready;                                          // ocm_s1_burst_adapter:sink0_ready -> cmd_mux:src_ready
	wire    [1:0] cmd_mux_src_channel;                                        // cmd_mux:src_channel -> ocm_s1_burst_adapter:sink0_channel
	...
	wire  [242:0] ocm_s1_burst_adapter_source0_data;                          // ocm_s1_burst_adapter:source0_data -> agent_pipeline:in_data
	...
	wire  [242:0] agent_pipeline_source0_data;                                // agent_pipeline:out_data -> ocm_s1_agent:cp_data
	...
	wire  [242:0] ocm_s1_agent_rp_data;                                       // ocm_s1_agent:rp_data -> agent_pipeline_001:in_data
	...
	wire  [242:0] agent_pipeline_001_source0_data;                            // agent_pipeline_001:out_data -> router_002:sink_data
	...
	qsys_top_altera_merlin_slave_translator_191_x56fcki #(
		...
		.uav_burstcount         (ocm_s1_agent_m0_burstcount),                                                 //   input,    width = 5,                         .burstcount
		...
		.uav_byteenable         (ocm_s1_agent_m0_byteenable),                                                 //   input,   width = 16,                         .byteenable
		.uav_readdata           (ocm_s1_agent_m0_readdata),                                                   //  output,  width = 128,                         .readdata
		.uav_writedata          (ocm_s1_agent_m0_writedata),                                                  //   input,  width = 128,                         .writedata
		.uav_lock               (ocm_s1_agent_m0_lock),                                                       //   input,    width = 1,                         .lock
		.uav_debugaccess        (ocm_s1_agent_m0_debugaccess),                                                //   input,    width = 1,                         .debugaccess
		.av_address             (ocm_s1_address),                                                             //  output,   width = 14,      avalon_anti_slave_0.address
		.av_write               (ocm_s1_write),                                                               //  output,    width = 1,                         .write
		.av_readdata            (ocm_s1_readdata),                                                            //   input,  width = 128,                         .readdata
		.av_writedata           (ocm_s1_writedata),                                                           //  output,  width = 128,                         .writedata
		.av_byteenable          (ocm_s1_byteenable),                                                          //  output,   width = 16,                         .byteenable
	...
	qsys_top_altera_merlin_slave_agent_191_ncfkfri #(
		...
		.m0_burstcount           (ocm_s1_agent_m0_burstcount),                                                 //  output,    width = 5,                .burstcount
		.m0_byteenable           (ocm_s1_agent_m0_byteenable),                                                 //  output,   width = 16,                .byteenable
		.m0_debugaccess          (ocm_s1_agent_m0_debugaccess),                                                //  output,    width = 1,                .debugaccess
		.m0_lock                 (ocm_s1_agent_m0_lock),                                                       //  output,    width = 1,                .lock
		.m0_readdata             (ocm_s1_agent_m0_readdata),                                                   //   input,  width = 128,                .readdata
		...
		.m0_writedata            (ocm_s1_agent_m0_writedata),                                                  //  output,  width = 128,                .writedata
		...
		.rp_data                 (ocm_s1_agent_rp_data),                                                       //  output,  width = 243,                .data
		...
		.cp_data                 (agent_pipeline_source0_data),                                                //   input,  width = 243,                .data
		...
		.rf_sink_data            (ocm_s1_agent_rsp_fifo_out_data),                                             //   input,  width = 244,                .data
		...
		.rf_source_data          (ocm_s1_agent_rf_source_data),                                                //  output,  width = 244,                .data
		...
		.rdata_fifo_sink_data    (ocm_s1_agent_rdata_fifo_out_data),                                           //   input,  width = 130,                .data
		...
		.rdata_fifo_src_data     (ocm_s1_agent_rdata_fifo_src_data),                                           //  output,  width = 130,                .data
	...
	qsys_top_altera_avalon_sc_fifo_1931_vhmcgqy #(
		...
		.in_data           (ocm_s1_agent_rf_source_data),                          //   input,  width = 244,        in.data
		...
		.out_data          (ocm_s1_agent_rsp_fifo_out_data),                       //  output,  width = 244,       out.data
	...
	qsys_top_altera_avalon_sc_fifo_1931_vhmcgqy #(
		...
		.clk               (clk_100_out_clk_clk),                                  //   input,    width = 1,       clk.clk
		.reset             (agilex_hps_h2f_axi_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
		.in_data           (ocm_s1_agent_rdata_fifo_src_data),                     //   input,  width = 130,        in.data
		...
		.out_data          (ocm_s1_agent_rdata_fifo_out_data),                     //  output,  width = 130,       out.data
	...
	qsys_top_altera_merlin_router_1921_kclwamq router_002 (
		...
		.sink_data          (agent_pipeline_001_source0_data),                                            //   input,  width = 243,          .data
		...
		.src_data           (router_002_src_data),                                                        //  output,  width = 243,          .data
	...
	qsys_top_altera_merlin_burst_adapter_1923_kfoohfq #(
		.PKT_ADDR_H                (175),
		.PKT_ADDR_L                (144),
		.PKT_BEGIN_BURST           (211),
		.PKT_BYTE_CNT_H            (194),
		...
		.sink0_data            (cmd_mux_src_data),                                                           //   input,  width = 243,          .data
		...
		.source0_data          (ocm_s1_burst_adapter_source0_data),                                          //  output,  width = 243,          .data
	...
	qsys_top_altera_merlin_demultiplexer_1921_or3nb5y rsp_demux (
		...
		.sink_data          (router_002_src_data),                                                        //   input,  width = 243,          .data
	...
	qsys_top_altera_avalon_st_pipeline_stage_1920_zterisq #(
		...
		.in_data           (ocm_s1_burst_adapter_source0_data),                    //   input,  width = 243,          .data
		...
		.out_data          (agent_pipeline_source0_data),                          //  output,  width = 243,          .data
	...
	qsys_top_altera_avalon_st_pipeline_stage_1920_zterisq #(
		...
		.in_data           (ocm_s1_agent_rp_data),                                 //   input,  width = 243,          .data
		...
		.out_data          (agent_pipeline_001_source0_data),                      //  output,  width = 243,          .data
		.in_empty          (1'b0),                                                 // (terminated),                         
		.out_empty         (),                                                     // (terminated),                         
		.out_error         (),                                                     // (terminated),                         
		.in_error          (1'b0),                                                 // (terminated),                         
