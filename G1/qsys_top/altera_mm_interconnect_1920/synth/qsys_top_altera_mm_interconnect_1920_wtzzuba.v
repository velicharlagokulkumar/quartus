// qsys_top_altera_mm_interconnect_1920_wtzzuba.v
...
`timescale 1 ps / 1 ps
module qsys_top_altera_mm_interconnect_1920_wtzzuba (
		...
		input  wire [3:0]   axi_conduit_merger_0_altera_axi_master_awid,                   //                  axi_conduit_merger_0_altera_axi_master.awid
		...
		input  wire [3:0]   axi_conduit_merger_0_altera_axi_master_wid,                    //                                                        .wid
		...
		output wire [3:0]   axi_conduit_merger_0_altera_axi_master_bid,                    //                                                        .bid
		...
		input  wire [3:0]   axi_conduit_merger_0_altera_axi_master_arid,                   //                                                        .arid
		...
		output wire [3:0]   axi_conduit_merger_0_altera_axi_master_rid,                    //                                                        .rid
	...
	wire  [160:0] rsp_mux_src_data;                                                    // rsp_mux:src_data -> axi_conduit_merger_0_altera_axi_master_agent:write_rp_data
	wire          rsp_mux_src_ready;                                                   // axi_conduit_merger_0_altera_axi_master_agent:write_rp_ready -> rsp_mux:src_ready
	wire    [2:0] rsp_mux_src_channel;                                                 // rsp_mux:src_channel -> axi_conduit_merger_0_altera_axi_master_agent:write_rp_channel
	...
	wire  [160:0] rsp_mux_001_src_data;                                                // rsp_mux_001:src_data -> axi_conduit_merger_0_altera_axi_master_agent:read_rp_data
	wire          rsp_mux_001_src_ready;                                               // axi_conduit_merger_0_altera_axi_master_agent:read_rp_ready -> rsp_mux_001:src_ready
	wire    [2:0] rsp_mux_001_src_channel;                                             // rsp_mux_001:src_channel -> axi_conduit_merger_0_altera_axi_master_agent:read_rp_channel
	...
	wire  [160:0] axi_conduit_merger_0_altera_axi_master_agent_write_cp_data;          // axi_conduit_merger_0_altera_axi_master_agent:write_cp_data -> router:sink_data
	...
	wire  [160:0] axi_conduit_merger_0_altera_axi_master_agent_read_cp_data;           // axi_conduit_merger_0_altera_axi_master_agent:read_cp_data -> router_001:sink_data
	...
	wire          jtag2mm_s_master_agent_cp_valid;                                     // jtag2mm_s_master_agent:cp_valid -> router_002:sink_valid
	wire  [160:0] jtag2mm_s_master_agent_cp_data;                                      // jtag2mm_s_master_agent:cp_data -> router_002:sink_data
	wire          jtag2mm_s_master_agent_cp_ready;                                     // router_002:sink_ready -> jtag2mm_s_master_agent:cp_ready
	wire          jtag2mm_s_master_agent_cp_startofpacket;                             // jtag2mm_s_master_agent:cp_startofpacket -> router_002:sink_startofpacket
	wire          jtag2mm_s_master_agent_cp_endofpacket;                               // jtag2mm_s_master_agent:cp_endofpacket -> router_002:sink_endofpacket
	wire          agilex_hps_f2h_axi_slave_agent_write_rp_valid;                       // agilex_hps_f2h_axi_slave_agent:write_rp_valid -> router_003:sink_valid
	wire  [700:0] agilex_hps_f2h_axi_slave_agent_write_rp_data;                        // agilex_hps_f2h_axi_slave_agent:write_rp_data -> router_003:sink_data
	wire          agilex_hps_f2h_axi_slave_agent_write_rp_ready;                       // router_003:sink_ready -> agilex_hps_f2h_axi_slave_agent:write_rp_ready
	wire          agilex_hps_f2h_axi_slave_agent_write_rp_startofpacket;               // agilex_hps_f2h_axi_slave_agent:write_rp_startofpacket -> router_003:sink_startofpacket
	wire          agilex_hps_f2h_axi_slave_agent_write_rp_endofpacket;                 // agilex_hps_f2h_axi_slave_agent:write_rp_endofpacket -> router_003:sink_endofpacket
	wire          agilex_hps_f2h_axi_slave_agent_read_rp_valid;                        // agilex_hps_f2h_axi_slave_agent:read_rp_valid -> router_004:sink_valid
	wire  [700:0] agilex_hps_f2h_axi_slave_agent_read_rp_data;                         // agilex_hps_f2h_axi_slave_agent:read_rp_data -> router_004:sink_data
	wire          agilex_hps_f2h_axi_slave_agent_read_rp_ready;                        // router_004:sink_ready -> agilex_hps_f2h_axi_slave_agent:read_rp_ready
	wire          agilex_hps_f2h_axi_slave_agent_read_rp_startofpacket;                // agilex_hps_f2h_axi_slave_agent:read_rp_startofpacket -> router_004:sink_startofpacket
	wire          agilex_hps_f2h_axi_slave_agent_read_rp_endofpacket;                  // agilex_hps_f2h_axi_slave_agent:read_rp_endofpacket -> router_004:sink_endofpacket
	wire          router_002_src_valid;                                                // router_002:src_valid -> jtag2mm_s_master_limiter:cmd_sink_valid
	wire  [160:0] router_002_src_data;                                                 // router_002:src_data -> jtag2mm_s_master_limiter:cmd_sink_data
	wire          router_002_src_ready;                                                // jtag2mm_s_master_limiter:cmd_sink_ready -> router_002:src_ready
	wire    [2:0] router_002_src_channel;                                              // router_002:src_channel -> jtag2mm_s_master_limiter:cmd_sink_channel
	wire          router_002_src_startofpacket;                                        // router_002:src_startofpacket -> jtag2mm_s_master_limiter:cmd_sink_startofpacket
	wire          router_002_src_endofpacket;                                          // router_002:src_endofpacket -> jtag2mm_s_master_limiter:cmd_sink_endofpacket
	wire  [160:0] jtag2mm_s_master_limiter_cmd_src_data;                               // jtag2mm_s_master_limiter:cmd_src_data -> cmd_demux_002:sink_data
	wire          jtag2mm_s_master_limiter_cmd_src_ready;                              // cmd_demux_002:sink_ready -> jtag2mm_s_master_limiter:cmd_src_ready
	wire    [2:0] jtag2mm_s_master_limiter_cmd_src_channel;                            // jtag2mm_s_master_limiter:cmd_src_channel -> cmd_demux_002:sink_channel
	wire          jtag2mm_s_master_limiter_cmd_src_startofpacket;                      // jtag2mm_s_master_limiter:cmd_src_startofpacket -> cmd_demux_002:sink_startofpacket
	wire          jtag2mm_s_master_limiter_cmd_src_endofpacket;                        // jtag2mm_s_master_limiter:cmd_src_endofpacket -> cmd_demux_002:sink_endofpacket
	wire          rsp_mux_002_src_valid;                                               // rsp_mux_002:src_valid -> jtag2mm_s_master_limiter:rsp_sink_valid
	wire  [160:0] rsp_mux_002_src_data;                                                // rsp_mux_002:src_data -> jtag2mm_s_master_limiter:rsp_sink_data
	wire          rsp_mux_002_src_ready;                                               // jtag2mm_s_master_limiter:rsp_sink_ready -> rsp_mux_002:src_ready
	wire    [2:0] rsp_mux_002_src_channel;                                             // rsp_mux_002:src_channel -> jtag2mm_s_master_limiter:rsp_sink_channel
	wire          rsp_mux_002_src_startofpacket;                                       // rsp_mux_002:src_startofpacket -> jtag2mm_s_master_limiter:rsp_sink_startofpacket
	wire          rsp_mux_002_src_endofpacket;                                         // rsp_mux_002:src_endofpacket -> jtag2mm_s_master_limiter:rsp_sink_endofpacket
	wire          jtag2mm_s_master_limiter_rsp_src_valid;                              // jtag2mm_s_master_limiter:rsp_src_valid -> jtag2mm_s_master_agent:rp_valid
	wire  [160:0] jtag2mm_s_master_limiter_rsp_src_data;                               // jtag2mm_s_master_limiter:rsp_src_data -> jtag2mm_s_master_agent:rp_data
	wire          jtag2mm_s_master_limiter_rsp_src_ready;                              // jtag2mm_s_master_agent:rp_ready -> jtag2mm_s_master_limiter:rsp_src_ready
	wire    [2:0] jtag2mm_s_master_limiter_rsp_src_channel;                            // jtag2mm_s_master_limiter:rsp_src_channel -> jtag2mm_s_master_agent:rp_channel
	...
	wire  [160:0] cmd_mux_src_data;                                                    // cmd_mux:src_data -> agilex_hps_f2h_axi_slave_wr_cmd_width_adapter:in_data
	wire          cmd_mux_src_ready;                                                   // agilex_hps_f2h_axi_slave_wr_cmd_width_adapter:in_ready -> cmd_mux:src_ready
	wire    [2:0] cmd_mux_src_channel;                                                 // cmd_mux:src_channel -> agilex_hps_f2h_axi_slave_wr_cmd_width_adapter:in_channel
	...
	wire  [700:0] agilex_hps_f2h_axi_slave_wr_cmd_width_adapter_src_data;              // agilex_hps_f2h_axi_slave_wr_cmd_width_adapter:out_data -> agilex_hps_f2h_axi_slave_agent:write_cp_data
	...
	wire    [2:0] agilex_hps_f2h_axi_slave_wr_cmd_width_adapter_src_channel;           // agilex_hps_f2h_axi_slave_wr_cmd_width_adapter:out_channel -> agilex_hps_f2h_axi_slave_agent:write_cp_channel
	...
	wire  [160:0] cmd_mux_001_src_data;                                                // cmd_mux_001:src_data -> agilex_hps_f2h_axi_slave_rd_cmd_width_adapter:in_data
	wire          cmd_mux_001_src_ready;                                               // agilex_hps_f2h_axi_slave_rd_cmd_width_adapter:in_ready -> cmd_mux_001:src_ready
	wire    [2:0] cmd_mux_001_src_channel;                                             // cmd_mux_001:src_channel -> agilex_hps_f2h_axi_slave_rd_cmd_width_adapter:in_channel
	...
	wire  [700:0] agilex_hps_f2h_axi_slave_rd_cmd_width_adapter_src_data;              // agilex_hps_f2h_axi_slave_rd_cmd_width_adapter:out_data -> agilex_hps_f2h_axi_slave_agent:read_cp_data
	...
	wire    [2:0] agilex_hps_f2h_axi_slave_rd_cmd_width_adapter_src_channel;           // agilex_hps_f2h_axi_slave_rd_cmd_width_adapter:out_channel -> agilex_hps_f2h_axi_slave_agent:read_cp_channel
	...
	wire          router_003_src_valid;                                                // router_003:src_valid -> agilex_hps_f2h_axi_slave_wr_rsp_width_adapter:in_valid
	wire  [700:0] router_003_src_data;                                                 // router_003:src_data -> agilex_hps_f2h_axi_slave_wr_rsp_width_adapter:in_data
	wire          router_003_src_ready;                                                // agilex_hps_f2h_axi_slave_wr_rsp_width_adapter:in_ready -> router_003:src_ready
	wire    [2:0] router_003_src_channel;                                              // router_003:src_channel -> agilex_hps_f2h_axi_slave_wr_rsp_width_adapter:in_channel
	wire          router_003_src_startofpacket;                                        // router_003:src_startofpacket -> agilex_hps_f2h_axi_slave_wr_rsp_width_adapter:in_startofpacket
	wire          router_003_src_endofpacket;                                          // router_003:src_endofpacket -> agilex_hps_f2h_axi_slave_wr_rsp_width_adapter:in_endofpacket
	...
	wire  [160:0] agilex_hps_f2h_axi_slave_wr_rsp_width_adapter_src_data;              // agilex_hps_f2h_axi_slave_wr_rsp_width_adapter:out_data -> rsp_demux:sink_data
	...
	wire    [2:0] agilex_hps_f2h_axi_slave_wr_rsp_width_adapter_src_channel;           // agilex_hps_f2h_axi_slave_wr_rsp_width_adapter:out_channel -> rsp_demux:sink_channel
	...
	wire          router_004_src_valid;                                                // router_004:src_valid -> agilex_hps_f2h_axi_slave_rd_rsp_width_adapter:in_valid
	wire  [700:0] router_004_src_data;                                                 // router_004:src_data -> agilex_hps_f2h_axi_slave_rd_rsp_width_adapter:in_data
	wire          router_004_src_ready;                                                // agilex_hps_f2h_axi_slave_rd_rsp_width_adapter:in_ready -> router_004:src_ready
	wire    [2:0] router_004_src_channel;                                              // router_004:src_channel -> agilex_hps_f2h_axi_slave_rd_rsp_width_adapter:in_channel
	wire          router_004_src_startofpacket;                                        // router_004:src_startofpacket -> agilex_hps_f2h_axi_slave_rd_rsp_width_adapter:in_startofpacket
	wire          router_004_src_endofpacket;                                          // router_004:src_endofpacket -> agilex_hps_f2h_axi_slave_rd_rsp_width_adapter:in_endofpacket
	...
	wire  [160:0] agilex_hps_f2h_axi_slave_rd_rsp_width_adapter_src_data;              // agilex_hps_f2h_axi_slave_rd_rsp_width_adapter:out_data -> rsp_demux_001:sink_data
	...
	wire    [2:0] agilex_hps_f2h_axi_slave_rd_rsp_width_adapter_src_channel;           // agilex_hps_f2h_axi_slave_rd_rsp_width_adapter:out_channel -> rsp_demux_001:sink_channel
	...
	wire    [2:0] jtag2mm_s_master_limiter_cmd_valid_data;                             // jtag2mm_s_master_limiter:cmd_src_valid -> cmd_demux_002:sink_valid
	...
	qsys_top_altera_merlin_axi_master_ni_1941_dfsyzvi #(
		...
		.write_cp_data          (axi_conduit_merger_0_altera_axi_master_agent_write_cp_data),          //  output,  width = 161,                 .data
		...
		.write_rp_data          (rsp_mux_src_data),                                                    //   input,  width = 161,                 .data
		...
		.read_cp_data           (axi_conduit_merger_0_altera_axi_master_agent_read_cp_data),           //  output,  width = 161,                 .data
		...
		.read_rp_data           (rsp_mux_001_src_data),                                                //   input,  width = 161,                 .data
		...
		.awid                   (axi_conduit_merger_0_altera_axi_master_awid),                         //   input,    width = 4, altera_axi_slave.awid
		.awaddr                 (axi_conduit_merger_0_altera_axi_master_awaddr),                       //   input,   width = 32,                 .awaddr
		.awlen                  (axi_conduit_merger_0_altera_axi_master_awlen),                        //   input,    width = 4,                 .awlen
		.awsize                 (axi_conduit_merger_0_altera_axi_master_awsize),                       //   input,    width = 3,                 .awsize
		.awburst                (axi_conduit_merger_0_altera_axi_master_awburst),                      //   input,    width = 2,                 .awburst
		.awlock                 (axi_conduit_merger_0_altera_axi_master_awlock),                       //   input,    width = 2,                 .awlock
		.awcache                (axi_conduit_merger_0_altera_axi_master_awcache),                      //   input,    width = 4,                 .awcache
		.awprot                 (axi_conduit_merger_0_altera_axi_master_awprot),                       //   input,    width = 3,                 .awprot
		.awvalid                (axi_conduit_merger_0_altera_axi_master_awvalid),                      //   input,    width = 1,                 .awvalid
		.awready                (axi_conduit_merger_0_altera_axi_master_awready),                      //  output,    width = 1,                 .awready
		.wid                    (axi_conduit_merger_0_altera_axi_master_wid),                          //   input,    width = 4,                 .wid
		.wdata                  (axi_conduit_merger_0_altera_axi_master_wdata),                        //   input,   width = 32,                 .wdata
		.wstrb                  (axi_conduit_merger_0_altera_axi_master_wstrb),                        //   input,    width = 4,                 .wstrb
		.wlast                  (axi_conduit_merger_0_altera_axi_master_wlast),                        //   input,    width = 1,                 .wlast
		.wvalid                 (axi_conduit_merger_0_altera_axi_master_wvalid),                       //   input,    width = 1,                 .wvalid
		.wready                 (axi_conduit_merger_0_altera_axi_master_wready),                       //  output,    width = 1,                 .wready
		.bid                    (axi_conduit_merger_0_altera_axi_master_bid),                          //  output,    width = 4,                 .bid
		.bresp                  (axi_conduit_merger_0_altera_axi_master_bresp),                        //  output,    width = 2,                 .bresp
		.bvalid                 (axi_conduit_merger_0_altera_axi_master_bvalid),                       //  output,    width = 1,                 .bvalid
		.bready                 (axi_conduit_merger_0_altera_axi_master_bready),                       //   input,    width = 1,                 .bready
		.arid                   (axi_conduit_merger_0_altera_axi_master_arid),                         //   input,    width = 4,                 .arid
		.araddr                 (axi_conduit_merger_0_altera_axi_master_araddr),                       //   input,   width = 32,                 .araddr
		.arlen                  (axi_conduit_merger_0_altera_axi_master_arlen),                        //   input,    width = 4,                 .arlen
		.arsize                 (axi_conduit_merger_0_altera_axi_master_arsize),                       //   input,    width = 3,                 .arsize
		.arburst                (axi_conduit_merger_0_altera_axi_master_arburst),                      //   input,    width = 2,                 .arburst
		.arlock                 (axi_conduit_merger_0_altera_axi_master_arlock),                       //   input,    width = 2,                 .arlock
		.arcache                (axi_conduit_merger_0_altera_axi_master_arcache),                      //   input,    width = 4,                 .arcache
		.arprot                 (axi_conduit_merger_0_altera_axi_master_arprot),                       //   input,    width = 3,                 .arprot
		.arvalid                (axi_conduit_merger_0_altera_axi_master_arvalid),                      //   input,    width = 1,                 .arvalid
		.arready                (axi_conduit_merger_0_altera_axi_master_arready),                      //  output,    width = 1,                 .arready
		.rid                    (axi_conduit_merger_0_altera_axi_master_rid),                          //  output,    width = 4,                 .rid
		.rdata                  (axi_conduit_merger_0_altera_axi_master_rdata),                        //  output,   width = 32,                 .rdata
		.rresp                  (axi_conduit_merger_0_altera_axi_master_rresp),                        //  output,    width = 2,                 .rresp
		.rlast                  (axi_conduit_merger_0_altera_axi_master_rlast),                        //  output,    width = 1,                 .rlast
		.rvalid                 (axi_conduit_merger_0_altera_axi_master_rvalid),                       //  output,    width = 1,                 .rvalid
		.rready                 (axi_conduit_merger_0_altera_axi_master_rready),                       //   input,    width = 1,                 .rready
		.awuser                 (5'b00000),                                                            // (terminated),                                
		.aruser                 (5'b00000),                                                            // (terminated),                                
	...
	qsys_top_altera_merlin_master_agent_191_mpbm6tq #(
		...
		.cp_data               (jtag2mm_s_master_agent_cp_data),                                      //  output,  width = 161,          .data
		...
		.rp_data               (jtag2mm_s_master_limiter_rsp_src_data),                               //   input,  width = 161,          .data
		.rp_channel            (jtag2mm_s_master_limiter_rsp_src_channel),                            //   input,    width = 3,          .channel
	...
	qsys_top_altera_merlin_axi_slave_ni_1941_xhkhqui #(
		.PKT_QOS_H                   (673),
		.PKT_QOS_L                   (670),
		.PKT_THREAD_ID_H             (679),
		.PKT_THREAD_ID_L             (676),
		.PKT_RESPONSE_STATUS_H       (688),
		.PKT_RESPONSE_STATUS_L       (687),
		.PKT_BEGIN_BURST             (669),
		.PKT_CACHE_H                 (686),
		.PKT_CACHE_L                 (683),
		...
		.PKT_DEST_ID_H               (675),
		.PKT_DEST_ID_L               (675),
		.PKT_ORI_BURST_SIZE_L        (689),
		.PKT_ORI_BURST_SIZE_H        (691),
		.PKT_DOMAIN_L                (698),
		.PKT_DOMAIN_H                (699),
		.PKT_SNOOP_L                 (694),
		.PKT_SNOOP_H                 (697),
		...
		.read_cp_data           (agilex_hps_f2h_axi_slave_rd_cmd_width_adapter_src_data),          //   input,  width = 701,                  .data
		.read_cp_channel        (agilex_hps_f2h_axi_slave_rd_cmd_width_adapter_src_channel),       //   input,    width = 3,                  .channel
		...
		.write_cp_data          (agilex_hps_f2h_axi_slave_wr_cmd_width_adapter_src_data),          //   input,  width = 701,                  .data
		.write_cp_channel       (agilex_hps_f2h_axi_slave_wr_cmd_width_adapter_src_channel),       //   input,    width = 3,                  .channel
		...
		.read_rp_data           (agilex_hps_f2h_axi_slave_agent_read_rp_data),                     //  output,  width = 701,                  .data
		...
		.write_rp_data          (agilex_hps_f2h_axi_slave_agent_write_rp_data),                    //  output,  width = 701,                  .data
	...
	qsys_top_altera_merlin_router_1921_aof5may router (
		...
		.sink_data          (axi_conduit_merger_0_altera_axi_master_agent_write_cp_data),          //   input,  width = 161,          .data
		...
		.src_data           (router_src_data),                                                     //  output,  width = 161,          .data
		.src_channel        (router_src_channel),                                                  //  output,    width = 3,          .channel
		.src_startofpacket  (router_src_startofpacket),                                            //  output,    width = 1,          .startofpacket
		.src_endofpacket    (router_src_endofpacket)                                               //  output,    width = 1,          .endofpacket
	);

	qsys_top_altera_merlin_router_1921_vmxazhq router_001 (
		...
		.sink_data          (axi_conduit_merger_0_altera_axi_master_agent_read_cp_data),          //   input,  width = 161,          .data
		...
		.src_data           (router_001_src_data),                                                //  output,  width = 161,          .data
		.src_channel        (router_001_src_channel),                                             //  output,    width = 3,          .channel
		.src_startofpacket  (router_001_src_startofpacket),                                       //  output,    width = 1,          .startofpacket
		.src_endofpacket    (router_001_src_endofpacket)                                          //  output,    width = 1,          .endofpacket
	);

	qsys_top_altera_merlin_router_1921_lowxgiq router_002 (
		...
		.sink_data          (jtag2mm_s_master_agent_cp_data),                                //   input,  width = 161,          .data
		...
		.src_data           (router_002_src_data),                                           //  output,  width = 161,          .data
		.src_channel        (router_002_src_channel),                                        //  output,    width = 3,          .channel
		.src_startofpacket  (router_002_src_startofpacket),                                  //  output,    width = 1,          .startofpacket
		.src_endofpacket    (router_002_src_endofpacket)                                     //  output,    width = 1,          .endofpacket
	);

	qsys_top_altera_merlin_router_1921_63putmq router_003 (
		...
		.sink_data          (agilex_hps_f2h_axi_slave_agent_write_rp_data),                  //   input,  width = 701,          .data
		...
		.src_data           (router_003_src_data),                                           //  output,  width = 701,          .data
	...
	qsys_top_altera_merlin_router_1921_2tisvai router_004 (
		...
		.sink_data          (agilex_hps_f2h_axi_slave_agent_read_rp_data),                   //   input,  width = 701,          .data
		...
		.src_data           (router_004_src_data),                                           //  output,  width = 701,          .data
	...
	qsys_top_altera_merlin_traffic_limiter_191_6blplji #(
		...
		.cmd_sink_data          (router_002_src_data),                                           //   input,  width = 161,          .data
		...
		.cmd_src_data           (jtag2mm_s_master_limiter_cmd_src_data),                         //  output,  width = 161,          .data
		.cmd_src_channel        (jtag2mm_s_master_limiter_cmd_src_channel),                      //  output,    width = 3,          .channel
		...
		.rsp_sink_data          (rsp_mux_002_src_data),                                          //   input,  width = 161,          .data
		...
		.rsp_src_data           (jtag2mm_s_master_limiter_rsp_src_data),                         //  output,  width = 161,          .data
		.rsp_src_channel        (jtag2mm_s_master_limiter_rsp_src_channel),                      //  output,    width = 3,          .channel
		...
		.cmd_src_valid          (jtag2mm_s_master_limiter_cmd_valid_data)                        //  output,    width = 3, cmd_valid.data
	);

	qsys_top_altera_merlin_demultiplexer_1921_qqjm6ia cmd_demux (
		.clk                (clk_100_out_clk_clk),                                           //   input,    width = 1,       clk.clk
		.reset              (jtag2mm_s_master_translator_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
		.sink_ready         (router_src_ready),                                              //  output,    width = 1,      sink.ready
		.sink_channel       (router_src_channel),                                            //   input,    width = 3,          .channel
		.sink_data          (router_src_data),                                               //   input,  width = 161,          .data
		...
		.src0_data          (cmd_demux_src0_data),                                           //  output,  width = 161,          .data
		.src0_channel       (cmd_demux_src0_channel),                                        //  output,    width = 3,          .channel
		.src0_startofpacket (cmd_demux_src0_startofpacket),                                  //  output,    width = 1,          .startofpacket
		.src0_endofpacket   (cmd_demux_src0_endofpacket)                                     //  output,    width = 1,          .endofpacket
	);

	qsys_top_altera_merlin_demultiplexer_1921_qqjm6ia cmd_demux_001 (
		.clk                (clk_100_out_clk_clk),                                           //   input,    width = 1,       clk.clk
		.reset              (jtag2mm_s_master_translator_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
		.sink_ready         (router_001_src_ready),                                          //  output,    width = 1,      sink.ready
		.sink_channel       (router_001_src_channel),                                        //   input,    width = 3,          .channel
		.sink_data          (router_001_src_data),                                           //   input,  width = 161,          .data
		...
		.src0_data          (cmd_demux_001_src0_data),                                       //  output,  width = 161,          .data
	...
	qsys_top_altera_merlin_demultiplexer_1921_l2tkdsy cmd_demux_002 (
		.clk                (clk_100_out_clk_clk),                                           //   input,    width = 1,        clk.clk
		.reset              (jtag2mm_s_master_translator_reset_reset_bridge_in_reset_reset), //   input,    width = 1,  clk_reset.reset
		.sink_ready         (jtag2mm_s_master_limiter_cmd_src_ready),                        //  output,    width = 1,       sink.ready
		.sink_channel       (jtag2mm_s_master_limiter_cmd_src_channel),                      //   input,    width = 3,           .channel
		.sink_data          (jtag2mm_s_master_limiter_cmd_src_data),                         //   input,  width = 161,           .data
		.sink_startofpacket (jtag2mm_s_master_limiter_cmd_src_startofpacket),                //   input,    width = 1,           .startofpacket
		.sink_endofpacket   (jtag2mm_s_master_limiter_cmd_src_endofpacket),                  //   input,    width = 1,           .endofpacket
		.sink_valid         (jtag2mm_s_master_limiter_cmd_valid_data),                       //   input,    width = 3, sink_valid.data
		.src0_ready         (cmd_demux_002_src0_ready),                                      //   input,    width = 1,       src0.ready
		.src0_valid         (cmd_demux_002_src0_valid),                                      //  output,    width = 1,           .valid
		.src0_data          (cmd_demux_002_src0_data),                                       //  output,  width = 161,           .data
		...
		.src1_data          (cmd_demux_002_src1_data),                                       //  output,  width = 161,           .data
	...
	qsys_top_altera_merlin_multiplexer_1921_eg2ikoy cmd_mux (
		.clk                 (clk_100_out_clk_clk),                                           //   input,    width = 1,       clk.clk
		.reset               (jtag2mm_s_master_translator_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
		.src_ready           (cmd_mux_src_ready),                                             //   input,    width = 1,       src.ready
		.src_valid           (cmd_mux_src_valid),                                             //  output,    width = 1,          .valid
		.src_data            (cmd_mux_src_data),                                              //  output,  width = 161,          .data
		...
		.sink0_data          (cmd_demux_src0_data),                                           //   input,  width = 161,          .data
		...
		.sink1_data          (cmd_demux_002_src0_data),                                       //   input,  width = 161,          .data
	...
	qsys_top_altera_merlin_multiplexer_1921_eg2ikoy cmd_mux_001 (
		.clk                 (clk_100_out_clk_clk),                                           //   input,    width = 1,       clk.clk
		.reset               (jtag2mm_s_master_translator_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
		.src_ready           (cmd_mux_001_src_ready),                                         //   input,    width = 1,       src.ready
		.src_valid           (cmd_mux_001_src_valid),                                         //  output,    width = 1,          .valid
		.src_data            (cmd_mux_001_src_data),                                          //  output,  width = 161,          .data
		...
		.sink0_data          (cmd_demux_001_src0_data),                                       //   input,  width = 161,          .data
		...
		.sink1_data          (cmd_demux_002_src1_data),                                       //   input,  width = 161,          .data
	...
	qsys_top_altera_merlin_demultiplexer_1921_ko6jjta rsp_demux (
		.clk                (clk_100_out_clk_clk),                                             //   input,    width = 1,       clk.clk
		.reset              (jtag2mm_s_master_translator_reset_reset_bridge_in_reset_reset),   //   input,    width = 1, clk_reset.reset
		.sink_ready         (agilex_hps_f2h_axi_slave_wr_rsp_width_adapter_src_ready),         //  output,    width = 1,      sink.ready
		.sink_channel       (agilex_hps_f2h_axi_slave_wr_rsp_width_adapter_src_channel),       //   input,    width = 3,          .channel
		.sink_data          (agilex_hps_f2h_axi_slave_wr_rsp_width_adapter_src_data),          //   input,  width = 161,          .data
		...
		.src0_data          (rsp_demux_src0_data),                                             //  output,  width = 161,          .data
		...
		.src1_data          (rsp_demux_src1_data),                                             //  output,  width = 161,          .data
	...
	qsys_top_altera_merlin_demultiplexer_1921_ko6jjta rsp_demux_001 (
		.clk                (clk_100_out_clk_clk),                                             //   input,    width = 1,       clk.clk
		.reset              (jtag2mm_s_master_translator_reset_reset_bridge_in_reset_reset),   //   input,    width = 1, clk_reset.reset
		.sink_ready         (agilex_hps_f2h_axi_slave_rd_rsp_width_adapter_src_ready),         //  output,    width = 1,      sink.ready
		.sink_channel       (agilex_hps_f2h_axi_slave_rd_rsp_width_adapter_src_channel),       //   input,    width = 3,          .channel
		.sink_data          (agilex_hps_f2h_axi_slave_rd_rsp_width_adapter_src_data),          //   input,  width = 161,          .data
		...
		.src0_data          (rsp_demux_001_src0_data),                                         //  output,  width = 161,          .data
		...
		.src1_data          (rsp_demux_001_src1_data),                                         //  output,  width = 161,          .data
	...
	qsys_top_altera_merlin_multiplexer_1921_vq247yq rsp_mux (
		.clk                 (clk_100_out_clk_clk),                                           //   input,    width = 1,       clk.clk
		.reset               (jtag2mm_s_master_translator_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
		.src_ready           (rsp_mux_src_ready),                                             //   input,    width = 1,       src.ready
		.src_valid           (rsp_mux_src_valid),                                             //  output,    width = 1,          .valid
		.src_data            (rsp_mux_src_data),                                              //  output,  width = 161,          .data
		...
		.sink0_data          (rsp_demux_src0_data),                                           //   input,  width = 161,          .data
		.sink0_startofpacket (rsp_demux_src0_startofpacket),                                  //   input,    width = 1,          .startofpacket
		.sink0_endofpacket   (rsp_demux_src0_endofpacket)                                     //   input,    width = 1,          .endofpacket
	);

	qsys_top_altera_merlin_multiplexer_1921_vq247yq rsp_mux_001 (
		.clk                 (clk_100_out_clk_clk),                                           //   input,    width = 1,       clk.clk
		.reset               (jtag2mm_s_master_translator_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
		.src_ready           (rsp_mux_001_src_ready),                                         //   input,    width = 1,       src.ready
		.src_valid           (rsp_mux_001_src_valid),                                         //  output,    width = 1,          .valid
		.src_data            (rsp_mux_001_src_data),                                          //  output,  width = 161,          .data
		...
		.sink0_data          (rsp_demux_001_src0_data),                                       //   input,  width = 161,          .data
	...
	qsys_top_altera_merlin_multiplexer_1921_tdoyxxa rsp_mux_002 (
		.clk                 (clk_100_out_clk_clk),                                           //   input,    width = 1,       clk.clk
		.reset               (jtag2mm_s_master_translator_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
		.src_ready           (rsp_mux_002_src_ready),                                         //   input,    width = 1,       src.ready
		.src_valid           (rsp_mux_002_src_valid),                                         //  output,    width = 1,          .valid
		.src_data            (rsp_mux_002_src_data),                                          //  output,  width = 161,          .data
		...
		.sink0_data          (rsp_demux_src1_data),                                           //   input,  width = 161,          .data
		...
		.sink1_data          (rsp_demux_001_src1_data),                                       //   input,  width = 161,          .data
	...
	qsys_top_altera_merlin_width_adapter_1920_pionvia #(
		.IN_PKT_ADDR_H                 (67),
		.IN_PKT_ADDR_L                 (36),
		.IN_PKT_DATA_H                 (31),
		.IN_PKT_DATA_L                 (0),
		...
		.OUT_PKT_RESPONSE_STATUS_H     (688),
		.OUT_PKT_RESPONSE_STATUS_L     (687),
		.OUT_PKT_TRANS_EXCLUSIVE       (613),
		.OUT_PKT_BURST_TYPE_H          (644),
		.OUT_PKT_BURST_TYPE_L          (643),
		.OUT_PKT_ORI_BURST_SIZE_L      (689),
		.OUT_PKT_ORI_BURST_SIZE_H      (691),
		.OUT_ST_DATA_W                 (701),
		.ST_CHANNEL_W                  (3),
		.OPTIMIZE_FOR_RSP              (0),
		.RESPONSE_PATH                 (0),
		...
		.in_data              (cmd_mux_src_data),                                                //   input,  width = 161,          .data
		.out_endofpacket      (agilex_hps_f2h_axi_slave_wr_cmd_width_adapter_src_endofpacket),   //  output,    width = 1,       src.endofpacket
		.out_data             (agilex_hps_f2h_axi_slave_wr_cmd_width_adapter_src_data),          //  output,  width = 701,          .data
		.out_channel          (agilex_hps_f2h_axi_slave_wr_cmd_width_adapter_src_channel),       //  output,    width = 3,          .channel
	...
	qsys_top_altera_merlin_width_adapter_1920_pionvia #(
		...
		.in_data              (cmd_mux_001_src_data),                                            //   input,  width = 161,          .data
		.out_endofpacket      (agilex_hps_f2h_axi_slave_rd_cmd_width_adapter_src_endofpacket),   //  output,    width = 1,       src.endofpacket
		.out_data             (agilex_hps_f2h_axi_slave_rd_cmd_width_adapter_src_data),          //  output,  width = 701,          .data
		.out_channel          (agilex_hps_f2h_axi_slave_rd_cmd_width_adapter_src_channel),       //  output,    width = 3,          .channel
	...
	qsys_top_altera_merlin_width_adapter_1920_nql5sya #(
		.IN_PKT_ADDR_H                 (607),
		.IN_PKT_ADDR_L                 (576),
		.IN_PKT_DATA_H                 (511),
		.IN_PKT_DATA_L                 (0),
		...
		.IN_PKT_RESPONSE_STATUS_H      (688),
		.IN_PKT_RESPONSE_STATUS_L      (687),
		.IN_PKT_TRANS_EXCLUSIVE        (613),
		.IN_PKT_BURST_TYPE_H           (644),
		.IN_PKT_BURST_TYPE_L           (643),
		.IN_PKT_ORI_BURST_SIZE_L       (689),
		.IN_PKT_ORI_BURST_SIZE_H       (691),
		.IN_ST_DATA_W                  (701),
		.OUT_PKT_ADDR_H                (67),
		.OUT_PKT_ADDR_L                (36),
		.OUT_PKT_DATA_H                (31),
		...
		.in_data              (router_003_src_data),                                             //   input,  width = 701,          .data
		.out_endofpacket      (agilex_hps_f2h_axi_slave_wr_rsp_width_adapter_src_endofpacket),   //  output,    width = 1,       src.endofpacket
		.out_data             (agilex_hps_f2h_axi_slave_wr_rsp_width_adapter_src_data),          //  output,  width = 161,          .data
		.out_channel          (agilex_hps_f2h_axi_slave_wr_rsp_width_adapter_src_channel),       //  output,    width = 3,          .channel
	...
	qsys_top_altera_merlin_width_adapter_1920_nql5sya #(
		...
		.in_data              (router_004_src_data),                                             //   input,  width = 701,          .data
		.out_endofpacket      (agilex_hps_f2h_axi_slave_rd_rsp_width_adapter_src_endofpacket),   //  output,    width = 1,       src.endofpacket
		.out_data             (agilex_hps_f2h_axi_slave_rd_rsp_width_adapter_src_data),          //  output,  width = 161,          .data
		.out_channel          (agilex_hps_f2h_axi_slave_rd_rsp_width_adapter_src_channel),       //  output,    width = 3,          .channel
