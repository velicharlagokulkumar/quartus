// qsys_top_altera_mm_interconnect_1920_zzrdqra.v
...
`timescale 1 ps / 1 ps
module qsys_top_altera_mm_interconnect_1920_zzrdqra (
	...
	wire  [134:0] cmd_mux_src_data;                                                     // cmd_mux:src_data -> pio_0_s1_burst_adapter:sink0_data
	wire          cmd_mux_src_ready;                                                    // pio_0_s1_burst_adapter:sink0_ready -> cmd_mux:src_ready
	wire    [2:0] cmd_mux_src_channel;                                                  // cmd_mux:src_channel -> pio_0_s1_burst_adapter:sink0_channel
	...
	wire  [134:0] cmd_mux_001_src_data;                                                 // cmd_mux_001:src_data -> ocm_s1_burst_adapter:sink0_data
	wire          cmd_mux_001_src_ready;                                                // ocm_s1_burst_adapter:sink0_ready -> cmd_mux_001:src_ready
	wire    [2:0] cmd_mux_001_src_channel;                                              // cmd_mux_001:src_channel -> ocm_s1_burst_adapter:sink0_channel
	...
	wire  [134:0] pio_0_s1_burst_adapter_source0_data;                                  // pio_0_s1_burst_adapter:source0_data -> agent_pipeline:in_data
	wire          pio_0_s1_burst_adapter_source0_ready;                                 // agent_pipeline:in_ready -> pio_0_s1_burst_adapter:source0_ready
	wire    [2:0] pio_0_s1_burst_adapter_source0_channel;                               // pio_0_s1_burst_adapter:source0_channel -> agent_pipeline:in_channel
	...
	wire  [134:0] agent_pipeline_source0_data;                                          // agent_pipeline:out_data -> pio_0_s1_agent:cp_data
	wire          agent_pipeline_source0_ready;                                         // pio_0_s1_agent:cp_ready -> agent_pipeline:out_ready
	wire    [2:0] agent_pipeline_source0_channel;                                       // agent_pipeline:out_channel -> pio_0_s1_agent:cp_channel
	...
	wire  [134:0] pio_0_s1_agent_rp_data;                                               // pio_0_s1_agent:rp_data -> agent_pipeline_001:in_data
	...
	wire  [134:0] ocm_s1_burst_adapter_source0_data;                                    // ocm_s1_burst_adapter:source0_data -> agent_pipeline_002:in_data
	wire          ocm_s1_burst_adapter_source0_ready;                                   // agent_pipeline_002:in_ready -> ocm_s1_burst_adapter:source0_ready
	wire    [2:0] ocm_s1_burst_adapter_source0_channel;                                 // ocm_s1_burst_adapter:source0_channel -> agent_pipeline_002:in_channel
	...
	wire  [134:0] agent_pipeline_002_source0_data;                                      // agent_pipeline_002:out_data -> ocm_s1_agent:cp_data
	wire          agent_pipeline_002_source0_ready;                                     // ocm_s1_agent:cp_ready -> agent_pipeline_002:out_ready
	wire    [2:0] agent_pipeline_002_source0_channel;                                   // agent_pipeline_002:out_channel -> ocm_s1_agent:cp_channel
	...
	wire  [134:0] ocm_s1_agent_rp_data;                                                 // ocm_s1_agent:rp_data -> agent_pipeline_003:in_data
	...
	qsys_top_altera_merlin_router_1921_g6zdmna router (
	...
	qsys_top_altera_merlin_router_1921_g6zdmna router_001 (
	...
	qsys_top_altera_merlin_router_1921_h3nvlua router_002 (
