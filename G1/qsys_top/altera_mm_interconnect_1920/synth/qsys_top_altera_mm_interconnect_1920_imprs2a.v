// qsys_top_altera_mm_interconnect_1920_imprs2a.v
...
`timescale 1 ps / 1 ps
module qsys_top_altera_mm_interconnect_1920_imprs2a (
	...
	wire    [2:0] rsp_mux_src_channel;                                                 // rsp_mux:src_channel -> agilex_hps_h2f_axi_master_agent:write_rp_channel
	...
	wire    [2:0] rsp_mux_001_src_channel;                                             // rsp_mux_001:src_channel -> agilex_hps_h2f_axi_master_agent:read_rp_channel
	...
	wire          rsp_mux_002_src_valid;                                               // rsp_mux_002:src_valid -> fpga_m2ocm_pb_m0_agent:rp_valid
	wire  [242:0] rsp_mux_002_src_data;                                                // rsp_mux_002:src_data -> fpga_m2ocm_pb_m0_agent:rp_data
	wire          rsp_mux_002_src_ready;                                               // fpga_m2ocm_pb_m0_agent:rp_ready -> rsp_mux_002:src_ready
	wire    [2:0] rsp_mux_002_src_channel;                                             // rsp_mux_002:src_channel -> fpga_m2ocm_pb_m0_agent:rp_channel
	wire          rsp_mux_002_src_startofpacket;                                       // rsp_mux_002:src_startofpacket -> fpga_m2ocm_pb_m0_agent:rp_startofpacket
	wire          rsp_mux_002_src_endofpacket;                                         // rsp_mux_002:src_endofpacket -> fpga_m2ocm_pb_m0_agent:rp_endofpacket
	...
	wire          fpga_m2ocm_pb_m0_agent_cp_valid;                                     // fpga_m2ocm_pb_m0_agent:cp_valid -> router_002:sink_valid
	wire  [242:0] fpga_m2ocm_pb_m0_agent_cp_data;                                      // fpga_m2ocm_pb_m0_agent:cp_data -> router_002:sink_data
	wire          fpga_m2ocm_pb_m0_agent_cp_ready;                                     // router_002:sink_ready -> fpga_m2ocm_pb_m0_agent:cp_ready
	wire          fpga_m2ocm_pb_m0_agent_cp_startofpacket;                             // fpga_m2ocm_pb_m0_agent:cp_startofpacket -> router_002:sink_startofpacket
	wire          fpga_m2ocm_pb_m0_agent_cp_endofpacket;                               // fpga_m2ocm_pb_m0_agent:cp_endofpacket -> router_002:sink_endofpacket
	wire          router_002_src_valid;                                                // router_002:src_valid -> cmd_demux_002:sink_valid
	wire  [242:0] router_002_src_data;                                                 // router_002:src_data -> cmd_demux_002:sink_data
	...
	wire          router_003_src_valid;                                                // router_003:src_valid -> ocm_s1_rsp_width_adapter:in_valid
	wire  [134:0] router_003_src_data;                                                 // router_003:src_data -> ocm_s1_rsp_width_adapter:in_data
	wire          router_003_src_ready;                                                // ocm_s1_rsp_width_adapter:in_ready -> router_003:src_ready
	wire    [2:0] router_003_src_channel;                                              // router_003:src_channel -> ocm_s1_rsp_width_adapter:in_channel
	wire          router_003_src_startofpacket;                                        // router_003:src_startofpacket -> ocm_s1_rsp_width_adapter:in_startofpacket
	wire          router_003_src_endofpacket;                                          // router_003:src_endofpacket -> ocm_s1_rsp_width_adapter:in_endofpacket
	...
	wire    [2:0] ocm_s1_rsp_width_adapter_src_channel;                                // ocm_s1_rsp_width_adapter:out_channel -> rsp_demux:sink_channel
	...
	wire    [2:0] cmd_mux_src_channel;                                                 // cmd_mux:src_channel -> ocm_s1_cmd_width_adapter:in_channel
	...
	wire    [2:0] ocm_s1_cmd_width_adapter_src_channel;                                // ocm_s1_cmd_width_adapter:out_channel -> ocm_s1_burst_adapter:sink0_channel
	...
	wire  [242:0] cmd_demux_002_src0_data;                                             // cmd_demux_002:src0_data -> mux_pipeline_002:in_data
	...
	wire  [242:0] mux_pipeline_002_source0_data;                                       // mux_pipeline_002:out_data -> cmd_mux:sink2_data
	...
	wire  [242:0] rsp_demux_src0_data;                                                 // rsp_demux:src0_data -> mux_pipeline_003:in_data
	...
	wire  [242:0] mux_pipeline_003_source0_data;                                       // mux_pipeline_003:out_data -> rsp_mux:sink0_data
	...
	wire  [242:0] rsp_demux_src1_data;                                                 // rsp_demux:src1_data -> mux_pipeline_004:in_data
	...
	wire  [242:0] mux_pipeline_004_source0_data;                                       // mux_pipeline_004:out_data -> rsp_mux_001:sink0_data
	...
	wire  [242:0] rsp_demux_src2_data;                                                 // rsp_demux:src2_data -> mux_pipeline_005:in_data
	...
	wire  [242:0] mux_pipeline_005_source0_data;                                       // mux_pipeline_005:out_data -> rsp_mux_002:sink0_data
	...
	qsys_top_altera_merlin_master_agent_191_mpbm6tq #(
		...
		.cp_data               (fpga_m2ocm_pb_m0_agent_cp_data),                                             //  output,  width = 243,          .data
		...
		.rp_data               (rsp_mux_002_src_data),                                                       //   input,  width = 243,          .data
	...
	qsys_top_altera_merlin_router_1921_i7ndrqy router (
	...
	qsys_top_altera_merlin_router_1921_i7ndrqy router_001 (
	...
	qsys_top_altera_merlin_router_1921_m5vemli router_002 (
		...
		.sink_data          (fpga_m2ocm_pb_m0_agent_cp_data),                                             //   input,  width = 243,          .data
	...
	qsys_top_altera_merlin_burst_adapter_1923_dxqle7a #(
		...
		.sink0_channel         (ocm_s1_cmd_width_adapter_src_channel),                                       //   input,    width = 3,          .channel
	...
	qsys_top_altera_merlin_demultiplexer_1921_upt6kay cmd_demux (
		.clk                (clk_100_out_clk_clk),                                                        //   input,    width = 1,       clk.clk
		.reset              (agilex_hps_h2f_axi_master_translator_clk_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	qsys_top_altera_merlin_demultiplexer_1921_upt6kay cmd_demux_001 (
		.clk                (clk_100_out_clk_clk),                                                        //   input,    width = 1,       clk.clk
		.reset              (agilex_hps_h2f_axi_master_translator_clk_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	qsys_top_altera_merlin_demultiplexer_1921_upt6kay cmd_demux_002 (
		.clk                (clk_100_out_clk_clk),                                                        //   input,    width = 1,       clk.clk
		.reset              (agilex_hps_h2f_axi_master_translator_clk_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
		...
		.src0_data          (cmd_demux_002_src0_data),                                                    //  output,  width = 243,          .data
	...
	qsys_top_altera_merlin_multiplexer_1921_cmx766a cmd_mux (
		.clk                 (clk_100_out_clk_clk),                                                        //   input,    width = 1,       clk.clk
		.reset               (agilex_hps_h2f_axi_master_translator_clk_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
		...
		.sink2_data          (mux_pipeline_002_source0_data),                                              //   input,  width = 243,          .data
	...
	qsys_top_altera_merlin_demultiplexer_1921_lzqylyy rsp_demux (
		.clk                (clk_100_out_clk_clk),                                                        //   input,    width = 1,       clk.clk
		.reset              (agilex_hps_h2f_axi_master_translator_clk_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
		.sink_ready         (ocm_s1_rsp_width_adapter_src_ready),                                         //  output,    width = 1,      sink.ready
		.sink_channel       (ocm_s1_rsp_width_adapter_src_channel),                                       //   input,    width = 3,          .channel
		...
		.src2_data          (rsp_demux_src2_data),                                                        //  output,  width = 243,          .data
	...
	qsys_top_altera_merlin_multiplexer_1921_s4dky2y rsp_mux (
		.clk                 (clk_100_out_clk_clk),                                                        //   input,    width = 1,       clk.clk
		.reset               (agilex_hps_h2f_axi_master_translator_clk_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
		...
		.sink0_data          (mux_pipeline_003_source0_data),                                              //   input,  width = 243,          .data
	...
	qsys_top_altera_merlin_multiplexer_1921_s4dky2y rsp_mux_001 (
		.clk                 (clk_100_out_clk_clk),                                                        //   input,    width = 1,       clk.clk
		.reset               (agilex_hps_h2f_axi_master_translator_clk_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	qsys_top_altera_merlin_multiplexer_1921_s4dky2y rsp_mux_002 (
		.clk                 (clk_100_out_clk_clk),                                                        //   input,    width = 1,       clk.clk
		.reset               (agilex_hps_h2f_axi_master_translator_clk_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
		.src_ready           (rsp_mux_002_src_ready),                                                      //   input,    width = 1,       src.ready
		.src_valid           (rsp_mux_002_src_valid),                                                      //  output,    width = 1,          .valid
		.src_data            (rsp_mux_002_src_data),                                                       //  output,  width = 243,          .data
		...
		.sink0_data          (mux_pipeline_005_source0_data),                                              //   input,  width = 243,          .data
	...
	qsys_top_altera_merlin_width_adapter_1920_o6ymenq #(
		...
		.out_channel          (ocm_s1_rsp_width_adapter_src_channel),                                       //  output,    width = 3,          .channel
	...
	qsys_top_altera_merlin_width_adapter_1920_b5xd2ga #(
		...
		.out_channel          (ocm_s1_cmd_width_adapter_src_channel),                                       //  output,    width = 3,          .channel
	...
	qsys_top_altera_avalon_st_pipeline_stage_1920_zterisq #(
		...
		.in_data           (cmd_demux_002_src0_data),                              //   input,  width = 243,          .data
	...
	qsys_top_altera_avalon_st_pipeline_stage_1920_zterisq #(
		...
		.in_data           (rsp_demux_src2_data),                                  //   input,  width = 243,          .data
