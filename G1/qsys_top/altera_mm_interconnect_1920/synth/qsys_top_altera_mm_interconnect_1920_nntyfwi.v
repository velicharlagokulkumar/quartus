// qsys_top_altera_mm_interconnect_1920_nntyfwi.v
...
`timescale 1 ps / 1 ps
module qsys_top_altera_mm_interconnect_1920_nntyfwi (
	...
	wire  [136:0] rsp_mux_003_src_data;                                                 // rsp_mux_003:src_data -> dma_0_read_master_agent:rp_data
	...
	wire  [136:0] dma_0_read_master_agent_cp_data;                                      // dma_0_read_master_agent:cp_data -> router_003:sink_data
	...
	wire          cmd_demux_003_src0_valid;                                             // cmd_demux_003:src0_valid -> mux_pipeline_006:in_valid
	wire  [136:0] cmd_demux_003_src0_data;                                              // cmd_demux_003:src0_data -> mux_pipeline_006:in_data
	wire          cmd_demux_003_src0_ready;                                             // mux_pipeline_006:in_ready -> cmd_demux_003:src0_ready
	wire    [3:0] cmd_demux_003_src0_channel;                                           // cmd_demux_003:src0_channel -> mux_pipeline_006:in_channel
	wire          cmd_demux_003_src0_startofpacket;                                     // cmd_demux_003:src0_startofpacket -> mux_pipeline_006:in_startofpacket
	wire          cmd_demux_003_src0_endofpacket;                                       // cmd_demux_003:src0_endofpacket -> mux_pipeline_006:in_endofpacket
	...
	wire    [3:0] mux_pipeline_006_source0_channel;                                     // mux_pipeline_006:out_channel -> cmd_mux_001:sink3_channel
	...
	wire    [3:0] cmd_demux_src2_channel;                                               // cmd_demux:src2_channel -> mux_pipeline_007:in_channel
	...
	wire    [3:0] mux_pipeline_007_source0_channel;                                     // mux_pipeline_007:out_channel -> cmd_mux_002:sink0_channel
	...
	wire    [3:0] cmd_demux_001_src2_channel;                                           // cmd_demux_001:src2_channel -> mux_pipeline_008:in_channel
	...
	wire    [3:0] mux_pipeline_008_source0_channel;                                     // mux_pipeline_008:out_channel -> cmd_mux_002:sink1_channel
	...
	wire    [3:0] cmd_demux_002_src2_channel;                                           // cmd_demux_002:src2_channel -> mux_pipeline_009:in_channel
	...
	wire    [3:0] mux_pipeline_009_source0_channel;                                     // mux_pipeline_009:out_channel -> cmd_mux_002:sink2_channel
	...
	wire          rsp_demux_001_src3_valid;                                             // rsp_demux_001:src3_valid -> mux_pipeline_019:in_valid
	wire  [136:0] rsp_demux_001_src3_data;                                              // rsp_demux_001:src3_data -> mux_pipeline_019:in_data
	wire          rsp_demux_001_src3_ready;                                             // mux_pipeline_019:in_ready -> rsp_demux_001:src3_ready
	wire    [3:0] rsp_demux_001_src3_channel;                                           // rsp_demux_001:src3_channel -> mux_pipeline_019:in_channel
	wire          rsp_demux_001_src3_startofpacket;                                     // rsp_demux_001:src3_startofpacket -> mux_pipeline_019:in_startofpacket
	wire          rsp_demux_001_src3_endofpacket;                                       // rsp_demux_001:src3_endofpacket -> mux_pipeline_019:in_endofpacket
	...
	qsys_top_altera_merlin_router_1921_2mynjka router_003 (
	...
	qsys_top_altera_merlin_router_1921_u6clscy router_005 (
	...
	qsys_top_altera_merlin_router_1921_gjyg27q router_006 (
	...
	qsys_top_altera_merlin_multiplexer_1921_q2diwby cmd_mux_001 (
		.clk                 (clk_100_out_clk_clk),                                                        //   input,    width = 1,       clk.clk
		.reset               (agilex_hps_h2f_axi_master_translator_clk_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
		...
		.sink3_channel       (mux_pipeline_006_source0_channel),                                           //   input,    width = 4,          .channel
	...
	qsys_top_altera_merlin_multiplexer_1921_7sl5mfa cmd_mux_002 (
		.clk                 (clk_100_out_clk_clk),                                                        //   input,    width = 1,       clk.clk
		.reset               (agilex_hps_h2f_axi_master_translator_clk_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
		...
		.sink2_channel       (mux_pipeline_009_source0_channel),                                           //   input,    width = 4,          .channel
	...
	qsys_top_altera_merlin_demultiplexer_1921_gd3iw6a rsp_demux_001 (
		.clk                (clk_100_out_clk_clk),                                                        //   input,    width = 1,       clk.clk
		.reset              (agilex_hps_h2f_axi_master_translator_clk_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	qsys_top_altera_merlin_demultiplexer_1921_odws56i rsp_demux_002 (
		.clk                (clk_100_out_clk_clk),                                                        //   input,    width = 1,       clk.clk
		.reset              (agilex_hps_h2f_axi_master_translator_clk_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	qsys_top_altera_avalon_st_pipeline_stage_1920_zterisq #(
		...
		.in_channel        (rsp_demux_001_src3_channel),                           //   input,    width = 4,          .channel
