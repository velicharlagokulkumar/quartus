// qsys_top_altera_mm_interconnect_1920_capkv5i.v
...
`timescale 1 ps / 1 ps
module qsys_top_altera_mm_interconnect_1920_capkv5i (
	...
	wire          rsp_mux_002_src_valid;                                                // rsp_mux_002:src_valid -> jtag2mm_ns_master_agent:rp_valid
	wire  [134:0] rsp_mux_002_src_data;                                                 // rsp_mux_002:src_data -> jtag2mm_ns_master_agent:rp_data
	wire          rsp_mux_002_src_ready;                                                // jtag2mm_ns_master_agent:rp_ready -> rsp_mux_002:src_ready
	wire    [2:0] rsp_mux_002_src_channel;                                              // rsp_mux_002:src_channel -> jtag2mm_ns_master_agent:rp_channel
	wire          rsp_mux_002_src_startofpacket;                                        // rsp_mux_002:src_startofpacket -> jtag2mm_ns_master_agent:rp_startofpacket
	wire          rsp_mux_002_src_endofpacket;                                          // rsp_mux_002:src_endofpacket -> jtag2mm_ns_master_agent:rp_endofpacket
	...
	wire  [134:0] router_002_src_data;                                                  // router_002:src_data -> cmd_demux_002:sink_data
	...
	wire  [134:0] rsp_demux_src0_data;                                                  // rsp_demux:src0_data -> mux_pipeline_005:in_data
	wire          rsp_demux_src0_ready;                                                 // mux_pipeline_005:in_ready -> rsp_demux:src0_ready
	wire    [2:0] rsp_demux_src0_channel;                                               // rsp_demux:src0_channel -> mux_pipeline_005:in_channel
	...
	wire  [134:0] mux_pipeline_005_source0_data;                                        // mux_pipeline_005:out_data -> rsp_mux:sink0_data
	...
	wire  [134:0] rsp_demux_001_src0_data;                                              // rsp_demux_001:src0_data -> mux_pipeline_006:in_data
	...
	wire  [134:0] mux_pipeline_006_source0_data;                                        // mux_pipeline_006:out_data -> rsp_mux:sink1_data
	wire          mux_pipeline_006_source0_ready;                                       // rsp_mux:sink1_ready -> mux_pipeline_006:out_ready
	wire    [2:0] mux_pipeline_006_source0_channel;                                     // mux_pipeline_006:out_channel -> rsp_mux:sink1_channel
	...
	wire  [134:0] rsp_demux_src1_data;                                                  // rsp_demux:src1_data -> mux_pipeline_007:in_data
	wire          rsp_demux_src1_ready;                                                 // mux_pipeline_007:in_ready -> rsp_demux:src1_ready
	wire    [2:0] rsp_demux_src1_channel;                                               // rsp_demux:src1_channel -> mux_pipeline_007:in_channel
	...
	wire  [134:0] mux_pipeline_007_source0_data;                                        // mux_pipeline_007:out_data -> rsp_mux_001:sink0_data
	...
	wire          rsp_demux_001_src1_valid;                                             // rsp_demux_001:src1_valid -> mux_pipeline_008:in_valid
	wire  [134:0] rsp_demux_001_src1_data;                                              // rsp_demux_001:src1_data -> mux_pipeline_008:in_data
	wire          rsp_demux_001_src1_ready;                                             // mux_pipeline_008:in_ready -> rsp_demux_001:src1_ready
	wire    [2:0] rsp_demux_001_src1_channel;                                           // rsp_demux_001:src1_channel -> mux_pipeline_008:in_channel
	wire          rsp_demux_001_src1_startofpacket;                                     // rsp_demux_001:src1_startofpacket -> mux_pipeline_008:in_startofpacket
	wire          rsp_demux_001_src1_endofpacket;                                       // rsp_demux_001:src1_endofpacket -> mux_pipeline_008:in_endofpacket
	wire          mux_pipeline_008_source0_valid;                                       // mux_pipeline_008:out_valid -> rsp_mux_001:sink1_valid
	wire  [134:0] mux_pipeline_008_source0_data;                                        // mux_pipeline_008:out_data -> rsp_mux_001:sink1_data
	wire          mux_pipeline_008_source0_ready;                                       // rsp_mux_001:sink1_ready -> mux_pipeline_008:out_ready
	wire    [2:0] mux_pipeline_008_source0_channel;                                     // mux_pipeline_008:out_channel -> rsp_mux_001:sink1_channel
	...
	wire  [134:0] rsp_demux_src2_data;                                                  // rsp_demux:src2_data -> mux_pipeline_009:in_data
	wire          rsp_demux_src2_ready;                                                 // mux_pipeline_009:in_ready -> rsp_demux:src2_ready
	wire    [2:0] rsp_demux_src2_channel;                                               // rsp_demux:src2_channel -> mux_pipeline_009:in_channel
	...
	wire  [134:0] mux_pipeline_009_source0_data;                                        // mux_pipeline_009:out_data -> rsp_mux_002:sink0_data
	wire          mux_pipeline_009_source0_ready;                                       // rsp_mux_002:sink0_ready -> mux_pipeline_009:out_ready
	wire    [2:0] mux_pipeline_009_source0_channel;                                     // mux_pipeline_009:out_channel -> rsp_mux_002:sink0_channel
	...
	qsys_top_altera_merlin_master_agent_191_mpbm6tq #(
		...
		.rp_data               (rsp_mux_002_src_data),                                                       //   input,  width = 135,          .data
	...
	qsys_top_altera_merlin_router_1921_4nwycji router_002 (
	...
	qsys_top_altera_merlin_router_1921_nnoe45a router_004 (
	...
	qsys_top_altera_merlin_demultiplexer_1921_3ixqtja cmd_demux_002 (
		.clk                (clk_100_out_clk_clk),                                                        //   input,    width = 1,       clk.clk
		.reset              (agilex_hps_h2f_axi_master_translator_clk_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	qsys_top_altera_merlin_multiplexer_1921_yxwngua cmd_mux_001 (
		.clk                 (clk_100_out_clk_clk),                                                        //   input,    width = 1,       clk.clk
		.reset               (agilex_hps_h2f_axi_master_translator_clk_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	qsys_top_altera_merlin_demultiplexer_1921_ur5itvq rsp_demux_001 (
		.clk                (clk_100_out_clk_clk),                                                        //   input,    width = 1,       clk.clk
		.reset              (agilex_hps_h2f_axi_master_translator_clk_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	qsys_top_altera_merlin_multiplexer_1921_masmxoq rsp_mux (
		...
		.sink0_channel       (mux_pipeline_005_source0_channel),                                           //   input,    width = 3,          .channel
		.sink0_data          (mux_pipeline_005_source0_data),                                              //   input,  width = 135,          .data
		...
		.sink1_ready         (mux_pipeline_006_source0_ready),                                             //  output,    width = 1,     sink1.ready
		.sink1_valid         (mux_pipeline_006_source0_valid),                                             //   input,    width = 1,          .valid
		.sink1_channel       (mux_pipeline_006_source0_channel),                                           //   input,    width = 3,          .channel
		.sink1_data          (mux_pipeline_006_source0_data),                                              //   input,  width = 135,          .data
		.sink1_startofpacket (mux_pipeline_006_source0_startofpacket),                                     //   input,    width = 1,          .startofpacket
		.sink1_endofpacket   (mux_pipeline_006_source0_endofpacket)                                        //   input,    width = 1,          .endofpacket
	);
	...
	qsys_top_altera_merlin_multiplexer_1921_masmxoq rsp_mux_001 (
		...
		.sink0_channel       (mux_pipeline_007_source0_channel),                                           //   input,    width = 3,          .channel
		.sink0_data          (mux_pipeline_007_source0_data),                                              //   input,  width = 135,          .data
		...
		.sink1_channel       (mux_pipeline_008_source0_channel),                                           //   input,    width = 3,          .channel
		.sink1_data          (mux_pipeline_008_source0_data),                                              //   input,  width = 135,          .data
	...
	qsys_top_altera_merlin_multiplexer_1921_zpzkjtq rsp_mux_002 (
		.clk                 (clk_100_out_clk_clk),                                                        //   input,    width = 1,       clk.clk
		.reset               (agilex_hps_h2f_axi_master_translator_clk_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
		...
		.sink0_data          (mux_pipeline_009_source0_data),                                              //   input,  width = 135,          .data
