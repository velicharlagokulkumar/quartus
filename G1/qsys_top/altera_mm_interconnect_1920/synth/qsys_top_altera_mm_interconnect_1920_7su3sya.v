// qsys_top_altera_mm_interconnect_1920_7su3sya.v
...
`timescale 1 ps / 1 ps
module qsys_top_altera_mm_interconnect_1920_7su3sya (
		...
		input  wire         agilex_hps_f2h_axi_reset_reset_bridge_in_reset_reset, // agilex_hps_f2h_axi_reset_reset_bridge_in_reset.reset
		input  wire         clk_100_out_clk_clk                                   //                                clk_100_out_clk.clk
	);

	wire          jtg_mst_hps_m_master_translator_avalon_universal_master_0_waitrequest;   // jtg_mst_hps_m_master_agent:av_waitrequest -> jtg_mst_hps_m_master_translator:uav_waitrequest
	wire   [31:0] jtg_mst_hps_m_master_translator_avalon_universal_master_0_readdata;      // jtg_mst_hps_m_master_agent:av_readdata -> jtg_mst_hps_m_master_translator:uav_readdata
	wire          jtg_mst_hps_m_master_translator_avalon_universal_master_0_debugaccess;   // jtg_mst_hps_m_master_translator:uav_debugaccess -> jtg_mst_hps_m_master_agent:av_debugaccess
	wire   [31:0] jtg_mst_hps_m_master_translator_avalon_universal_master_0_address;       // jtg_mst_hps_m_master_translator:uav_address -> jtg_mst_hps_m_master_agent:av_address
	wire          jtg_mst_hps_m_master_translator_avalon_universal_master_0_read;          // jtg_mst_hps_m_master_translator:uav_read -> jtg_mst_hps_m_master_agent:av_read
	wire    [3:0] jtg_mst_hps_m_master_translator_avalon_universal_master_0_byteenable;    // jtg_mst_hps_m_master_translator:uav_byteenable -> jtg_mst_hps_m_master_agent:av_byteenable
	wire          jtg_mst_hps_m_master_translator_avalon_universal_master_0_readdatavalid; // jtg_mst_hps_m_master_agent:av_readdatavalid -> jtg_mst_hps_m_master_translator:uav_readdatavalid
	wire          jtg_mst_hps_m_master_translator_avalon_universal_master_0_lock;          // jtg_mst_hps_m_master_translator:uav_lock -> jtg_mst_hps_m_master_agent:av_lock
	wire          jtg_mst_hps_m_master_translator_avalon_universal_master_0_write;         // jtg_mst_hps_m_master_translator:uav_write -> jtg_mst_hps_m_master_agent:av_write
	wire   [31:0] jtg_mst_hps_m_master_translator_avalon_universal_master_0_writedata;     // jtg_mst_hps_m_master_translator:uav_writedata -> jtg_mst_hps_m_master_agent:av_writedata
	wire    [2:0] jtg_mst_hps_m_master_translator_avalon_universal_master_0_burstcount;    // jtg_mst_hps_m_master_translator:uav_burstcount -> jtg_mst_hps_m_master_agent:av_burstcount
	...
	wire          jtg_mst_hps_m_master_agent_cp_valid;                                     // jtg_mst_hps_m_master_agent:cp_valid -> router:sink_valid
	wire  [157:0] jtg_mst_hps_m_master_agent_cp_data;                                      // jtg_mst_hps_m_master_agent:cp_data -> router:sink_data
	wire          jtg_mst_hps_m_master_agent_cp_ready;                                     // router:sink_ready -> jtg_mst_hps_m_master_agent:cp_ready
	wire          jtg_mst_hps_m_master_agent_cp_startofpacket;                             // jtg_mst_hps_m_master_agent:cp_startofpacket -> router:sink_startofpacket
	wire          jtg_mst_hps_m_master_agent_cp_endofpacket;                               // jtg_mst_hps_m_master_agent:cp_endofpacket -> router:sink_endofpacket
	wire          router_src_valid;                                                        // router:src_valid -> jtg_mst_hps_m_master_limiter:cmd_sink_valid
	wire  [157:0] router_src_data;                                                         // router:src_data -> jtg_mst_hps_m_master_limiter:cmd_sink_data
	wire          router_src_ready;                                                        // jtg_mst_hps_m_master_limiter:cmd_sink_ready -> router:src_ready
	wire    [1:0] router_src_channel;                                                      // router:src_channel -> jtg_mst_hps_m_master_limiter:cmd_sink_channel
	wire          router_src_startofpacket;                                                // router:src_startofpacket -> jtg_mst_hps_m_master_limiter:cmd_sink_startofpacket
	wire          router_src_endofpacket;                                                  // router:src_endofpacket -> jtg_mst_hps_m_master_limiter:cmd_sink_endofpacket
	wire          jtg_mst_hps_m_master_limiter_rsp_src_valid;                              // jtg_mst_hps_m_master_limiter:rsp_src_valid -> jtg_mst_hps_m_master_agent:rp_valid
	wire  [157:0] jtg_mst_hps_m_master_limiter_rsp_src_data;                               // jtg_mst_hps_m_master_limiter:rsp_src_data -> jtg_mst_hps_m_master_agent:rp_data
	wire          jtg_mst_hps_m_master_limiter_rsp_src_ready;                              // jtg_mst_hps_m_master_agent:rp_ready -> jtg_mst_hps_m_master_limiter:rsp_src_ready
	wire    [1:0] jtg_mst_hps_m_master_limiter_rsp_src_channel;                            // jtg_mst_hps_m_master_limiter:rsp_src_channel -> jtg_mst_hps_m_master_agent:rp_channel
	wire          jtg_mst_hps_m_master_limiter_rsp_src_startofpacket;                      // jtg_mst_hps_m_master_limiter:rsp_src_startofpacket -> jtg_mst_hps_m_master_agent:rp_startofpacket
	wire          jtg_mst_hps_m_master_limiter_rsp_src_endofpacket;                        // jtg_mst_hps_m_master_limiter:rsp_src_endofpacket -> jtg_mst_hps_m_master_agent:rp_endofpacket
	wire          cmd_mux_src_valid;                                                       // cmd_mux:src_valid -> agilex_hps_f2h_axi_slave_wr_cmd_width_adapter:in_valid
	wire  [157:0] cmd_mux_src_data;                                                        // cmd_mux:src_data -> agilex_hps_f2h_axi_slave_wr_cmd_width_adapter:in_data
	...
	wire  [157:0] cmd_mux_001_src_data;                                                    // cmd_mux_001:src_data -> agilex_hps_f2h_axi_slave_rd_cmd_width_adapter:in_data
	...
	wire          router_001_src_valid;                                                    // router_001:src_valid -> agilex_hps_f2h_axi_slave_wr_rsp_width_adapter:in_valid
	wire  [697:0] router_001_src_data;                                                     // router_001:src_data -> agilex_hps_f2h_axi_slave_wr_rsp_width_adapter:in_data
	wire          router_001_src_ready;                                                    // agilex_hps_f2h_axi_slave_wr_rsp_width_adapter:in_ready -> router_001:src_ready
	wire    [1:0] router_001_src_channel;                                                  // router_001:src_channel -> agilex_hps_f2h_axi_slave_wr_rsp_width_adapter:in_channel
	wire          router_001_src_startofpacket;                                            // router_001:src_startofpacket -> agilex_hps_f2h_axi_slave_wr_rsp_width_adapter:in_startofpacket
	wire          router_001_src_endofpacket;                                              // router_001:src_endofpacket -> agilex_hps_f2h_axi_slave_wr_rsp_width_adapter:in_endofpacket
	...
	wire  [157:0] agilex_hps_f2h_axi_slave_wr_rsp_width_adapter_src_data;                  // agilex_hps_f2h_axi_slave_wr_rsp_width_adapter:out_data -> rsp_demux:sink_data
	...
	wire          router_002_src_valid;                                                    // router_002:src_valid -> agilex_hps_f2h_axi_slave_rd_rsp_width_adapter:in_valid
	wire  [697:0] router_002_src_data;                                                     // router_002:src_data -> agilex_hps_f2h_axi_slave_rd_rsp_width_adapter:in_data
	wire          router_002_src_ready;                                                    // agilex_hps_f2h_axi_slave_rd_rsp_width_adapter:in_ready -> router_002:src_ready
	wire    [1:0] router_002_src_channel;                                                  // router_002:src_channel -> agilex_hps_f2h_axi_slave_rd_rsp_width_adapter:in_channel
	wire          router_002_src_startofpacket;                                            // router_002:src_startofpacket -> agilex_hps_f2h_axi_slave_rd_rsp_width_adapter:in_startofpacket
	wire          router_002_src_endofpacket;                                              // router_002:src_endofpacket -> agilex_hps_f2h_axi_slave_rd_rsp_width_adapter:in_endofpacket
	...
	wire  [157:0] agilex_hps_f2h_axi_slave_rd_rsp_width_adapter_src_data;                  // agilex_hps_f2h_axi_slave_rd_rsp_width_adapter:out_data -> rsp_demux_001:sink_data
	...
	wire    [0:0] jtg_mst_hps_m_master_limiter_cmd_src_valid;                              // jtg_mst_hps_m_master_limiter:cmd_src_valid -> limiter_pipeline:in_valid
	wire  [157:0] jtg_mst_hps_m_master_limiter_cmd_src_data;                               // jtg_mst_hps_m_master_limiter:cmd_src_data -> limiter_pipeline:in_data
	wire          jtg_mst_hps_m_master_limiter_cmd_src_ready;                              // limiter_pipeline:in_ready -> jtg_mst_hps_m_master_limiter:cmd_src_ready
	wire    [1:0] jtg_mst_hps_m_master_limiter_cmd_src_channel;                            // jtg_mst_hps_m_master_limiter:cmd_src_channel -> limiter_pipeline:in_channel
	wire          jtg_mst_hps_m_master_limiter_cmd_src_startofpacket;                      // jtg_mst_hps_m_master_limiter:cmd_src_startofpacket -> limiter_pipeline:in_startofpacket
	wire          jtg_mst_hps_m_master_limiter_cmd_src_endofpacket;                        // jtg_mst_hps_m_master_limiter:cmd_src_endofpacket -> limiter_pipeline:in_endofpacket
	wire          limiter_pipeline_source0_valid;                                          // limiter_pipeline:out_valid -> cmd_demux:sink_valid
	wire  [157:0] limiter_pipeline_source0_data;                                           // limiter_pipeline:out_data -> cmd_demux:sink_data
	...
	wire  [157:0] rsp_mux_src_data;                                                        // rsp_mux:src_data -> limiter_pipeline_001:in_data
	...
	wire          limiter_pipeline_001_source0_valid;                                      // limiter_pipeline_001:out_valid -> jtg_mst_hps_m_master_limiter:rsp_sink_valid
	wire  [157:0] limiter_pipeline_001_source0_data;                                       // limiter_pipeline_001:out_data -> jtg_mst_hps_m_master_limiter:rsp_sink_data
	wire          limiter_pipeline_001_source0_ready;                                      // jtg_mst_hps_m_master_limiter:rsp_sink_ready -> limiter_pipeline_001:out_ready
	wire    [1:0] limiter_pipeline_001_source0_channel;                                    // limiter_pipeline_001:out_channel -> jtg_mst_hps_m_master_limiter:rsp_sink_channel
	wire          limiter_pipeline_001_source0_startofpacket;                              // limiter_pipeline_001:out_startofpacket -> jtg_mst_hps_m_master_limiter:rsp_sink_startofpacket
	wire          limiter_pipeline_001_source0_endofpacket;                                // limiter_pipeline_001:out_endofpacket -> jtg_mst_hps_m_master_limiter:rsp_sink_endofpacket
	wire          agilex_hps_f2h_axi_slave_wr_cmd_width_adapter_src_valid;                 // agilex_hps_f2h_axi_slave_wr_cmd_width_adapter:out_valid -> agent_pipeline:in_valid
	wire  [697:0] agilex_hps_f2h_axi_slave_wr_cmd_width_adapter_src_data;                  // agilex_hps_f2h_axi_slave_wr_cmd_width_adapter:out_data -> agent_pipeline:in_data
	wire          agilex_hps_f2h_axi_slave_wr_cmd_width_adapter_src_ready;                 // agent_pipeline:in_ready -> agilex_hps_f2h_axi_slave_wr_cmd_width_adapter:out_ready
	wire    [1:0] agilex_hps_f2h_axi_slave_wr_cmd_width_adapter_src_channel;               // agilex_hps_f2h_axi_slave_wr_cmd_width_adapter:out_channel -> agent_pipeline:in_channel
	wire          agilex_hps_f2h_axi_slave_wr_cmd_width_adapter_src_startofpacket;         // agilex_hps_f2h_axi_slave_wr_cmd_width_adapter:out_startofpacket -> agent_pipeline:in_startofpacket
	wire          agilex_hps_f2h_axi_slave_wr_cmd_width_adapter_src_endofpacket;           // agilex_hps_f2h_axi_slave_wr_cmd_width_adapter:out_endofpacket -> agent_pipeline:in_endofpacket
	wire          agent_pipeline_source0_valid;                                            // agent_pipeline:out_valid -> agilex_hps_f2h_axi_slave_agent:write_cp_valid
	wire  [697:0] agent_pipeline_source0_data;                                             // agent_pipeline:out_data -> agilex_hps_f2h_axi_slave_agent:write_cp_data
	wire          agent_pipeline_source0_ready;                                            // agilex_hps_f2h_axi_slave_agent:write_cp_ready -> agent_pipeline:out_ready
	wire    [1:0] agent_pipeline_source0_channel;                                          // agent_pipeline:out_channel -> agilex_hps_f2h_axi_slave_agent:write_cp_channel
	wire          agent_pipeline_source0_startofpacket;                                    // agent_pipeline:out_startofpacket -> agilex_hps_f2h_axi_slave_agent:write_cp_startofpacket
	wire          agent_pipeline_source0_endofpacket;                                      // agent_pipeline:out_endofpacket -> agilex_hps_f2h_axi_slave_agent:write_cp_endofpacket
	wire          agilex_hps_f2h_axi_slave_rd_cmd_width_adapter_src_valid;                 // agilex_hps_f2h_axi_slave_rd_cmd_width_adapter:out_valid -> agent_pipeline_001:in_valid
	wire  [697:0] agilex_hps_f2h_axi_slave_rd_cmd_width_adapter_src_data;                  // agilex_hps_f2h_axi_slave_rd_cmd_width_adapter:out_data -> agent_pipeline_001:in_data
	wire          agilex_hps_f2h_axi_slave_rd_cmd_width_adapter_src_ready;                 // agent_pipeline_001:in_ready -> agilex_hps_f2h_axi_slave_rd_cmd_width_adapter:out_ready
	wire    [1:0] agilex_hps_f2h_axi_slave_rd_cmd_width_adapter_src_channel;               // agilex_hps_f2h_axi_slave_rd_cmd_width_adapter:out_channel -> agent_pipeline_001:in_channel
	wire          agilex_hps_f2h_axi_slave_rd_cmd_width_adapter_src_startofpacket;         // agilex_hps_f2h_axi_slave_rd_cmd_width_adapter:out_startofpacket -> agent_pipeline_001:in_startofpacket
	wire          agilex_hps_f2h_axi_slave_rd_cmd_width_adapter_src_endofpacket;           // agilex_hps_f2h_axi_slave_rd_cmd_width_adapter:out_endofpacket -> agent_pipeline_001:in_endofpacket
	wire          agent_pipeline_001_source0_valid;                                        // agent_pipeline_001:out_valid -> agilex_hps_f2h_axi_slave_agent:read_cp_valid
	wire  [697:0] agent_pipeline_001_source0_data;                                         // agent_pipeline_001:out_data -> agilex_hps_f2h_axi_slave_agent:read_cp_data
	wire          agent_pipeline_001_source0_ready;                                        // agilex_hps_f2h_axi_slave_agent:read_cp_ready -> agent_pipeline_001:out_ready
	wire    [1:0] agent_pipeline_001_source0_channel;                                      // agent_pipeline_001:out_channel -> agilex_hps_f2h_axi_slave_agent:read_cp_channel
	wire          agent_pipeline_001_source0_startofpacket;                                // agent_pipeline_001:out_startofpacket -> agilex_hps_f2h_axi_slave_agent:read_cp_startofpacket
	wire          agent_pipeline_001_source0_endofpacket;                                  // agent_pipeline_001:out_endofpacket -> agilex_hps_f2h_axi_slave_agent:read_cp_endofpacket
	wire          agilex_hps_f2h_axi_slave_agent_write_rp_valid;                           // agilex_hps_f2h_axi_slave_agent:write_rp_valid -> agent_pipeline_002:in_valid
	wire  [697:0] agilex_hps_f2h_axi_slave_agent_write_rp_data;                            // agilex_hps_f2h_axi_slave_agent:write_rp_data -> agent_pipeline_002:in_data
	wire          agilex_hps_f2h_axi_slave_agent_write_rp_ready;                           // agent_pipeline_002:in_ready -> agilex_hps_f2h_axi_slave_agent:write_rp_ready
	wire          agilex_hps_f2h_axi_slave_agent_write_rp_startofpacket;                   // agilex_hps_f2h_axi_slave_agent:write_rp_startofpacket -> agent_pipeline_002:in_startofpacket
	wire          agilex_hps_f2h_axi_slave_agent_write_rp_endofpacket;                     // agilex_hps_f2h_axi_slave_agent:write_rp_endofpacket -> agent_pipeline_002:in_endofpacket
	wire          agent_pipeline_002_source0_valid;                                        // agent_pipeline_002:out_valid -> router_001:sink_valid
	wire  [697:0] agent_pipeline_002_source0_data;                                         // agent_pipeline_002:out_data -> router_001:sink_data
	...
	wire          agilex_hps_f2h_axi_slave_agent_read_rp_valid;                            // agilex_hps_f2h_axi_slave_agent:read_rp_valid -> agent_pipeline_003:in_valid
	wire  [697:0] agilex_hps_f2h_axi_slave_agent_read_rp_data;                             // agilex_hps_f2h_axi_slave_agent:read_rp_data -> agent_pipeline_003:in_data
	wire          agilex_hps_f2h_axi_slave_agent_read_rp_ready;                            // agent_pipeline_003:in_ready -> agilex_hps_f2h_axi_slave_agent:read_rp_ready
	wire          agilex_hps_f2h_axi_slave_agent_read_rp_startofpacket;                    // agilex_hps_f2h_axi_slave_agent:read_rp_startofpacket -> agent_pipeline_003:in_startofpacket
	wire          agilex_hps_f2h_axi_slave_agent_read_rp_endofpacket;                      // agilex_hps_f2h_axi_slave_agent:read_rp_endofpacket -> agent_pipeline_003:in_endofpacket
	wire          agent_pipeline_003_source0_valid;                                        // agent_pipeline_003:out_valid -> router_002:sink_valid
	wire  [697:0] agent_pipeline_003_source0_data;                                         // agent_pipeline_003:out_data -> router_002:sink_data
	...
	wire  [157:0] cmd_demux_src0_data;                                                     // cmd_demux:src0_data -> mux_pipeline:in_data
	...
	wire  [157:0] mux_pipeline_source0_data;                                               // mux_pipeline:out_data -> cmd_mux:sink0_data
	...
	wire  [157:0] cmd_demux_src1_data;                                                     // cmd_demux:src1_data -> mux_pipeline_001:in_data
	...
	wire  [157:0] mux_pipeline_001_source0_data;                                           // mux_pipeline_001:out_data -> cmd_mux_001:sink0_data
	...
	wire  [157:0] rsp_demux_src0_data;                                                     // rsp_demux:src0_data -> mux_pipeline_002:in_data
	...
	wire  [157:0] mux_pipeline_002_source0_data;                                           // mux_pipeline_002:out_data -> rsp_mux:sink0_data
	...
	wire  [157:0] rsp_demux_001_src0_data;                                                 // rsp_demux_001:src0_data -> mux_pipeline_003:in_data
	...
	wire  [157:0] mux_pipeline_003_source0_data;                                           // mux_pipeline_003:out_data -> rsp_mux:sink1_data
	...
	qsys_top_altera_merlin_master_agent_191_mpbm6tq #(
		...
		.WUNIQUE_VALUE             (0),
		.SYNC_RESET                (1)
	) jtg_mst_hps_m_master_agent (
		.clk                   (clk_100_out_clk_clk),                                                     //   input,    width = 1,       clk.clk
		.reset                 (jtg_mst_reset_reset_bridge_in_reset_reset),                               //   input,    width = 1, clk_reset.reset
		.av_address            (jtg_mst_hps_m_master_translator_avalon_universal_master_0_address),       //   input,   width = 32,        av.address
		.av_write              (jtg_mst_hps_m_master_translator_avalon_universal_master_0_write),         //   input,    width = 1,          .write
		.av_read               (jtg_mst_hps_m_master_translator_avalon_universal_master_0_read),          //   input,    width = 1,          .read
		.av_writedata          (jtg_mst_hps_m_master_translator_avalon_universal_master_0_writedata),     //   input,   width = 32,          .writedata
		.av_readdata           (jtg_mst_hps_m_master_translator_avalon_universal_master_0_readdata),      //  output,   width = 32,          .readdata
		.av_waitrequest        (jtg_mst_hps_m_master_translator_avalon_universal_master_0_waitrequest),   //  output,    width = 1,          .waitrequest
		.av_readdatavalid      (jtg_mst_hps_m_master_translator_avalon_universal_master_0_readdatavalid), //  output,    width = 1,          .readdatavalid
		.av_byteenable         (jtg_mst_hps_m_master_translator_avalon_universal_master_0_byteenable),    //   input,    width = 4,          .byteenable
		.av_burstcount         (jtg_mst_hps_m_master_translator_avalon_universal_master_0_burstcount),    //   input,    width = 3,          .burstcount
		.av_debugaccess        (jtg_mst_hps_m_master_translator_avalon_universal_master_0_debugaccess),   //   input,    width = 1,          .debugaccess
		.av_lock               (jtg_mst_hps_m_master_translator_avalon_universal_master_0_lock),          //   input,    width = 1,          .lock
		.cp_valid              (jtg_mst_hps_m_master_agent_cp_valid),                                     //  output,    width = 1,        cp.valid
		.cp_data               (jtg_mst_hps_m_master_agent_cp_data),                                      //  output,  width = 158,          .data
		.cp_startofpacket      (jtg_mst_hps_m_master_agent_cp_startofpacket),                             //  output,    width = 1,          .startofpacket
		.cp_endofpacket        (jtg_mst_hps_m_master_agent_cp_endofpacket),                               //  output,    width = 1,          .endofpacket
		.cp_ready              (jtg_mst_hps_m_master_agent_cp_ready),                                     //   input,    width = 1,          .ready
		.rp_valid              (jtg_mst_hps_m_master_limiter_rsp_src_valid),                              //   input,    width = 1,        rp.valid
		.rp_data               (jtg_mst_hps_m_master_limiter_rsp_src_data),                               //   input,  width = 158,          .data
		.rp_channel            (jtg_mst_hps_m_master_limiter_rsp_src_channel),                            //   input,    width = 2,          .channel
		.rp_startofpacket      (jtg_mst_hps_m_master_limiter_rsp_src_startofpacket),                      //   input,    width = 1,          .startofpacket
		.rp_endofpacket        (jtg_mst_hps_m_master_limiter_rsp_src_endofpacket),                        //   input,    width = 1,          .endofpacket
		.rp_ready              (jtg_mst_hps_m_master_limiter_rsp_src_ready),                              //  output,    width = 1,          .ready
		.av_response           (),                                                                        // (terminated),                         
		.av_writeresponsevalid ()                                                                         // (terminated),                         
	);
	...
	qsys_top_altera_merlin_axi_slave_ni_1941_5ooumii #(
		...
		.aresetn                (~jtg_mst_reset_reset_bridge_in_reset_reset),                //   input,    width = 1,        reset_sink.reset_n
		...
		.read_cp_data           (agent_pipeline_001_source0_data),                           //   input,  width = 698,                  .data
		...
		.write_cp_data          (agent_pipeline_source0_data),                               //   input,  width = 698,                  .data
	...
	qsys_top_altera_merlin_router_1921_4zbrsli router (
		.sink_ready         (jtg_mst_hps_m_master_agent_cp_ready),         //  output,    width = 1,      sink.ready
		.sink_valid         (jtg_mst_hps_m_master_agent_cp_valid),         //   input,    width = 1,          .valid
		.sink_data          (jtg_mst_hps_m_master_agent_cp_data),          //   input,  width = 158,          .data
		.sink_startofpacket (jtg_mst_hps_m_master_agent_cp_startofpacket), //   input,    width = 1,          .startofpacket
		.sink_endofpacket   (jtg_mst_hps_m_master_agent_cp_endofpacket),   //   input,    width = 1,          .endofpacket
		.clk                (clk_100_out_clk_clk),                         //   input,    width = 1,       clk.clk
		.reset              (jtg_mst_reset_reset_bridge_in_reset_reset),   //   input,    width = 1, clk_reset.reset
	...
	qsys_top_altera_merlin_router_1921_rp3epvy router_001 (
		...
		.sink_data          (agent_pipeline_002_source0_data),           //   input,  width = 698,          .data
		...
		.src_data           (router_001_src_data),                       //  output,  width = 698,          .data
		.src_channel        (router_001_src_channel),                    //  output,    width = 2,          .channel
		.src_startofpacket  (router_001_src_startofpacket),              //  output,    width = 1,          .startofpacket
		.src_endofpacket    (router_001_src_endofpacket)                 //  output,    width = 1,          .endofpacket
	);

	qsys_top_altera_merlin_router_1921_rp3epvy router_002 (
		...
		.sink_data          (agent_pipeline_003_source0_data),           //   input,  width = 698,          .data
	...
	qsys_top_altera_merlin_traffic_limiter_191_6blplji #(
		...
		.cmd_src_ready          (jtg_mst_hps_m_master_limiter_cmd_src_ready),         //   input,    width = 1,   cmd_src.ready
		.cmd_src_data           (jtg_mst_hps_m_master_limiter_cmd_src_data),          //  output,  width = 158,          .data
		.cmd_src_channel        (jtg_mst_hps_m_master_limiter_cmd_src_channel),       //  output,    width = 2,          .channel
		.cmd_src_startofpacket  (jtg_mst_hps_m_master_limiter_cmd_src_startofpacket), //  output,    width = 1,          .startofpacket
		.cmd_src_endofpacket    (jtg_mst_hps_m_master_limiter_cmd_src_endofpacket),   //  output,    width = 1,          .endofpacket
		.cmd_src_valid          (jtg_mst_hps_m_master_limiter_cmd_src_valid),         //  output,    width = 1,          .valid
		...
		.rsp_sink_data          (limiter_pipeline_001_source0_data),                  //   input,  width = 158,          .data
		...
		.rsp_src_ready          (jtg_mst_hps_m_master_limiter_rsp_src_ready),         //   input,    width = 1,   rsp_src.ready
		.rsp_src_valid          (jtg_mst_hps_m_master_limiter_rsp_src_valid),         //  output,    width = 1,          .valid
		.rsp_src_data           (jtg_mst_hps_m_master_limiter_rsp_src_data),          //  output,  width = 158,          .data
		.rsp_src_channel        (jtg_mst_hps_m_master_limiter_rsp_src_channel),       //  output,    width = 2,          .channel
		.rsp_src_startofpacket  (jtg_mst_hps_m_master_limiter_rsp_src_startofpacket), //  output,    width = 1,          .startofpacket
		.rsp_src_endofpacket    (jtg_mst_hps_m_master_limiter_rsp_src_endofpacket)    //  output,    width = 1,          .endofpacket
	);

	qsys_top_altera_merlin_demultiplexer_1921_pcump4i cmd_demux (
		.clk                (clk_100_out_clk_clk),                       //   input,    width = 1,       clk.clk
		.reset              (jtg_mst_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
		...
		.sink_data          (limiter_pipeline_source0_data),             //   input,  width = 158,          .data
	...
	qsys_top_altera_merlin_multiplexer_1921_fgpooby cmd_mux (
		...
		.sink0_data          (mux_pipeline_source0_data),                 //   input,  width = 158,          .data
	...
	qsys_top_altera_merlin_multiplexer_1921_fgpooby cmd_mux_001 (
		.clk                 (clk_100_out_clk_clk),                       //   input,    width = 1,       clk.clk
		.reset               (jtg_mst_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
		.src_ready           (cmd_mux_001_src_ready),                     //   input,    width = 1,       src.ready
		.src_valid           (cmd_mux_001_src_valid),                     //  output,    width = 1,          .valid
		.src_data            (cmd_mux_001_src_data),                      //  output,  width = 158,          .data
		...
		.sink0_data          (mux_pipeline_001_source0_data),             //   input,  width = 158,          .data
	...
	qsys_top_altera_merlin_demultiplexer_1921_e7g366y rsp_demux (
		.clk                (clk_100_out_clk_clk),                                             //   input,    width = 1,       clk.clk
		.reset              (jtg_mst_reset_reset_bridge_in_reset_reset),                       //   input,    width = 1, clk_reset.reset
		...
		.sink_data          (agilex_hps_f2h_axi_slave_wr_rsp_width_adapter_src_data),          //   input,  width = 158,          .data
		...
		.src0_data          (rsp_demux_src0_data),                                             //  output,  width = 158,          .data
		.src0_channel       (rsp_demux_src0_channel),                                          //  output,    width = 2,          .channel
		.src0_startofpacket (rsp_demux_src0_startofpacket),                                    //  output,    width = 1,          .startofpacket
		.src0_endofpacket   (rsp_demux_src0_endofpacket)                                       //  output,    width = 1,          .endofpacket
	);

	qsys_top_altera_merlin_demultiplexer_1921_e7g366y rsp_demux_001 (
		.clk                (clk_100_out_clk_clk),                                             //   input,    width = 1,       clk.clk
		.reset              (jtg_mst_reset_reset_bridge_in_reset_reset),                       //   input,    width = 1, clk_reset.reset
		...
		.sink_data          (agilex_hps_f2h_axi_slave_rd_rsp_width_adapter_src_data),          //   input,  width = 158,          .data
		...
		.src0_data          (rsp_demux_001_src0_data),                                         //  output,  width = 158,          .data
		.src0_channel       (rsp_demux_001_src0_channel),                                      //  output,    width = 2,          .channel
		.src0_startofpacket (rsp_demux_001_src0_startofpacket),                                //  output,    width = 1,          .startofpacket
		.src0_endofpacket   (rsp_demux_001_src0_endofpacket)                                   //  output,    width = 1,          .endofpacket
	);

	qsys_top_altera_merlin_multiplexer_1921_5p55ega rsp_mux (
		.clk                 (clk_100_out_clk_clk),                       //   input,    width = 1,       clk.clk
		.reset               (jtg_mst_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
		.src_ready           (rsp_mux_src_ready),                         //   input,    width = 1,       src.ready
		.src_valid           (rsp_mux_src_valid),                         //  output,    width = 1,          .valid
		.src_data            (rsp_mux_src_data),                          //  output,  width = 158,          .data
		...
		.sink0_data          (mux_pipeline_002_source0_data),             //   input,  width = 158,          .data
		...
		.sink1_data          (mux_pipeline_003_source0_data),             //   input,  width = 158,          .data
	...
	qsys_top_altera_merlin_width_adapter_1920_vczjhya #(
		...
		.in_data              (cmd_mux_src_data),                                                //   input,  width = 158,          .data
		.out_endofpacket      (agilex_hps_f2h_axi_slave_wr_cmd_width_adapter_src_endofpacket),   //  output,    width = 1,       src.endofpacket
		.out_data             (agilex_hps_f2h_axi_slave_wr_cmd_width_adapter_src_data),          //  output,  width = 698,          .data
	...
	qsys_top_altera_merlin_width_adapter_1920_vczjhya #(
		...
		.in_data              (cmd_mux_001_src_data),                                            //   input,  width = 158,          .data
		.out_endofpacket      (agilex_hps_f2h_axi_slave_rd_cmd_width_adapter_src_endofpacket),   //  output,    width = 1,       src.endofpacket
		.out_data             (agilex_hps_f2h_axi_slave_rd_cmd_width_adapter_src_data),          //  output,  width = 698,          .data
	...
	qsys_top_altera_merlin_width_adapter_1920_tlmozpy #(
		...
		.in_data              (router_001_src_data),                                             //   input,  width = 698,          .data
		.out_endofpacket      (agilex_hps_f2h_axi_slave_wr_rsp_width_adapter_src_endofpacket),   //  output,    width = 1,       src.endofpacket
		.out_data             (agilex_hps_f2h_axi_slave_wr_rsp_width_adapter_src_data),          //  output,  width = 158,          .data
	...
	qsys_top_altera_merlin_width_adapter_1920_tlmozpy #(
		...
		.in_data              (router_002_src_data),                                             //   input,  width = 698,          .data
		.out_endofpacket      (agilex_hps_f2h_axi_slave_rd_rsp_width_adapter_src_endofpacket),   //  output,    width = 1,       src.endofpacket
		.out_data             (agilex_hps_f2h_axi_slave_rd_rsp_width_adapter_src_data),          //  output,  width = 158,          .data
	...
	qsys_top_altera_avalon_st_pipeline_stage_1920_zterisq #(
		...
		.reset             (agilex_hps_f2h_axi_reset_reset_bridge_in_reset_reset), //   input,    width = 1, cr0_reset.reset
		.in_ready          (jtg_mst_hps_m_master_limiter_cmd_src_ready),           //  output,    width = 1,     sink0.ready
		.in_valid          (jtg_mst_hps_m_master_limiter_cmd_src_valid),           //   input,    width = 1,          .valid
		.in_startofpacket  (jtg_mst_hps_m_master_limiter_cmd_src_startofpacket),   //   input,    width = 1,          .startofpacket
		.in_endofpacket    (jtg_mst_hps_m_master_limiter_cmd_src_endofpacket),     //   input,    width = 1,          .endofpacket
		.in_data           (jtg_mst_hps_m_master_limiter_cmd_src_data),            //   input,  width = 158,          .data
		.in_channel        (jtg_mst_hps_m_master_limiter_cmd_src_channel),         //   input,    width = 2,          .channel
		...
		.out_data          (limiter_pipeline_source0_data),                        //  output,  width = 158,          .data
	...
	qsys_top_altera_avalon_st_pipeline_stage_1920_zterisq #(
		...
		.in_data           (rsp_mux_src_data),                                     //   input,  width = 158,          .data
		...
		.out_data          (limiter_pipeline_001_source0_data),                    //  output,  width = 158,          .data
	...
	qsys_top_altera_avalon_st_pipeline_stage_1920_zterisq #(
		...
		.clk               (clk_100_out_clk_clk),                                             //   input,    width = 1,       cr0.clk
		.reset             (agilex_hps_f2h_axi_reset_reset_bridge_in_reset_reset),            //   input,    width = 1, cr0_reset.reset
		.in_ready          (agilex_hps_f2h_axi_slave_wr_cmd_width_adapter_src_ready),         //  output,    width = 1,     sink0.ready
		.in_valid          (agilex_hps_f2h_axi_slave_wr_cmd_width_adapter_src_valid),         //   input,    width = 1,          .valid
		.in_startofpacket  (agilex_hps_f2h_axi_slave_wr_cmd_width_adapter_src_startofpacket), //   input,    width = 1,          .startofpacket
		.in_endofpacket    (agilex_hps_f2h_axi_slave_wr_cmd_width_adapter_src_endofpacket),   //   input,    width = 1,          .endofpacket
		.in_data           (agilex_hps_f2h_axi_slave_wr_cmd_width_adapter_src_data),          //   input,  width = 698,          .data
		.in_channel        (agilex_hps_f2h_axi_slave_wr_cmd_width_adapter_src_channel),       //   input,    width = 2,          .channel
		...
		.out_data          (agent_pipeline_source0_data),                                     //  output,  width = 698,          .data
	...
	qsys_top_altera_avalon_st_pipeline_stage_1920_zterisq #(
		...
		.clk               (clk_100_out_clk_clk),                                             //   input,    width = 1,       cr0.clk
		.reset             (agilex_hps_f2h_axi_reset_reset_bridge_in_reset_reset),            //   input,    width = 1, cr0_reset.reset
		.in_ready          (agilex_hps_f2h_axi_slave_rd_cmd_width_adapter_src_ready),         //  output,    width = 1,     sink0.ready
		.in_valid          (agilex_hps_f2h_axi_slave_rd_cmd_width_adapter_src_valid),         //   input,    width = 1,          .valid
		.in_startofpacket  (agilex_hps_f2h_axi_slave_rd_cmd_width_adapter_src_startofpacket), //   input,    width = 1,          .startofpacket
		.in_endofpacket    (agilex_hps_f2h_axi_slave_rd_cmd_width_adapter_src_endofpacket),   //   input,    width = 1,          .endofpacket
		.in_data           (agilex_hps_f2h_axi_slave_rd_cmd_width_adapter_src_data),          //   input,  width = 698,          .data
		.in_channel        (agilex_hps_f2h_axi_slave_rd_cmd_width_adapter_src_channel),       //   input,    width = 2,          .channel
		...
		.out_data          (agent_pipeline_001_source0_data),                                 //  output,  width = 698,          .data
	...
	qsys_top_altera_avalon_st_pipeline_stage_1920_zterisq #(
		...
		.clk               (clk_100_out_clk_clk),                                   //   input,    width = 1,       cr0.clk
		.reset             (agilex_hps_f2h_axi_reset_reset_bridge_in_reset_reset),  //   input,    width = 1, cr0_reset.reset
		.in_ready          (agilex_hps_f2h_axi_slave_agent_write_rp_ready),         //  output,    width = 1,     sink0.ready
		.in_valid          (agilex_hps_f2h_axi_slave_agent_write_rp_valid),         //   input,    width = 1,          .valid
		.in_startofpacket  (agilex_hps_f2h_axi_slave_agent_write_rp_startofpacket), //   input,    width = 1,          .startofpacket
		.in_endofpacket    (agilex_hps_f2h_axi_slave_agent_write_rp_endofpacket),   //   input,    width = 1,          .endofpacket
		.in_data           (agilex_hps_f2h_axi_slave_agent_write_rp_data),          //   input,  width = 698,          .data
		...
		.out_data          (agent_pipeline_002_source0_data),                       //  output,  width = 698,          .data
		.in_empty          (1'b0),                                                  // (terminated),                         
		.out_empty         (),                                                      // (terminated),                         
		.out_error         (),                                                      // (terminated),                         
		.in_error          (1'b0),                                                  // (terminated),                         
	...
	qsys_top_altera_avalon_st_pipeline_stage_1920_zterisq #(
		...
		.clk               (clk_100_out_clk_clk),                                  //   input,    width = 1,       cr0.clk
		.reset             (agilex_hps_f2h_axi_reset_reset_bridge_in_reset_reset), //   input,    width = 1, cr0_reset.reset
		.in_ready          (agilex_hps_f2h_axi_slave_agent_read_rp_ready),         //  output,    width = 1,     sink0.ready
		.in_valid          (agilex_hps_f2h_axi_slave_agent_read_rp_valid),         //   input,    width = 1,          .valid
		.in_startofpacket  (agilex_hps_f2h_axi_slave_agent_read_rp_startofpacket), //   input,    width = 1,          .startofpacket
		.in_endofpacket    (agilex_hps_f2h_axi_slave_agent_read_rp_endofpacket),   //   input,    width = 1,          .endofpacket
		.in_data           (agilex_hps_f2h_axi_slave_agent_read_rp_data),          //   input,  width = 698,          .data
		...
		.out_data          (agent_pipeline_003_source0_data),                      //  output,  width = 698,          .data
		.in_empty          (1'b0),                                                 // (terminated),                         
		.out_empty         (),                                                     // (terminated),                         
		.out_error         (),                                                     // (terminated),                         
		.in_error          (1'b0),                                                 // (terminated),                         
	...
	qsys_top_altera_avalon_st_pipeline_stage_1920_zterisq #(
		...
		.in_data           (cmd_demux_src0_data),                                  //   input,  width = 158,          .data
		...
		.out_data          (mux_pipeline_source0_data),                            //  output,  width = 158,          .data
	...
	qsys_top_altera_avalon_st_pipeline_stage_1920_zterisq #(
		...
		.in_data           (cmd_demux_src1_data),                                  //   input,  width = 158,          .data
		...
		.out_data          (mux_pipeline_001_source0_data),                        //  output,  width = 158,          .data
	...
	qsys_top_altera_avalon_st_pipeline_stage_1920_zterisq #(
		...
		.in_data           (rsp_demux_src0_data),                                  //   input,  width = 158,          .data
		...
		.out_data          (mux_pipeline_002_source0_data),                        //  output,  width = 158,          .data
	...
	qsys_top_altera_avalon_st_pipeline_stage_1920_zterisq #(
		...
		.in_data           (rsp_demux_001_src0_data),                              //   input,  width = 158,          .data
		...
		.out_data          (mux_pipeline_003_source0_data),                        //  output,  width = 158,          .data
