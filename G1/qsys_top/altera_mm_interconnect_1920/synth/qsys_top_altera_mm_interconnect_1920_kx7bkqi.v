// qsys_top_altera_mm_interconnect_1920_kx7bkqi.v
...
`timescale 1 ps / 1 ps
module qsys_top_altera_mm_interconnect_1920_kx7bkqi (
	...
	wire  [697:0] agilex_hps_f2h_axi_slave_agent_write_rp_data;                        // agilex_hps_f2h_axi_slave_agent:write_rp_data -> router_001:sink_data
	...
	wire  [697:0] agilex_hps_f2h_axi_slave_agent_read_rp_data;                         // agilex_hps_f2h_axi_slave_agent:read_rp_data -> router_002:sink_data
	...
	wire  [157:0] jtag2mm_s_master_limiter_cmd_src_data;                               // jtag2mm_s_master_limiter:cmd_src_data -> cmd_demux:sink_data
	wire          jtag2mm_s_master_limiter_cmd_src_ready;                              // cmd_demux:sink_ready -> jtag2mm_s_master_limiter:cmd_src_ready
	wire    [1:0] jtag2mm_s_master_limiter_cmd_src_channel;                            // jtag2mm_s_master_limiter:cmd_src_channel -> cmd_demux:sink_channel
	wire          jtag2mm_s_master_limiter_cmd_src_startofpacket;                      // jtag2mm_s_master_limiter:cmd_src_startofpacket -> cmd_demux:sink_startofpacket
	wire          jtag2mm_s_master_limiter_cmd_src_endofpacket;                        // jtag2mm_s_master_limiter:cmd_src_endofpacket -> cmd_demux:sink_endofpacket
	wire          rsp_mux_src_valid;                                                   // rsp_mux:src_valid -> jtag2mm_s_master_limiter:rsp_sink_valid
	wire  [157:0] rsp_mux_src_data;                                                    // rsp_mux:src_data -> jtag2mm_s_master_limiter:rsp_sink_data
	wire          rsp_mux_src_ready;                                                   // jtag2mm_s_master_limiter:rsp_sink_ready -> rsp_mux:src_ready
	wire    [1:0] rsp_mux_src_channel;                                                 // rsp_mux:src_channel -> jtag2mm_s_master_limiter:rsp_sink_channel
	wire          rsp_mux_src_startofpacket;                                           // rsp_mux:src_startofpacket -> jtag2mm_s_master_limiter:rsp_sink_startofpacket
	wire          rsp_mux_src_endofpacket;                                             // rsp_mux:src_endofpacket -> jtag2mm_s_master_limiter:rsp_sink_endofpacket
	...
	wire  [697:0] agilex_hps_f2h_axi_slave_wr_cmd_width_adapter_src_data;              // agilex_hps_f2h_axi_slave_wr_cmd_width_adapter:out_data -> agilex_hps_f2h_axi_slave_agent:write_cp_data
	...
	wire  [697:0] agilex_hps_f2h_axi_slave_rd_cmd_width_adapter_src_data;              // agilex_hps_f2h_axi_slave_rd_cmd_width_adapter:out_data -> agilex_hps_f2h_axi_slave_agent:read_cp_data
	...
	wire    [1:0] jtag2mm_s_master_limiter_cmd_valid_data;                             // jtag2mm_s_master_limiter:cmd_src_valid -> cmd_demux:sink_valid
	...
	qsys_top_altera_merlin_axi_slave_ni_1941_5ooumii #(
		...
		.read_cp_data           (agilex_hps_f2h_axi_slave_rd_cmd_width_adapter_src_data),          //   input,  width = 698,                  .data
		...
		.write_cp_data          (agilex_hps_f2h_axi_slave_wr_cmd_width_adapter_src_data),          //   input,  width = 698,                  .data
	...
	qsys_top_altera_merlin_traffic_limiter_191_6blplji #(
		...
		.rsp_sink_data          (rsp_mux_src_data),                                              //   input,  width = 158,          .data
		...
		.cmd_src_valid          (jtag2mm_s_master_limiter_cmd_valid_data)                        //  output,    width = 2, cmd_valid.data
	);

	qsys_top_altera_merlin_demultiplexer_1921_z22k7xi cmd_demux (
		.clk                (clk_100_out_clk_clk),                                           //   input,    width = 1,        clk.clk
		.reset              (jtag2mm_s_master_translator_reset_reset_bridge_in_reset_reset), //   input,    width = 1,  clk_reset.reset
		.sink_ready         (jtag2mm_s_master_limiter_cmd_src_ready),                        //  output,    width = 1,       sink.ready
		.sink_channel       (jtag2mm_s_master_limiter_cmd_src_channel),                      //   input,    width = 2,           .channel
		.sink_data          (jtag2mm_s_master_limiter_cmd_src_data),                         //   input,  width = 158,           .data
		...
		.sink_valid         (jtag2mm_s_master_limiter_cmd_valid_data),                       //   input,    width = 2, sink_valid.data
	...
	qsys_top_altera_merlin_multiplexer_1921_fgpooby cmd_mux (
		...
		.sink0_data          (cmd_demux_src0_data),                                           //   input,  width = 158,          .data
	...
	qsys_top_altera_merlin_multiplexer_1921_fgpooby cmd_mux_001 (
		...
		.sink0_data          (cmd_demux_src1_data),                                           //   input,  width = 158,          .data
	...
	qsys_top_altera_merlin_multiplexer_1921_5p55ega rsp_mux (
		...
		.sink0_data          (rsp_demux_src0_data),                                           //   input,  width = 158,          .data
		...
		.sink1_data          (rsp_demux_001_src0_data),                                       //   input,  width = 158,          .data
