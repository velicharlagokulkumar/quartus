...
//   output_name:         qsys_top_altera_merlin_multiplexer_1921_iab2y3y
//   NUM_INPUTS:          2
...
module qsys_top_altera_merlin_multiplexer_1921_iab2y3y
(
    // ----------------------
    // Sinks
    // ----------------------
    input                       sink0_valid,
    input [698-1   : 0]  sink0_data,
