...
# ----------------------------------------
# If emif_hps is one of several IP cores in your
...
# ----------------------------------------
# ACDS 22.4 94 linux 2024.01.25.19:29:33
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "emif_hps.emif_hps"
}
...
append ELAB_OPTIONS [subst [emif_hps::get_elab_options $SIMULATOR_TOOL_BITNESS]]
append SIM_OPTIONS [subst [emif_hps::get_sim_options $SIMULATOR_TOOL_BITNESS]]
...
alias file_copy {
  ...
  set memory_files [concat $memory_files [emif_hps::get_memory_files "$QSYS_SIMDIR"]]
  ...
  set normalized_src [emif_hps::normalize_path "$file"]
  set normalized_dest [emif_hps::normalize_path "$dest_file"]
...
set design_libraries [dict merge $design_libraries [emif_hps::get_design_libraries]]
...
alias com {
  ...
  set design_files [dict merge [emif_hps::get_common_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR"]]
  set common_design_files [dict values $design_files]
  foreach file $common_design_files {
    eval $file
  }
  set design_files [list]
  set design_files [concat $design_files [emif_hps::get_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR"]]
