...
namespace eval emif_hps {
  proc get_design_libraries {} {
    set libraries [dict create]
    dict set libraries altera_emif_arch_fm_191 1
    dict set libraries altera_emif_fm_hps_262  1
    dict set libraries emif_hps                1
    return $libraries
  }
  
  proc get_memory_files {QSYS_SIMDIR} {
    set memory_files [list]
    lappend memory_files "[normalize_path "$QSYS_SIMDIR/../altera_emif_arch_fm_191/sim/emif_hps_altera_emif_arch_fm_191_ky5ybpi_seq_params_synth.hex"]"
    return $memory_files
  }
  ...
  proc get_design_files {USER_DEFINED_COMPILE_OPTIONS USER_DEFINED_VERILOG_COMPILE_OPTIONS USER_DEFINED_VHDL_COMPILE_OPTIONS QSYS_SIMDIR} {
    ...
    lappend design_files "vlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS  \"[normalize_path "$QSYS_SIMDIR/../altera_emif_arch_fm_191/sim/emif_hps_altera_emif_arch_fm_191_ky5ybpi_top.sv"]\"  -work altera_emif_arch_fm_191"
    ...
    lappend design_files "vlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS  \"[normalize_path "$QSYS_SIMDIR/../altera_emif_arch_fm_191/sim/emif_hps_altera_emif_arch_fm_191_ky5ybpi.sv"]\"  -work altera_emif_arch_fm_191"    
    lappend design_files "vlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS  \"[normalize_path "$QSYS_SIMDIR/../altera_emif_fm_hps_262/sim/emif_hps_altera_emif_fm_hps_262_ijg2uvy.v"]\"  -work altera_emif_fm_hps_262"            
    lappend design_files "vlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS  \"[normalize_path "$QSYS_SIMDIR/emif_hps.v"]\"  -work emif_hps"                                                                                       
    return $design_files
  }
