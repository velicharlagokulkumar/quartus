...
# ----------------------------------------
# If rst_in is one of several IP cores in your
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "rst_in.rst_in"
}
...
append ELAB_OPTIONS [subst [rst_in::get_elab_options $SIMULATOR_TOOL_BITNESS]]
append SIM_OPTIONS [subst [rst_in::get_sim_options $SIMULATOR_TOOL_BITNESS]]
...
alias file_copy {
  ...
  set memory_files [concat $memory_files [rst_in::get_memory_files "$QSYS_SIMDIR"]]
  ...
  set normalized_src [rst_in::normalize_path "$file"]
  set normalized_dest [rst_in::normalize_path "$dest_file"]
...
set design_libraries [dict merge $design_libraries [rst_in::get_design_libraries]]
...
alias com {
  ...
  set design_files [dict merge [rst_in::get_common_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR"]]
  set common_design_files [dict values $design_files]
  foreach file $common_design_files {
    eval $file
  }
  set design_files [list]
  set design_files [concat $design_files [rst_in::get_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR"]]
