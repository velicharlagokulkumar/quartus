...
# ----------------------------------------
# If user_rst_clkgate_0 is one of several IP cores in your
...
# ----------------------------------------
# ACDS 22.4 94 linux 2024.01.25.19:29:15
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "user_rst_clkgate_0.user_rst_clkgate_0"
}
...
if ![info exists QUARTUS_INSTALL_DIR] { 
  set QUARTUS_INSTALL_DIR "/home/wisig321/intelFPGA_pro/22.4/quartus/"
}
...
append ELAB_OPTIONS [subst [user_rst_clkgate_0::get_elab_options $SIMULATOR_TOOL_BITNESS]]
append SIM_OPTIONS [subst [user_rst_clkgate_0::get_sim_options $SIMULATOR_TOOL_BITNESS]]
...
alias file_copy {
  ...
  set memory_files [concat $memory_files [user_rst_clkgate_0::get_memory_files "$QSYS_SIMDIR"]]
  ...
  set normalized_src [user_rst_clkgate_0::normalize_path "$file"]
  set normalized_dest [user_rst_clkgate_0::normalize_path "$dest_file"]
...
set design_libraries [dict merge $design_libraries [user_rst_clkgate_0::get_design_libraries]]
...
alias com {
  ...
  set design_files [dict merge [user_rst_clkgate_0::get_common_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR"]]
  set common_design_files [dict values $design_files]
  foreach file $common_design_files {
    eval $file
  }
  set design_files [list]
  set design_files [concat $design_files [user_rst_clkgate_0::get_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR"]]
