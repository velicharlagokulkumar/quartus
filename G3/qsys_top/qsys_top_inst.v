	qsys_top u0 (
		...
		.ram_controller_1_src_write_cmd_tready (_connected_to_ram_controller_1_src_write_cmd_tready_), //   input,   width = 1, ram_controller_1_src_write_cmd.tready
		.ram_controller_1_src_write_cmd_tdata  (_connected_to_ram_controller_1_src_write_cmd_tdata_),  //  output,  width = 96,                               .tdata
		.ram_controller_1_src_write_cmd_tvalid (_connected_to_ram_controller_1_src_write_cmd_tvalid_), //  output,   width = 1,                               .tvalid
