...
//    output_name             qsys_top_altera_merlin_router_1921_333dfui
//    pkt_addr_h              175
//    pkt_addr_l              144
//    pkt_dest_id_h           219
//    pkt_dest_id_l           218
...
//    pkt_trans_read          179
//    pkt_trans_write         178
//    slaves_info             2:0010:0x0:0x20:both:1:0:0:1,3:0001:0x20:0x40:both:1:0:0:1,0:1000:0x1000:0x2000:both:1:0:0:1,1:0100:0x3000:0x3010:both:1:0:0:1
//    st_channel_w            4
//    st_data_w               245
// ------------------------------------------

module qsys_top_altera_merlin_router_1921_333dfui_default_decode
  #(
...
module qsys_top_altera_merlin_router_1921_333dfui
(
    // -------------------
    // Clock & Reset
    // -------------------
    ...
    qsys_top_altera_merlin_router_1921_333dfui_default_decode the_default_decode(
    ...
    always @* begin
        ...
        // slave 2: [0x1000, 0x2000) : sel [13:12]
        if ( {address[13:12],{12 {1'b0}}} == 14'h1000   ) begin
            src_channel = 4'b1000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 0;
        end

        // slave 3: [0x3000, 0x3010) : sel [13:4]
