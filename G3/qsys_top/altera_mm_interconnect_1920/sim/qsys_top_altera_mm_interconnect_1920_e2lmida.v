// qsys_top_altera_mm_interconnect_1920_e2lmida.v
...
`timescale 1 ps / 1 ps
module qsys_top_altera_mm_interconnect_1920_e2lmida (
	...
	wire    [2:0] agilex_hps_h2f_axi_master_wr_limiter_cmd_src_channel;       // agilex_hps_h2f_axi_master_wr_limiter:cmd_src_channel -> cmd_demux:sink_channel
	...
	wire    [2:0] rsp_mux_src_channel;                                        // rsp_mux:src_channel -> agilex_hps_h2f_axi_master_wr_limiter:rsp_sink_channel
	...
	wire    [2:0] agilex_hps_h2f_axi_master_rd_limiter_cmd_src_channel;       // agilex_hps_h2f_axi_master_rd_limiter:cmd_src_channel -> cmd_demux_001:sink_channel
	...
	wire    [2:0] rsp_mux_001_src_channel;                                    // rsp_mux_001:src_channel -> agilex_hps_h2f_axi_master_rd_limiter:rsp_sink_channel
	...
	wire    [2:0] ram_controller_1_csr_burst_adapter_source0_channel;         // ram_controller_1_csr_burst_adapter:source0_channel -> ram_controller_1_csr_agent:cp_channel
	...
	wire    [2:0] prbs_generator_1_csr_burst_adapter_source0_channel;         // prbs_generator_1_csr_burst_adapter:source0_channel -> prbs_generator_1_csr_agent:cp_channel
	...
	wire    [2:0] router_002_src_channel;                                     // router_002:src_channel -> ram_controller_1_csr_rsp_width_adapter:in_channel
	...
	wire    [2:0] ram_controller_1_csr_rsp_width_adapter_src_channel;         // ram_controller_1_csr_rsp_width_adapter:out_channel -> rsp_demux:sink_channel
	...
	wire    [2:0] router_003_src_channel;                                     // router_003:src_channel -> prbs_generator_1_csr_rsp_width_adapter:in_channel
	...
	wire    [2:0] prbs_generator_1_csr_rsp_width_adapter_src_channel;         // prbs_generator_1_csr_rsp_width_adapter:out_channel -> rsp_demux_001:sink_channel
	...
	wire    [2:0] cmd_mux_src_channel;                                        // cmd_mux:src_channel -> ram_controller_1_csr_cmd_width_adapter:in_channel
	...
	wire    [2:0] ram_controller_1_csr_cmd_width_adapter_src_channel;         // ram_controller_1_csr_cmd_width_adapter:out_channel -> ram_controller_1_csr_burst_adapter:sink0_channel
	...
	wire    [2:0] cmd_mux_001_src_channel;                                    // cmd_mux_001:src_channel -> prbs_generator_1_csr_cmd_width_adapter:in_channel
	...
	wire    [2:0] prbs_generator_1_csr_cmd_width_adapter_src_channel;         // prbs_generator_1_csr_cmd_width_adapter:out_channel -> prbs_generator_1_csr_burst_adapter:sink0_channel
	...
	wire    [2:0] agilex_hps_h2f_axi_master_wr_limiter_cmd_valid_data;        // agilex_hps_h2f_axi_master_wr_limiter:cmd_src_valid -> cmd_demux:sink_valid
	wire    [2:0] agilex_hps_h2f_axi_master_rd_limiter_cmd_valid_data;        // agilex_hps_h2f_axi_master_rd_limiter:cmd_src_valid -> cmd_demux_001:sink_valid
	...
	qsys_top_altera_merlin_slave_agent_191_ncfkfri #(
		...
		.cp_channel              (ram_controller_1_csr_burst_adapter_source0_channel),                         //   input,    width = 3,                .channel
	...
	qsys_top_altera_merlin_slave_agent_191_ncfkfri #(
		...
		.cp_channel              (prbs_generator_1_csr_burst_adapter_source0_channel),                         //   input,    width = 3,                .channel
	...
	qsys_top_altera_merlin_slave_agent_191_ncfkfri #(
		...
		.cp_channel              (pio_0_s1_burst_adapter_source0_channel),                                     //   input,    width = 3,                .channel
	...
	qsys_top_altera_merlin_router_1921_qcliebq router (
	...
	qsys_top_altera_merlin_router_1921_qcliebq router_001 (
	...
	qsys_top_altera_merlin_router_1921_sgnkmui router_002 (
	...
	qsys_top_altera_merlin_router_1921_sgnkmui router_003 (
	...
	qsys_top_altera_merlin_router_1921_sgnkmui router_004 (
	...
	qsys_top_altera_merlin_traffic_limiter_191_6blplji #(
		...
		.cmd_src_valid          (agilex_hps_h2f_axi_master_wr_limiter_cmd_valid_data)                         //  output,    width = 3, cmd_valid.data
	);
	...
	qsys_top_altera_merlin_traffic_limiter_191_6blplji #(
		...
		.rsp_sink_channel       (rsp_mux_001_src_channel),                                                    //   input,    width = 3,          .channel
		...
		.cmd_src_valid          (agilex_hps_h2f_axi_master_rd_limiter_cmd_valid_data)                         //  output,    width = 3, cmd_valid.data
	);
	...
	qsys_top_altera_merlin_burst_adapter_1923_goicj3i #(
		...
		.sink0_channel         (ram_controller_1_csr_cmd_width_adapter_src_channel),                         //   input,    width = 3,          .channel
		...
		.source0_channel       (ram_controller_1_csr_burst_adapter_source0_channel),                         //  output,    width = 3,          .channel
	...
	qsys_top_altera_merlin_burst_adapter_1923_goicj3i #(
		...
		.sink0_channel         (prbs_generator_1_csr_cmd_width_adapter_src_channel),                         //   input,    width = 3,          .channel
		...
		.source0_channel       (prbs_generator_1_csr_burst_adapter_source0_channel),                         //  output,    width = 3,          .channel
	...
	qsys_top_altera_merlin_burst_adapter_1923_goicj3i #(
		...
		.sink0_channel         (pio_0_s1_cmd_width_adapter_src_channel),                                     //   input,    width = 3,          .channel
	...
	qsys_top_altera_merlin_demultiplexer_1921_ewsbekq cmd_demux (
		.clk                (clk_100_out_clk_clk),                                                        //   input,    width = 1,        clk.clk
		.reset              (agilex_hps_h2f_axi_master_translator_clk_reset_reset_bridge_in_reset_reset), //   input,    width = 1,  clk_reset.reset
		.sink_ready         (agilex_hps_h2f_axi_master_wr_limiter_cmd_src_ready),                         //  output,    width = 1,       sink.ready
		.sink_channel       (agilex_hps_h2f_axi_master_wr_limiter_cmd_src_channel),                       //   input,    width = 3,           .channel
		...
		.sink_valid         (agilex_hps_h2f_axi_master_wr_limiter_cmd_valid_data),                        //   input,    width = 3, sink_valid.data
	...
	qsys_top_altera_merlin_demultiplexer_1921_ewsbekq cmd_demux_001 (
		.clk                (clk_100_out_clk_clk),                                                        //   input,    width = 1,        clk.clk
		.reset              (agilex_hps_h2f_axi_master_translator_clk_reset_reset_bridge_in_reset_reset), //   input,    width = 1,  clk_reset.reset
		.sink_ready         (agilex_hps_h2f_axi_master_rd_limiter_cmd_src_ready),                         //  output,    width = 1,       sink.ready
		.sink_channel       (agilex_hps_h2f_axi_master_rd_limiter_cmd_src_channel),                       //   input,    width = 3,           .channel
		...
		.sink_valid         (agilex_hps_h2f_axi_master_rd_limiter_cmd_valid_data),                        //   input,    width = 3, sink_valid.data
	...
	qsys_top_altera_merlin_multiplexer_1921_y2gzbry cmd_mux (
		.clk                 (clk_100_out_clk_clk),                                                        //   input,    width = 1,       clk.clk
		.reset               (agilex_hps_h2f_axi_master_translator_clk_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	qsys_top_altera_merlin_multiplexer_1921_y2gzbry cmd_mux_001 (
		.clk                 (clk_100_out_clk_clk),                                                        //   input,    width = 1,       clk.clk
		.reset               (agilex_hps_h2f_axi_master_translator_clk_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	qsys_top_altera_merlin_multiplexer_1921_y2gzbry cmd_mux_002 (
		.clk                 (clk_100_out_clk_clk),                                                        //   input,    width = 1,       clk.clk
		.reset               (agilex_hps_h2f_axi_master_translator_clk_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	qsys_top_altera_merlin_demultiplexer_1921_sdvkkgq rsp_demux (
		.clk                (clk_100_out_clk_clk),                                                        //   input,    width = 1,       clk.clk
		.reset              (agilex_hps_h2f_axi_master_translator_clk_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
		.sink_ready         (ram_controller_1_csr_rsp_width_adapter_src_ready),                           //  output,    width = 1,      sink.ready
		.sink_channel       (ram_controller_1_csr_rsp_width_adapter_src_channel),                         //   input,    width = 3,          .channel
	...
	qsys_top_altera_merlin_demultiplexer_1921_sdvkkgq rsp_demux_001 (
		.clk                (clk_100_out_clk_clk),                                                        //   input,    width = 1,       clk.clk
		.reset              (agilex_hps_h2f_axi_master_translator_clk_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
		.sink_ready         (prbs_generator_1_csr_rsp_width_adapter_src_ready),                           //  output,    width = 1,      sink.ready
		.sink_channel       (prbs_generator_1_csr_rsp_width_adapter_src_channel),                         //   input,    width = 3,          .channel
	...
	qsys_top_altera_merlin_demultiplexer_1921_sdvkkgq rsp_demux_002 (
		.clk                (clk_100_out_clk_clk),                                                        //   input,    width = 1,       clk.clk
		.reset              (agilex_hps_h2f_axi_master_translator_clk_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
		.sink_ready         (pio_0_s1_rsp_width_adapter_src_ready),                                       //  output,    width = 1,      sink.ready
		.sink_channel       (pio_0_s1_rsp_width_adapter_src_channel),                                     //   input,    width = 3,          .channel
	...
	qsys_top_altera_merlin_multiplexer_1921_ba3f2mi rsp_mux (
		.clk                 (clk_100_out_clk_clk),                                                        //   input,    width = 1,       clk.clk
		.reset               (agilex_hps_h2f_axi_master_translator_clk_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	qsys_top_altera_merlin_multiplexer_1921_ba3f2mi rsp_mux_001 (
		.clk                 (clk_100_out_clk_clk),                                                        //   input,    width = 1,       clk.clk
		.reset               (agilex_hps_h2f_axi_master_translator_clk_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	qsys_top_altera_merlin_width_adapter_1920_v4zrbhq #(
		...
		.out_channel          (ram_controller_1_csr_rsp_width_adapter_src_channel),                         //  output,    width = 3,          .channel
	...
	qsys_top_altera_merlin_width_adapter_1920_v4zrbhq #(
		...
		.out_channel          (prbs_generator_1_csr_rsp_width_adapter_src_channel),                         //  output,    width = 3,          .channel
	...
	qsys_top_altera_merlin_width_adapter_1920_v4zrbhq #(
		...
		.in_channel           (router_004_src_channel),                                                     //   input,    width = 3,          .channel
		...
		.out_channel          (pio_0_s1_rsp_width_adapter_src_channel),                                     //  output,    width = 3,          .channel
	...
	qsys_top_altera_merlin_width_adapter_1920_b4iaudq #(
		...
		.out_channel          (ram_controller_1_csr_cmd_width_adapter_src_channel),                         //  output,    width = 3,          .channel
	...
	qsys_top_altera_merlin_width_adapter_1920_b4iaudq #(
		...
		.out_channel          (prbs_generator_1_csr_cmd_width_adapter_src_channel),                         //  output,    width = 3,          .channel
	...
	qsys_top_altera_merlin_width_adapter_1920_b4iaudq #(
		...
		.out_channel          (pio_0_s1_cmd_width_adapter_src_channel),                                     //  output,    width = 3,          .channel
