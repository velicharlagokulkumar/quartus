// qsys_top_altera_mm_interconnect_1920_olyfxpq.v
...
`timescale 1 ps / 1 ps
module qsys_top_altera_mm_interconnect_1920_olyfxpq (
	...
	wire  [137:0] ram_controller_1_csr_agent_rf_source_data;                  // ram_controller_1_csr_agent:rf_source_data -> ram_controller_1_csr_agent_rsp_fifo:in_data
	...
	wire  [137:0] ram_controller_1_csr_agent_rsp_fifo_out_data;               // ram_controller_1_csr_agent_rsp_fifo:out_data -> ram_controller_1_csr_agent:rf_sink_data
	...
	wire  [137:0] prbs_generator_1_csr_agent_rf_source_data;                  // prbs_generator_1_csr_agent:rf_source_data -> prbs_generator_1_csr_agent_rsp_fifo:in_data
	...
	wire  [137:0] prbs_generator_1_csr_agent_rsp_fifo_out_data;               // prbs_generator_1_csr_agent_rsp_fifo:out_data -> prbs_generator_1_csr_agent:rf_sink_data
	...
	wire  [137:0] onchip_memory2_0_s1_agent_rf_source_data;                   // onchip_memory2_0_s1_agent:rf_source_data -> onchip_memory2_0_s1_agent_rsp_fifo:in_data
	...
	wire  [137:0] onchip_memory2_0_s1_agent_rsp_fifo_out_data;                // onchip_memory2_0_s1_agent_rsp_fifo:out_data -> onchip_memory2_0_s1_agent:rf_sink_data
	...
	wire          ram_controller_1_csr_agent_rp_valid;                        // ram_controller_1_csr_agent:rp_valid -> router_002:sink_valid
	wire  [136:0] ram_controller_1_csr_agent_rp_data;                         // ram_controller_1_csr_agent:rp_data -> router_002:sink_data
	wire          ram_controller_1_csr_agent_rp_ready;                        // router_002:sink_ready -> ram_controller_1_csr_agent:rp_ready
	wire          ram_controller_1_csr_agent_rp_startofpacket;                // ram_controller_1_csr_agent:rp_startofpacket -> router_002:sink_startofpacket
	wire          ram_controller_1_csr_agent_rp_endofpacket;                  // ram_controller_1_csr_agent:rp_endofpacket -> router_002:sink_endofpacket
	wire          prbs_generator_1_csr_agent_rp_valid;                        // prbs_generator_1_csr_agent:rp_valid -> router_003:sink_valid
	wire  [136:0] prbs_generator_1_csr_agent_rp_data;                         // prbs_generator_1_csr_agent:rp_data -> router_003:sink_data
	wire          prbs_generator_1_csr_agent_rp_ready;                        // router_003:sink_ready -> prbs_generator_1_csr_agent:rp_ready
	wire          prbs_generator_1_csr_agent_rp_startofpacket;                // prbs_generator_1_csr_agent:rp_startofpacket -> router_003:sink_startofpacket
	wire          prbs_generator_1_csr_agent_rp_endofpacket;                  // prbs_generator_1_csr_agent:rp_endofpacket -> router_003:sink_endofpacket
	wire          pio_0_s1_agent_rp_valid;                                    // pio_0_s1_agent:rp_valid -> router_004:sink_valid
	wire  [136:0] pio_0_s1_agent_rp_data;                                     // pio_0_s1_agent:rp_data -> router_004:sink_data
	...
	wire  [136:0] onchip_memory2_0_s1_agent_rp_data;                          // onchip_memory2_0_s1_agent:rp_data -> router_005:sink_data
	...
	wire  [244:0] agilex_hps_h2f_axi_master_wr_limiter_cmd_src_data;          // agilex_hps_h2f_axi_master_wr_limiter:cmd_src_data -> cmd_demux:sink_data
	...
	wire    [3:0] agilex_hps_h2f_axi_master_wr_limiter_cmd_src_channel;       // agilex_hps_h2f_axi_master_wr_limiter:cmd_src_channel -> cmd_demux:sink_channel
	...
	wire  [244:0] rsp_mux_src_data;                                           // rsp_mux:src_data -> agilex_hps_h2f_axi_master_wr_limiter:rsp_sink_data
	wire          rsp_mux_src_ready;                                          // agilex_hps_h2f_axi_master_wr_limiter:rsp_sink_ready -> rsp_mux:src_ready
	wire    [3:0] rsp_mux_src_channel;                                        // rsp_mux:src_channel -> agilex_hps_h2f_axi_master_wr_limiter:rsp_sink_channel
	...
	wire  [244:0] agilex_hps_h2f_axi_master_rd_limiter_cmd_src_data;          // agilex_hps_h2f_axi_master_rd_limiter:cmd_src_data -> cmd_demux_001:sink_data
	...
	wire    [3:0] agilex_hps_h2f_axi_master_rd_limiter_cmd_src_channel;       // agilex_hps_h2f_axi_master_rd_limiter:cmd_src_channel -> cmd_demux_001:sink_channel
	...
	wire  [244:0] rsp_mux_001_src_data;                                       // rsp_mux_001:src_data -> agilex_hps_h2f_axi_master_rd_limiter:rsp_sink_data
	wire          rsp_mux_001_src_ready;                                      // agilex_hps_h2f_axi_master_rd_limiter:rsp_sink_ready -> rsp_mux_001:src_ready
	wire    [3:0] rsp_mux_001_src_channel;                                    // rsp_mux_001:src_channel -> agilex_hps_h2f_axi_master_rd_limiter:rsp_sink_channel
	...
	wire  [136:0] ram_controller_1_csr_burst_adapter_source0_data;            // ram_controller_1_csr_burst_adapter:source0_data -> ram_controller_1_csr_agent:cp_data
	...
	wire    [3:0] ram_controller_1_csr_burst_adapter_source0_channel;         // ram_controller_1_csr_burst_adapter:source0_channel -> ram_controller_1_csr_agent:cp_channel
	...
	wire  [136:0] prbs_generator_1_csr_burst_adapter_source0_data;            // prbs_generator_1_csr_burst_adapter:source0_data -> prbs_generator_1_csr_agent:cp_data
	...
	wire    [3:0] prbs_generator_1_csr_burst_adapter_source0_channel;         // prbs_generator_1_csr_burst_adapter:source0_channel -> prbs_generator_1_csr_agent:cp_channel
	...
	wire  [136:0] pio_0_s1_burst_adapter_source0_data;                        // pio_0_s1_burst_adapter:source0_data -> pio_0_s1_agent:cp_data
	...
	wire  [136:0] onchip_memory2_0_s1_burst_adapter_source0_data;             // onchip_memory2_0_s1_burst_adapter:source0_data -> onchip_memory2_0_s1_agent:cp_data
	...
	wire  [244:0] cmd_demux_src0_data;                                        // cmd_demux:src0_data -> cmd_mux:sink0_data
	...
	wire  [244:0] cmd_demux_src1_data;                                        // cmd_demux:src1_data -> cmd_mux_001:sink0_data
	...
	wire  [244:0] cmd_demux_src2_data;                                        // cmd_demux:src2_data -> cmd_mux_002:sink0_data
	...
	wire  [244:0] cmd_demux_src3_data;                                        // cmd_demux:src3_data -> cmd_mux_003:sink0_data
	...
	wire  [244:0] cmd_demux_001_src0_data;                                    // cmd_demux_001:src0_data -> cmd_mux:sink1_data
	...
	wire  [244:0] cmd_demux_001_src1_data;                                    // cmd_demux_001:src1_data -> cmd_mux_001:sink1_data
	...
	wire  [244:0] cmd_demux_001_src2_data;                                    // cmd_demux_001:src2_data -> cmd_mux_002:sink1_data
	...
	wire  [244:0] cmd_demux_001_src3_data;                                    // cmd_demux_001:src3_data -> cmd_mux_003:sink1_data
	...
	wire  [244:0] rsp_demux_src0_data;                                        // rsp_demux:src0_data -> rsp_mux:sink0_data
	...
	wire  [244:0] rsp_demux_src1_data;                                        // rsp_demux:src1_data -> rsp_mux_001:sink0_data
	...
	wire  [244:0] rsp_demux_001_src0_data;                                    // rsp_demux_001:src0_data -> rsp_mux:sink1_data
	...
	wire  [244:0] rsp_demux_001_src1_data;                                    // rsp_demux_001:src1_data -> rsp_mux_001:sink1_data
	...
	wire  [244:0] rsp_demux_002_src0_data;                                    // rsp_demux_002:src0_data -> rsp_mux:sink2_data
	...
	wire  [244:0] rsp_demux_002_src1_data;                                    // rsp_demux_002:src1_data -> rsp_mux_001:sink2_data
	...
	wire  [244:0] rsp_demux_003_src0_data;                                    // rsp_demux_003:src0_data -> rsp_mux:sink3_data
	...
	wire  [244:0] rsp_demux_003_src1_data;                                    // rsp_demux_003:src1_data -> rsp_mux_001:sink3_data
	...
	wire          router_002_src_valid;                                       // router_002:src_valid -> ram_controller_1_csr_rsp_width_adapter:in_valid
	wire  [136:0] router_002_src_data;                                        // router_002:src_data -> ram_controller_1_csr_rsp_width_adapter:in_data
	wire          router_002_src_ready;                                       // ram_controller_1_csr_rsp_width_adapter:in_ready -> router_002:src_ready
	wire    [3:0] router_002_src_channel;                                     // router_002:src_channel -> ram_controller_1_csr_rsp_width_adapter:in_channel
	wire          router_002_src_startofpacket;                               // router_002:src_startofpacket -> ram_controller_1_csr_rsp_width_adapter:in_startofpacket
	wire          router_002_src_endofpacket;                                 // router_002:src_endofpacket -> ram_controller_1_csr_rsp_width_adapter:in_endofpacket
	wire          ram_controller_1_csr_rsp_width_adapter_src_valid;           // ram_controller_1_csr_rsp_width_adapter:out_valid -> rsp_demux:sink_valid
	wire  [244:0] ram_controller_1_csr_rsp_width_adapter_src_data;            // ram_controller_1_csr_rsp_width_adapter:out_data -> rsp_demux:sink_data
	wire          ram_controller_1_csr_rsp_width_adapter_src_ready;           // rsp_demux:sink_ready -> ram_controller_1_csr_rsp_width_adapter:out_ready
	wire    [3:0] ram_controller_1_csr_rsp_width_adapter_src_channel;         // ram_controller_1_csr_rsp_width_adapter:out_channel -> rsp_demux:sink_channel
	wire          ram_controller_1_csr_rsp_width_adapter_src_startofpacket;   // ram_controller_1_csr_rsp_width_adapter:out_startofpacket -> rsp_demux:sink_startofpacket
	wire          ram_controller_1_csr_rsp_width_adapter_src_endofpacket;     // ram_controller_1_csr_rsp_width_adapter:out_endofpacket -> rsp_demux:sink_endofpacket
	wire          router_003_src_valid;                                       // router_003:src_valid -> prbs_generator_1_csr_rsp_width_adapter:in_valid
	wire  [136:0] router_003_src_data;                                        // router_003:src_data -> prbs_generator_1_csr_rsp_width_adapter:in_data
	wire          router_003_src_ready;                                       // prbs_generator_1_csr_rsp_width_adapter:in_ready -> router_003:src_ready
	wire    [3:0] router_003_src_channel;                                     // router_003:src_channel -> prbs_generator_1_csr_rsp_width_adapter:in_channel
	wire          router_003_src_startofpacket;                               // router_003:src_startofpacket -> prbs_generator_1_csr_rsp_width_adapter:in_startofpacket
	wire          router_003_src_endofpacket;                                 // router_003:src_endofpacket -> prbs_generator_1_csr_rsp_width_adapter:in_endofpacket
	wire          prbs_generator_1_csr_rsp_width_adapter_src_valid;           // prbs_generator_1_csr_rsp_width_adapter:out_valid -> rsp_demux_001:sink_valid
	wire  [244:0] prbs_generator_1_csr_rsp_width_adapter_src_data;            // prbs_generator_1_csr_rsp_width_adapter:out_data -> rsp_demux_001:sink_data
	wire          prbs_generator_1_csr_rsp_width_adapter_src_ready;           // rsp_demux_001:sink_ready -> prbs_generator_1_csr_rsp_width_adapter:out_ready
	wire    [3:0] prbs_generator_1_csr_rsp_width_adapter_src_channel;         // prbs_generator_1_csr_rsp_width_adapter:out_channel -> rsp_demux_001:sink_channel
	wire          prbs_generator_1_csr_rsp_width_adapter_src_startofpacket;   // prbs_generator_1_csr_rsp_width_adapter:out_startofpacket -> rsp_demux_001:sink_startofpacket
	wire          prbs_generator_1_csr_rsp_width_adapter_src_endofpacket;     // prbs_generator_1_csr_rsp_width_adapter:out_endofpacket -> rsp_demux_001:sink_endofpacket
	wire          router_004_src_valid;                                       // router_004:src_valid -> pio_0_s1_rsp_width_adapter:in_valid
	wire  [136:0] router_004_src_data;                                        // router_004:src_data -> pio_0_s1_rsp_width_adapter:in_data
	...
	wire  [244:0] pio_0_s1_rsp_width_adapter_src_data;                        // pio_0_s1_rsp_width_adapter:out_data -> rsp_demux_002:sink_data
	...
	wire  [136:0] router_005_src_data;                                        // router_005:src_data -> onchip_memory2_0_s1_rsp_width_adapter:in_data
	...
	wire  [244:0] onchip_memory2_0_s1_rsp_width_adapter_src_data;             // onchip_memory2_0_s1_rsp_width_adapter:out_data -> rsp_demux_003:sink_data
	...
	wire          cmd_mux_src_valid;                                          // cmd_mux:src_valid -> ram_controller_1_csr_cmd_width_adapter:in_valid
	wire  [244:0] cmd_mux_src_data;                                           // cmd_mux:src_data -> ram_controller_1_csr_cmd_width_adapter:in_data
	wire          cmd_mux_src_ready;                                          // ram_controller_1_csr_cmd_width_adapter:in_ready -> cmd_mux:src_ready
	wire    [3:0] cmd_mux_src_channel;                                        // cmd_mux:src_channel -> ram_controller_1_csr_cmd_width_adapter:in_channel
	wire          cmd_mux_src_startofpacket;                                  // cmd_mux:src_startofpacket -> ram_controller_1_csr_cmd_width_adapter:in_startofpacket
	wire          cmd_mux_src_endofpacket;                                    // cmd_mux:src_endofpacket -> ram_controller_1_csr_cmd_width_adapter:in_endofpacket
	...
	wire  [136:0] ram_controller_1_csr_cmd_width_adapter_src_data;            // ram_controller_1_csr_cmd_width_adapter:out_data -> ram_controller_1_csr_burst_adapter:sink0_data
	...
	wire    [3:0] ram_controller_1_csr_cmd_width_adapter_src_channel;         // ram_controller_1_csr_cmd_width_adapter:out_channel -> ram_controller_1_csr_burst_adapter:sink0_channel
	...
	wire          cmd_mux_001_src_valid;                                      // cmd_mux_001:src_valid -> prbs_generator_1_csr_cmd_width_adapter:in_valid
	wire  [244:0] cmd_mux_001_src_data;                                       // cmd_mux_001:src_data -> prbs_generator_1_csr_cmd_width_adapter:in_data
	wire          cmd_mux_001_src_ready;                                      // prbs_generator_1_csr_cmd_width_adapter:in_ready -> cmd_mux_001:src_ready
	wire    [3:0] cmd_mux_001_src_channel;                                    // cmd_mux_001:src_channel -> prbs_generator_1_csr_cmd_width_adapter:in_channel
	wire          cmd_mux_001_src_startofpacket;                              // cmd_mux_001:src_startofpacket -> prbs_generator_1_csr_cmd_width_adapter:in_startofpacket
	wire          cmd_mux_001_src_endofpacket;                                // cmd_mux_001:src_endofpacket -> prbs_generator_1_csr_cmd_width_adapter:in_endofpacket
	...
	wire  [136:0] prbs_generator_1_csr_cmd_width_adapter_src_data;            // prbs_generator_1_csr_cmd_width_adapter:out_data -> prbs_generator_1_csr_burst_adapter:sink0_data
	...
	wire    [3:0] prbs_generator_1_csr_cmd_width_adapter_src_channel;         // prbs_generator_1_csr_cmd_width_adapter:out_channel -> prbs_generator_1_csr_burst_adapter:sink0_channel
	...
	wire  [244:0] cmd_mux_002_src_data;                                       // cmd_mux_002:src_data -> pio_0_s1_cmd_width_adapter:in_data
	...
	wire  [136:0] pio_0_s1_cmd_width_adapter_src_data;                        // pio_0_s1_cmd_width_adapter:out_data -> pio_0_s1_burst_adapter:sink0_data
	...
	wire  [244:0] cmd_mux_003_src_data;                                       // cmd_mux_003:src_data -> onchip_memory2_0_s1_cmd_width_adapter:in_data
	...
	wire  [136:0] onchip_memory2_0_s1_cmd_width_adapter_src_data;             // onchip_memory2_0_s1_cmd_width_adapter:out_data -> onchip_memory2_0_s1_burst_adapter:sink0_data
	...
	wire    [3:0] agilex_hps_h2f_axi_master_wr_limiter_cmd_valid_data;        // agilex_hps_h2f_axi_master_wr_limiter:cmd_src_valid -> cmd_demux:sink_valid
	wire    [3:0] agilex_hps_h2f_axi_master_rd_limiter_cmd_valid_data;        // agilex_hps_h2f_axi_master_rd_limiter:cmd_src_valid -> cmd_demux_001:sink_valid
	...
	qsys_top_altera_merlin_slave_agent_191_ncfkfri #(
		...
		.rp_data                 (ram_controller_1_csr_agent_rp_data),                                         //  output,  width = 137,                .data
		...
		.cp_data                 (ram_controller_1_csr_burst_adapter_source0_data),                            //   input,  width = 137,                .data
		...
		.cp_channel              (ram_controller_1_csr_burst_adapter_source0_channel),                         //   input,    width = 4,                .channel
		...
		.rf_sink_data            (ram_controller_1_csr_agent_rsp_fifo_out_data),                               //   input,  width = 138,                .data
		...
		.rf_source_data          (ram_controller_1_csr_agent_rf_source_data),                                  //  output,  width = 138,                .data
	...
	qsys_top_altera_avalon_sc_fifo_1931_vhmcgqy #(
		...
		.in_data           (ram_controller_1_csr_agent_rf_source_data),             //   input,  width = 138,        in.data
		...
		.out_data          (ram_controller_1_csr_agent_rsp_fifo_out_data),          //  output,  width = 138,       out.data
	...
	qsys_top_altera_merlin_slave_agent_191_ncfkfri #(
		...
		.rp_data                 (prbs_generator_1_csr_agent_rp_data),                                         //  output,  width = 137,                .data
		...
		.cp_data                 (prbs_generator_1_csr_burst_adapter_source0_data),                            //   input,  width = 137,                .data
		...
		.cp_channel              (prbs_generator_1_csr_burst_adapter_source0_channel),                         //   input,    width = 4,                .channel
		...
		.rf_sink_data            (prbs_generator_1_csr_agent_rsp_fifo_out_data),                               //   input,  width = 138,                .data
		...
		.rf_source_data          (prbs_generator_1_csr_agent_rf_source_data),                                  //  output,  width = 138,                .data
	...
	qsys_top_altera_avalon_sc_fifo_1931_vhmcgqy #(
		...
		.clk               (clk_100_out_clk_clk),                                   //   input,    width = 1,       clk.clk
		.reset             (agilex_hps_h2f_axi_reset_reset_bridge_in_reset_reset),  //   input,    width = 1, clk_reset.reset
		.in_data           (prbs_generator_1_csr_agent_rf_source_data),             //   input,  width = 138,        in.data
		...
		.out_data          (prbs_generator_1_csr_agent_rsp_fifo_out_data),          //  output,  width = 138,       out.data
	...
	qsys_top_altera_merlin_slave_agent_191_ncfkfri #(
		...
		.cp_data                 (pio_0_s1_burst_adapter_source0_data),                                        //   input,  width = 137,                .data
		...
		.cp_channel              (pio_0_s1_burst_adapter_source0_channel),                                     //   input,    width = 4,                .channel
	...
	qsys_top_altera_merlin_slave_agent_191_ncfkfri #(
		...
		.rp_data                 (onchip_memory2_0_s1_agent_rp_data),                                          //  output,  width = 137,                .data
		...
		.cp_data                 (onchip_memory2_0_s1_burst_adapter_source0_data),                             //   input,  width = 137,                .data
		...
		.rf_sink_data            (onchip_memory2_0_s1_agent_rsp_fifo_out_data),                                //   input,  width = 138,                .data
		...
		.rf_source_data          (onchip_memory2_0_s1_agent_rf_source_data),                                   //  output,  width = 138,                .data
	...
	qsys_top_altera_avalon_sc_fifo_1931_vhmcgqy #(
		...
		.clk               (clk_100_out_clk_clk),                                  //   input,    width = 1,       clk.clk
		.reset             (agilex_hps_h2f_axi_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
		.in_data           (onchip_memory2_0_s1_agent_rf_source_data),             //   input,  width = 138,        in.data
		...
		.out_data          (onchip_memory2_0_s1_agent_rsp_fifo_out_data),          //  output,  width = 138,       out.data
	...
	qsys_top_altera_merlin_router_1921_333dfui router (
	...
	qsys_top_altera_merlin_router_1921_333dfui router_001 (
	...
	qsys_top_altera_merlin_router_1921_jaa3dzq router_002 (
		...
		.sink_data          (ram_controller_1_csr_agent_rp_data),                                         //   input,  width = 137,          .data
	...
	qsys_top_altera_merlin_router_1921_jaa3dzq router_003 (
		...
		.sink_data          (prbs_generator_1_csr_agent_rp_data),                                         //   input,  width = 137,          .data
	...
	qsys_top_altera_merlin_router_1921_jaa3dzq router_005 (
		...
		.sink_data          (onchip_memory2_0_s1_agent_rp_data),                                          //   input,  width = 137,          .data
	...
	qsys_top_altera_merlin_traffic_limiter_191_6blplji #(
		...
		.rsp_sink_data          (rsp_mux_src_data),                                                           //   input,  width = 245,          .data
		...
		.cmd_src_valid          (agilex_hps_h2f_axi_master_wr_limiter_cmd_valid_data)                         //  output,    width = 4, cmd_valid.data
	);
	...
	qsys_top_altera_merlin_traffic_limiter_191_6blplji #(
		...
		.rsp_sink_data          (rsp_mux_001_src_data),                                                       //   input,  width = 245,          .data
		...
		.cmd_src_valid          (agilex_hps_h2f_axi_master_rd_limiter_cmd_valid_data)                         //  output,    width = 4, cmd_valid.data
	);
	...
	qsys_top_altera_merlin_burst_adapter_1923_goicj3i #(
		...
		.sink0_data            (ram_controller_1_csr_cmd_width_adapter_src_data),                            //   input,  width = 137,          .data
		.sink0_channel         (ram_controller_1_csr_cmd_width_adapter_src_channel),                         //   input,    width = 4,          .channel
		...
		.source0_data          (ram_controller_1_csr_burst_adapter_source0_data),                            //  output,  width = 137,          .data
		.source0_channel       (ram_controller_1_csr_burst_adapter_source0_channel),                         //  output,    width = 4,          .channel
	...
	qsys_top_altera_merlin_burst_adapter_1923_goicj3i #(
		...
		.sink0_data            (prbs_generator_1_csr_cmd_width_adapter_src_data),                            //   input,  width = 137,          .data
		.sink0_channel         (prbs_generator_1_csr_cmd_width_adapter_src_channel),                         //   input,    width = 4,          .channel
		...
		.source0_data          (prbs_generator_1_csr_burst_adapter_source0_data),                            //  output,  width = 137,          .data
		.source0_channel       (prbs_generator_1_csr_burst_adapter_source0_channel),                         //  output,    width = 4,          .channel
	...
	qsys_top_altera_merlin_burst_adapter_1923_goicj3i #(
		...
		.sink0_data            (pio_0_s1_cmd_width_adapter_src_data),                                        //   input,  width = 137,          .data
		.sink0_channel         (pio_0_s1_cmd_width_adapter_src_channel),                                     //   input,    width = 4,          .channel
	...
	qsys_top_altera_merlin_burst_adapter_1923_goicj3i #(
		...
		.sink0_data            (onchip_memory2_0_s1_cmd_width_adapter_src_data),                             //   input,  width = 137,          .data
		.sink0_channel         (onchip_memory2_0_s1_cmd_width_adapter_src_channel),                          //   input,    width = 4,          .channel
		...
		.source0_data          (onchip_memory2_0_s1_burst_adapter_source0_data),                             //  output,  width = 137,          .data
	...
	qsys_top_altera_merlin_demultiplexer_1921_mh5rhdq cmd_demux (
		.clk                (clk_100_out_clk_clk),                                                        //   input,    width = 1,        clk.clk
		.reset              (agilex_hps_h2f_axi_master_translator_clk_reset_reset_bridge_in_reset_reset), //   input,    width = 1,  clk_reset.reset
		.sink_ready         (agilex_hps_h2f_axi_master_wr_limiter_cmd_src_ready),                         //  output,    width = 1,       sink.ready
		.sink_channel       (agilex_hps_h2f_axi_master_wr_limiter_cmd_src_channel),                       //   input,    width = 4,           .channel
		.sink_data          (agilex_hps_h2f_axi_master_wr_limiter_cmd_src_data),                          //   input,  width = 245,           .data
		...
		.sink_valid         (agilex_hps_h2f_axi_master_wr_limiter_cmd_valid_data),                        //   input,    width = 4, sink_valid.data
		.src0_ready         (cmd_demux_src0_ready),                                                       //   input,    width = 1,       src0.ready
		.src0_valid         (cmd_demux_src0_valid),                                                       //  output,    width = 1,           .valid
		.src0_data          (cmd_demux_src0_data),                                                        //  output,  width = 245,           .data
		.src0_channel       (cmd_demux_src0_channel),                                                     //  output,    width = 4,           .channel
		.src0_startofpacket (cmd_demux_src0_startofpacket),                                               //  output,    width = 1,           .startofpacket
		.src0_endofpacket   (cmd_demux_src0_endofpacket),                                                 //  output,    width = 1,           .endofpacket
		.src1_ready         (cmd_demux_src1_ready),                                                       //   input,    width = 1,       src1.ready
		.src1_valid         (cmd_demux_src1_valid),                                                       //  output,    width = 1,           .valid
		.src1_data          (cmd_demux_src1_data),                                                        //  output,  width = 245,           .data
		...
		.src2_data          (cmd_demux_src2_data),                                                        //  output,  width = 245,           .data
		...
		.src3_data          (cmd_demux_src3_data),                                                        //  output,  width = 245,           .data
	...
	qsys_top_altera_merlin_demultiplexer_1921_mh5rhdq cmd_demux_001 (
		.clk                (clk_100_out_clk_clk),                                                        //   input,    width = 1,        clk.clk
		.reset              (agilex_hps_h2f_axi_master_translator_clk_reset_reset_bridge_in_reset_reset), //   input,    width = 1,  clk_reset.reset
		.sink_ready         (agilex_hps_h2f_axi_master_rd_limiter_cmd_src_ready),                         //  output,    width = 1,       sink.ready
		.sink_channel       (agilex_hps_h2f_axi_master_rd_limiter_cmd_src_channel),                       //   input,    width = 4,           .channel
		.sink_data          (agilex_hps_h2f_axi_master_rd_limiter_cmd_src_data),                          //   input,  width = 245,           .data
		...
		.sink_valid         (agilex_hps_h2f_axi_master_rd_limiter_cmd_valid_data),                        //   input,    width = 4, sink_valid.data
		...
		.src2_data          (cmd_demux_001_src2_data),                                                    //  output,  width = 245,           .data
		...
		.src3_data          (cmd_demux_001_src3_data),                                                    //  output,  width = 245,           .data
	...
	qsys_top_altera_merlin_multiplexer_1921_pevtnmy cmd_mux (
		.clk                 (clk_100_out_clk_clk),                                                        //   input,    width = 1,       clk.clk
		.reset               (agilex_hps_h2f_axi_master_translator_clk_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
		...
		.sink0_data          (cmd_demux_src0_data),                                                        //   input,  width = 245,          .data
		...
		.sink1_data          (cmd_demux_001_src0_data),                                                    //   input,  width = 245,          .data
	...
	qsys_top_altera_merlin_multiplexer_1921_pevtnmy cmd_mux_001 (
		.clk                 (clk_100_out_clk_clk),                                                        //   input,    width = 1,       clk.clk
		.reset               (agilex_hps_h2f_axi_master_translator_clk_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
		.src_ready           (cmd_mux_001_src_ready),                                                      //   input,    width = 1,       src.ready
		.src_valid           (cmd_mux_001_src_valid),                                                      //  output,    width = 1,          .valid
		.src_data            (cmd_mux_001_src_data),                                                       //  output,  width = 245,          .data
		...
		.sink0_data          (cmd_demux_src1_data),                                                        //   input,  width = 245,          .data
		...
		.sink1_data          (cmd_demux_001_src1_data),                                                    //   input,  width = 245,          .data
	...
	qsys_top_altera_merlin_multiplexer_1921_pevtnmy cmd_mux_002 (
		.clk                 (clk_100_out_clk_clk),                                                        //   input,    width = 1,       clk.clk
		.reset               (agilex_hps_h2f_axi_master_translator_clk_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
		.src_ready           (cmd_mux_002_src_ready),                                                      //   input,    width = 1,       src.ready
		.src_valid           (cmd_mux_002_src_valid),                                                      //  output,    width = 1,          .valid
		.src_data            (cmd_mux_002_src_data),                                                       //  output,  width = 245,          .data
		...
		.sink0_data          (cmd_demux_src2_data),                                                        //   input,  width = 245,          .data
		...
		.sink1_data          (cmd_demux_001_src2_data),                                                    //   input,  width = 245,          .data
	...
	qsys_top_altera_merlin_multiplexer_1921_pevtnmy cmd_mux_003 (
		.clk                 (clk_100_out_clk_clk),                                                        //   input,    width = 1,       clk.clk
		.reset               (agilex_hps_h2f_axi_master_translator_clk_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
		.src_ready           (cmd_mux_003_src_ready),                                                      //   input,    width = 1,       src.ready
		.src_valid           (cmd_mux_003_src_valid),                                                      //  output,    width = 1,          .valid
		.src_data            (cmd_mux_003_src_data),                                                       //  output,  width = 245,          .data
		...
		.sink0_data          (cmd_demux_src3_data),                                                        //   input,  width = 245,          .data
		...
		.sink1_data          (cmd_demux_001_src3_data),                                                    //   input,  width = 245,          .data
	...
	qsys_top_altera_merlin_demultiplexer_1921_2bzlwda rsp_demux (
		.clk                (clk_100_out_clk_clk),                                                        //   input,    width = 1,       clk.clk
		.reset              (agilex_hps_h2f_axi_master_translator_clk_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
		.sink_ready         (ram_controller_1_csr_rsp_width_adapter_src_ready),                           //  output,    width = 1,      sink.ready
		.sink_channel       (ram_controller_1_csr_rsp_width_adapter_src_channel),                         //   input,    width = 4,          .channel
		.sink_data          (ram_controller_1_csr_rsp_width_adapter_src_data),                            //   input,  width = 245,          .data
	...
	qsys_top_altera_merlin_demultiplexer_1921_2bzlwda rsp_demux_001 (
		.clk                (clk_100_out_clk_clk),                                                        //   input,    width = 1,       clk.clk
		.reset              (agilex_hps_h2f_axi_master_translator_clk_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
		.sink_ready         (prbs_generator_1_csr_rsp_width_adapter_src_ready),                           //  output,    width = 1,      sink.ready
		.sink_channel       (prbs_generator_1_csr_rsp_width_adapter_src_channel),                         //   input,    width = 4,          .channel
		.sink_data          (prbs_generator_1_csr_rsp_width_adapter_src_data),                            //   input,  width = 245,          .data
		...
		.src0_data          (rsp_demux_001_src0_data),                                                    //  output,  width = 245,          .data
		...
		.src1_data          (rsp_demux_001_src1_data),                                                    //  output,  width = 245,          .data
	...
	qsys_top_altera_merlin_demultiplexer_1921_2bzlwda rsp_demux_002 (
		.clk                (clk_100_out_clk_clk),                                                        //   input,    width = 1,       clk.clk
		.reset              (agilex_hps_h2f_axi_master_translator_clk_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
		.sink_ready         (pio_0_s1_rsp_width_adapter_src_ready),                                       //  output,    width = 1,      sink.ready
		.sink_channel       (pio_0_s1_rsp_width_adapter_src_channel),                                     //   input,    width = 4,          .channel
		.sink_data          (pio_0_s1_rsp_width_adapter_src_data),                                        //   input,  width = 245,          .data
		...
		.src0_data          (rsp_demux_002_src0_data),                                                    //  output,  width = 245,          .data
		...
		.src1_data          (rsp_demux_002_src1_data),                                                    //  output,  width = 245,          .data
	...
	qsys_top_altera_merlin_demultiplexer_1921_2bzlwda rsp_demux_003 (
		.clk                (clk_100_out_clk_clk),                                                        //   input,    width = 1,       clk.clk
		.reset              (agilex_hps_h2f_axi_master_translator_clk_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
		.sink_ready         (onchip_memory2_0_s1_rsp_width_adapter_src_ready),                            //  output,    width = 1,      sink.ready
		.sink_channel       (onchip_memory2_0_s1_rsp_width_adapter_src_channel),                          //   input,    width = 4,          .channel
		.sink_data          (onchip_memory2_0_s1_rsp_width_adapter_src_data),                             //   input,  width = 245,          .data
		...
		.src0_data          (rsp_demux_003_src0_data),                                                    //  output,  width = 245,          .data
		...
		.src1_data          (rsp_demux_003_src1_data),                                                    //  output,  width = 245,          .data
	...
	qsys_top_altera_merlin_multiplexer_1921_cwl6qey rsp_mux (
		.clk                 (clk_100_out_clk_clk),                                                        //   input,    width = 1,       clk.clk
		.reset               (agilex_hps_h2f_axi_master_translator_clk_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
		.src_ready           (rsp_mux_src_ready),                                                          //   input,    width = 1,       src.ready
		.src_valid           (rsp_mux_src_valid),                                                          //  output,    width = 1,          .valid
		.src_data            (rsp_mux_src_data),                                                           //  output,  width = 245,          .data
		...
		.sink0_data          (rsp_demux_src0_data),                                                        //   input,  width = 245,          .data
		...
		.sink1_data          (rsp_demux_001_src0_data),                                                    //   input,  width = 245,          .data
		...
		.sink2_data          (rsp_demux_002_src0_data),                                                    //   input,  width = 245,          .data
		...
		.sink3_data          (rsp_demux_003_src0_data),                                                    //   input,  width = 245,          .data
	...
	qsys_top_altera_merlin_multiplexer_1921_cwl6qey rsp_mux_001 (
		.clk                 (clk_100_out_clk_clk),                                                        //   input,    width = 1,       clk.clk
		.reset               (agilex_hps_h2f_axi_master_translator_clk_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
		...
		.sink0_data          (rsp_demux_src1_data),                                                        //   input,  width = 245,          .data
		...
		.sink1_data          (rsp_demux_001_src1_data),                                                    //   input,  width = 245,          .data
		...
		.sink2_data          (rsp_demux_002_src1_data),                                                    //   input,  width = 245,          .data
		...
		.sink3_data          (rsp_demux_003_src1_data),                                                    //   input,  width = 245,          .data
	...
	qsys_top_altera_merlin_width_adapter_1920_v4zrbhq #(
		...
		.in_data              (router_002_src_data),                                                        //   input,  width = 137,          .data
		.out_endofpacket      (ram_controller_1_csr_rsp_width_adapter_src_endofpacket),                     //  output,    width = 1,       src.endofpacket
		.out_data             (ram_controller_1_csr_rsp_width_adapter_src_data),                            //  output,  width = 245,          .data
		.out_channel          (ram_controller_1_csr_rsp_width_adapter_src_channel),                         //  output,    width = 4,          .channel
	...
	qsys_top_altera_merlin_width_adapter_1920_v4zrbhq #(
		...
		.in_data              (router_003_src_data),                                                        //   input,  width = 137,          .data
		.out_endofpacket      (prbs_generator_1_csr_rsp_width_adapter_src_endofpacket),                     //  output,    width = 1,       src.endofpacket
		.out_data             (prbs_generator_1_csr_rsp_width_adapter_src_data),                            //  output,  width = 245,          .data
		.out_channel          (prbs_generator_1_csr_rsp_width_adapter_src_channel),                         //  output,    width = 4,          .channel
	...
	qsys_top_altera_merlin_width_adapter_1920_v4zrbhq #(
		...
		.in_data              (router_004_src_data),                                                        //   input,  width = 137,          .data
		.out_endofpacket      (pio_0_s1_rsp_width_adapter_src_endofpacket),                                 //  output,    width = 1,       src.endofpacket
		.out_data             (pio_0_s1_rsp_width_adapter_src_data),                                        //  output,  width = 245,          .data
		.out_channel          (pio_0_s1_rsp_width_adapter_src_channel),                                     //  output,    width = 4,          .channel
	...
	qsys_top_altera_merlin_width_adapter_1920_v4zrbhq #(
		...
		.in_data              (router_005_src_data),                                                        //   input,  width = 137,          .data
		.out_endofpacket      (onchip_memory2_0_s1_rsp_width_adapter_src_endofpacket),                      //  output,    width = 1,       src.endofpacket
		.out_data             (onchip_memory2_0_s1_rsp_width_adapter_src_data),                             //  output,  width = 245,          .data
		.out_channel          (onchip_memory2_0_s1_rsp_width_adapter_src_channel),                          //  output,    width = 4,          .channel
	...
	qsys_top_altera_merlin_width_adapter_1920_b4iaudq #(
		...
		.in_data              (cmd_mux_src_data),                                                           //   input,  width = 245,          .data
		.out_endofpacket      (ram_controller_1_csr_cmd_width_adapter_src_endofpacket),                     //  output,    width = 1,       src.endofpacket
		.out_data             (ram_controller_1_csr_cmd_width_adapter_src_data),                            //  output,  width = 137,          .data
		.out_channel          (ram_controller_1_csr_cmd_width_adapter_src_channel),                         //  output,    width = 4,          .channel
	...
	qsys_top_altera_merlin_width_adapter_1920_b4iaudq #(
		...
		.in_data              (cmd_mux_001_src_data),                                                       //   input,  width = 245,          .data
		.out_endofpacket      (prbs_generator_1_csr_cmd_width_adapter_src_endofpacket),                     //  output,    width = 1,       src.endofpacket
		.out_data             (prbs_generator_1_csr_cmd_width_adapter_src_data),                            //  output,  width = 137,          .data
		.out_channel          (prbs_generator_1_csr_cmd_width_adapter_src_channel),                         //  output,    width = 4,          .channel
	...
	qsys_top_altera_merlin_width_adapter_1920_b4iaudq #(
		...
		.in_data              (cmd_mux_002_src_data),                                                       //   input,  width = 245,          .data
		.out_endofpacket      (pio_0_s1_cmd_width_adapter_src_endofpacket),                                 //  output,    width = 1,       src.endofpacket
		.out_data             (pio_0_s1_cmd_width_adapter_src_data),                                        //  output,  width = 137,          .data
		.out_channel          (pio_0_s1_cmd_width_adapter_src_channel),                                     //  output,    width = 4,          .channel
	...
	qsys_top_altera_merlin_width_adapter_1920_b4iaudq #(
		...
		.in_data              (cmd_mux_003_src_data),                                                       //   input,  width = 245,          .data
		.out_endofpacket      (onchip_memory2_0_s1_cmd_width_adapter_src_endofpacket),                      //  output,    width = 1,       src.endofpacket
		.out_data             (onchip_memory2_0_s1_cmd_width_adapter_src_data),                             //  output,  width = 137,          .data
		.out_channel          (onchip_memory2_0_s1_cmd_width_adapter_src_channel),                          //  output,    width = 4,          .channel
