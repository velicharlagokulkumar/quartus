// qsys_top_altera_mm_interconnect_1920_4sn7oti.v
...
`timescale 1 ps / 1 ps
module qsys_top_altera_mm_interconnect_1920_4sn7oti (
	...
	wire  [135:0] ram_controller_1_csr_agent_rf_source_data;                  // ram_controller_1_csr_agent:rf_source_data -> ram_controller_1_csr_agent_rsp_fifo:in_data
	...
	wire  [135:0] ram_controller_1_csr_agent_rsp_fifo_out_data;               // ram_controller_1_csr_agent_rsp_fifo:out_data -> ram_controller_1_csr_agent:rf_sink_data
	...
	wire  [134:0] ram_controller_1_csr_agent_rp_data;                         // ram_controller_1_csr_agent:rp_data -> router_002:sink_data
	...
	wire  [134:0] pio_0_s1_agent_rp_data;                                     // pio_0_s1_agent:rp_data -> router_003:sink_data
	...
	wire  [242:0] agilex_hps_h2f_axi_master_wr_limiter_cmd_src_data;          // agilex_hps_h2f_axi_master_wr_limiter:cmd_src_data -> cmd_demux:sink_data
	...
	wire    [1:0] agilex_hps_h2f_axi_master_wr_limiter_cmd_src_channel;       // agilex_hps_h2f_axi_master_wr_limiter:cmd_src_channel -> cmd_demux:sink_channel
	...
	wire  [242:0] rsp_mux_src_data;                                           // rsp_mux:src_data -> agilex_hps_h2f_axi_master_wr_limiter:rsp_sink_data
	wire          rsp_mux_src_ready;                                          // agilex_hps_h2f_axi_master_wr_limiter:rsp_sink_ready -> rsp_mux:src_ready
	wire    [1:0] rsp_mux_src_channel;                                        // rsp_mux:src_channel -> agilex_hps_h2f_axi_master_wr_limiter:rsp_sink_channel
	...
	wire  [242:0] agilex_hps_h2f_axi_master_rd_limiter_cmd_src_data;          // agilex_hps_h2f_axi_master_rd_limiter:cmd_src_data -> cmd_demux_001:sink_data
	...
	wire    [1:0] agilex_hps_h2f_axi_master_rd_limiter_cmd_src_channel;       // agilex_hps_h2f_axi_master_rd_limiter:cmd_src_channel -> cmd_demux_001:sink_channel
	...
	wire  [242:0] rsp_mux_001_src_data;                                       // rsp_mux_001:src_data -> agilex_hps_h2f_axi_master_rd_limiter:rsp_sink_data
	wire          rsp_mux_001_src_ready;                                      // agilex_hps_h2f_axi_master_rd_limiter:rsp_sink_ready -> rsp_mux_001:src_ready
	wire    [1:0] rsp_mux_001_src_channel;                                    // rsp_mux_001:src_channel -> agilex_hps_h2f_axi_master_rd_limiter:rsp_sink_channel
	...
	wire  [134:0] ram_controller_1_csr_burst_adapter_source0_data;            // ram_controller_1_csr_burst_adapter:source0_data -> ram_controller_1_csr_agent:cp_data
	...
	wire    [1:0] ram_controller_1_csr_burst_adapter_source0_channel;         // ram_controller_1_csr_burst_adapter:source0_channel -> ram_controller_1_csr_agent:cp_channel
	...
	wire  [242:0] cmd_demux_src1_data;                                        // cmd_demux:src1_data -> cmd_mux_001:sink0_data
	...
	wire  [242:0] cmd_demux_001_src1_data;                                    // cmd_demux_001:src1_data -> cmd_mux_001:sink1_data
	...
	wire  [242:0] rsp_demux_001_src0_data;                                    // rsp_demux_001:src0_data -> rsp_mux:sink1_data
	...
	wire  [242:0] rsp_demux_001_src1_data;                                    // rsp_demux_001:src1_data -> rsp_mux_001:sink1_data
	...
	wire  [134:0] router_002_src_data;                                        // router_002:src_data -> ram_controller_1_csr_rsp_width_adapter:in_data
	wire          router_002_src_ready;                                       // ram_controller_1_csr_rsp_width_adapter:in_ready -> router_002:src_ready
	wire    [1:0] router_002_src_channel;                                     // router_002:src_channel -> ram_controller_1_csr_rsp_width_adapter:in_channel
	...
	wire  [242:0] ram_controller_1_csr_rsp_width_adapter_src_data;            // ram_controller_1_csr_rsp_width_adapter:out_data -> rsp_demux:sink_data
	...
	wire    [1:0] ram_controller_1_csr_rsp_width_adapter_src_channel;         // ram_controller_1_csr_rsp_width_adapter:out_channel -> rsp_demux:sink_channel
	...
	wire  [242:0] cmd_mux_src_data;                                           // cmd_mux:src_data -> ram_controller_1_csr_cmd_width_adapter:in_data
	wire          cmd_mux_src_ready;                                          // ram_controller_1_csr_cmd_width_adapter:in_ready -> cmd_mux:src_ready
	wire    [1:0] cmd_mux_src_channel;                                        // cmd_mux:src_channel -> ram_controller_1_csr_cmd_width_adapter:in_channel
	...
	wire  [134:0] ram_controller_1_csr_cmd_width_adapter_src_data;            // ram_controller_1_csr_cmd_width_adapter:out_data -> ram_controller_1_csr_burst_adapter:sink0_data
	...
	wire    [1:0] ram_controller_1_csr_cmd_width_adapter_src_channel;         // ram_controller_1_csr_cmd_width_adapter:out_channel -> ram_controller_1_csr_burst_adapter:sink0_channel
	...
	wire    [1:0] agilex_hps_h2f_axi_master_wr_limiter_cmd_valid_data;        // agilex_hps_h2f_axi_master_wr_limiter:cmd_src_valid -> cmd_demux:sink_valid
	wire    [1:0] agilex_hps_h2f_axi_master_rd_limiter_cmd_valid_data;        // agilex_hps_h2f_axi_master_rd_limiter:cmd_src_valid -> cmd_demux_001:sink_valid
	...
	qsys_top_altera_merlin_slave_agent_191_ncfkfri #(
		...
		.rp_data                 (ram_controller_1_csr_agent_rp_data),                                         //  output,  width = 135,                .data
		...
		.cp_data                 (ram_controller_1_csr_burst_adapter_source0_data),                            //   input,  width = 135,                .data
		...
		.cp_channel              (ram_controller_1_csr_burst_adapter_source0_channel),                         //   input,    width = 2,                .channel
		...
		.rf_sink_data            (ram_controller_1_csr_agent_rsp_fifo_out_data),                               //   input,  width = 136,                .data
		...
		.rf_source_data          (ram_controller_1_csr_agent_rf_source_data),                                  //  output,  width = 136,                .data
	...
	qsys_top_altera_avalon_sc_fifo_1931_vhmcgqy #(
		...
		.in_data           (ram_controller_1_csr_agent_rf_source_data),             //   input,  width = 136,        in.data
		...
		.out_data          (ram_controller_1_csr_agent_rsp_fifo_out_data),          //  output,  width = 136,       out.data
	...
	qsys_top_altera_merlin_router_1921_pbr2qdq router (
	...
	qsys_top_altera_merlin_router_1921_pbr2qdq router_001 (
	...
	qsys_top_altera_merlin_router_1921_pov5cdi router_002 (
		...
		.sink_data          (ram_controller_1_csr_agent_rp_data),                                         //   input,  width = 135,          .data
	...
	qsys_top_altera_merlin_traffic_limiter_191_6blplji #(
		...
		.rsp_sink_data          (rsp_mux_src_data),                                                           //   input,  width = 243,          .data
		...
		.cmd_src_valid          (agilex_hps_h2f_axi_master_wr_limiter_cmd_valid_data)                         //  output,    width = 2, cmd_valid.data
	);
	...
	qsys_top_altera_merlin_traffic_limiter_191_6blplji #(
		...
		.rsp_sink_data          (rsp_mux_001_src_data),                                                       //   input,  width = 243,          .data
		...
		.cmd_src_valid          (agilex_hps_h2f_axi_master_rd_limiter_cmd_valid_data)                         //  output,    width = 2, cmd_valid.data
	);
	...
	qsys_top_altera_merlin_burst_adapter_1923_dxqle7a #(
		...
		.sink0_data            (ram_controller_1_csr_cmd_width_adapter_src_data),                            //   input,  width = 135,          .data
		.sink0_channel         (ram_controller_1_csr_cmd_width_adapter_src_channel),                         //   input,    width = 2,          .channel
		...
		.source0_data          (ram_controller_1_csr_burst_adapter_source0_data),                            //  output,  width = 135,          .data
		.source0_channel       (ram_controller_1_csr_burst_adapter_source0_channel),                         //  output,    width = 2,          .channel
	...
	qsys_top_altera_merlin_demultiplexer_1921_lu7o6ua cmd_demux (
		.clk                (clk_100_out_clk_clk),                                                        //   input,    width = 1,        clk.clk
		.reset              (agilex_hps_h2f_axi_master_translator_clk_reset_reset_bridge_in_reset_reset), //   input,    width = 1,  clk_reset.reset
		.sink_ready         (agilex_hps_h2f_axi_master_wr_limiter_cmd_src_ready),                         //  output,    width = 1,       sink.ready
		.sink_channel       (agilex_hps_h2f_axi_master_wr_limiter_cmd_src_channel),                       //   input,    width = 2,           .channel
		.sink_data          (agilex_hps_h2f_axi_master_wr_limiter_cmd_src_data),                          //   input,  width = 243,           .data
		...
		.sink_valid         (agilex_hps_h2f_axi_master_wr_limiter_cmd_valid_data),                        //   input,    width = 2, sink_valid.data
	...
	qsys_top_altera_merlin_demultiplexer_1921_lu7o6ua cmd_demux_001 (
		.clk                (clk_100_out_clk_clk),                                                        //   input,    width = 1,        clk.clk
		.reset              (agilex_hps_h2f_axi_master_translator_clk_reset_reset_bridge_in_reset_reset), //   input,    width = 1,  clk_reset.reset
		.sink_ready         (agilex_hps_h2f_axi_master_rd_limiter_cmd_src_ready),                         //  output,    width = 1,       sink.ready
		.sink_channel       (agilex_hps_h2f_axi_master_rd_limiter_cmd_src_channel),                       //   input,    width = 2,           .channel
		.sink_data          (agilex_hps_h2f_axi_master_rd_limiter_cmd_src_data),                          //   input,  width = 243,           .data
		...
		.sink_valid         (agilex_hps_h2f_axi_master_rd_limiter_cmd_valid_data),                        //   input,    width = 2, sink_valid.data
	...
	qsys_top_altera_merlin_multiplexer_1921_mo5nwri cmd_mux_001 (
		...
		.sink0_data          (cmd_demux_src1_data),                                                        //   input,  width = 243,          .data
		...
		.sink1_data          (cmd_demux_001_src1_data),                                                    //   input,  width = 243,          .data
	...
	qsys_top_altera_merlin_demultiplexer_1921_or3nb5y rsp_demux (
		...
		.sink_channel       (ram_controller_1_csr_rsp_width_adapter_src_channel),                         //   input,    width = 2,          .channel
		.sink_data          (ram_controller_1_csr_rsp_width_adapter_src_data),                            //   input,  width = 243,          .data
	...
	qsys_top_altera_merlin_multiplexer_1921_ph45pay rsp_mux (
		...
		.sink1_data          (rsp_demux_001_src0_data),                                                    //   input,  width = 243,          .data
	...
	qsys_top_altera_merlin_multiplexer_1921_ph45pay rsp_mux_001 (
		...
		.sink1_data          (rsp_demux_001_src1_data),                                                    //   input,  width = 243,          .data
	...
	qsys_top_altera_merlin_width_adapter_1920_o6ymenq #(
		...
		.out_data             (ram_controller_1_csr_rsp_width_adapter_src_data),                            //  output,  width = 243,          .data
		.out_channel          (ram_controller_1_csr_rsp_width_adapter_src_channel),                         //  output,    width = 2,          .channel
	...
	qsys_top_altera_merlin_width_adapter_1920_b5xd2ga #(
		...
		.out_data             (ram_controller_1_csr_cmd_width_adapter_src_data),                            //  output,  width = 135,          .data
		.out_channel          (ram_controller_1_csr_cmd_width_adapter_src_channel),                         //  output,    width = 2,          .channel
