// qsys_top_altera_mm_interconnect_1920_wejmgra.v
...
`timescale 1 ps / 1 ps
module qsys_top_altera_mm_interconnect_1920_wejmgra (
	...
	wire  [131:0] ram_controller_1_csr_agent_rf_source_data;                  // ram_controller_1_csr_agent:rf_source_data -> ram_controller_1_csr_agent_rsp_fifo:in_data
	...
	wire  [131:0] ram_controller_1_csr_agent_rsp_fifo_out_data;               // ram_controller_1_csr_agent_rsp_fifo:out_data -> ram_controller_1_csr_agent:rf_sink_data
	...
	wire  [130:0] agilex_hps_h2f_axi_master_agent_write_cp_data;              // agilex_hps_h2f_axi_master_agent:write_cp_data -> router:sink_data
	...
	wire  [130:0] agilex_hps_h2f_axi_master_agent_read_cp_data;               // agilex_hps_h2f_axi_master_agent:read_cp_data -> router_001:sink_data
	...
	wire  [130:0] ram_controller_1_csr_agent_rp_data;                         // ram_controller_1_csr_agent:rp_data -> router_002:sink_data
	...
	wire  [130:0] router_002_src_data;                                        // router_002:src_data -> rsp_demux:sink_data
	...
	wire  [130:0] pio_0_s1_agent_rp_data;                                     // pio_0_s1_agent:rp_data -> router_003:sink_data
	...
	wire  [130:0] router_003_src_data;                                        // router_003:src_data -> rsp_demux_001:sink_data
	...
	wire  [130:0] router_src_data;                                            // router:src_data -> agilex_hps_h2f_axi_master_wr_limiter:cmd_sink_data
	...
	wire  [130:0] agilex_hps_h2f_axi_master_wr_limiter_cmd_src_data;          // agilex_hps_h2f_axi_master_wr_limiter:cmd_src_data -> cmd_demux:sink_data
	...
	wire  [130:0] rsp_mux_src_data;                                           // rsp_mux:src_data -> agilex_hps_h2f_axi_master_wr_limiter:rsp_sink_data
	...
	wire  [130:0] agilex_hps_h2f_axi_master_wr_limiter_rsp_src_data;          // agilex_hps_h2f_axi_master_wr_limiter:rsp_src_data -> agilex_hps_h2f_axi_master_agent:write_rp_data
	...
	wire  [130:0] router_001_src_data;                                        // router_001:src_data -> agilex_hps_h2f_axi_master_rd_limiter:cmd_sink_data
	...
	wire  [130:0] agilex_hps_h2f_axi_master_rd_limiter_cmd_src_data;          // agilex_hps_h2f_axi_master_rd_limiter:cmd_src_data -> cmd_demux_001:sink_data
	...
	wire  [130:0] rsp_mux_001_src_data;                                       // rsp_mux_001:src_data -> agilex_hps_h2f_axi_master_rd_limiter:rsp_sink_data
	...
	wire  [130:0] agilex_hps_h2f_axi_master_rd_limiter_rsp_src_data;          // agilex_hps_h2f_axi_master_rd_limiter:rsp_src_data -> agilex_hps_h2f_axi_master_agent:read_rp_data
	...
	wire  [130:0] cmd_mux_src_data;                                           // cmd_mux:src_data -> ram_controller_1_csr_burst_adapter:sink0_data
	wire          cmd_mux_src_ready;                                          // ram_controller_1_csr_burst_adapter:sink0_ready -> cmd_mux:src_ready
	wire    [1:0] cmd_mux_src_channel;                                        // cmd_mux:src_channel -> ram_controller_1_csr_burst_adapter:sink0_channel
	...
	wire  [130:0] ram_controller_1_csr_burst_adapter_source0_data;            // ram_controller_1_csr_burst_adapter:source0_data -> ram_controller_1_csr_agent:cp_data
	...
	wire  [130:0] cmd_mux_001_src_data;                                       // cmd_mux_001:src_data -> pio_0_s1_burst_adapter:sink0_data
	...
	qsys_top_altera_merlin_axi_master_ni_1941_dfsyzvi #(
		...
		.write_cp_data          (agilex_hps_h2f_axi_master_agent_write_cp_data),                               //  output,  width = 131,                 .data
		...
		.write_rp_data          (agilex_hps_h2f_axi_master_wr_limiter_rsp_src_data),                           //   input,  width = 131,                 .data
		...
		.read_cp_data           (agilex_hps_h2f_axi_master_agent_read_cp_data),                                //  output,  width = 131,                 .data
		...
		.read_rp_data           (agilex_hps_h2f_axi_master_rd_limiter_rsp_src_data),                           //   input,  width = 131,                 .data
	...
	qsys_top_altera_merlin_slave_agent_191_ncfkfri #(
		...
		.rp_data                 (ram_controller_1_csr_agent_rp_data),                                         //  output,  width = 131,                .data
		...
		.cp_data                 (ram_controller_1_csr_burst_adapter_source0_data),                            //   input,  width = 131,                .data
		...
		.rf_sink_data            (ram_controller_1_csr_agent_rsp_fifo_out_data),                               //   input,  width = 132,                .data
		...
		.rf_source_data          (ram_controller_1_csr_agent_rf_source_data),                                  //  output,  width = 132,                .data
	...
	qsys_top_altera_avalon_sc_fifo_1931_vhmcgqy #(
		...
		.in_data           (ram_controller_1_csr_agent_rf_source_data),             //   input,  width = 132,        in.data
		...
		.out_data          (ram_controller_1_csr_agent_rsp_fifo_out_data),          //  output,  width = 132,       out.data
	...
	qsys_top_altera_merlin_slave_agent_191_ncfkfri #(
		...
		.rp_data                 (pio_0_s1_agent_rp_data),                                                     //  output,  width = 131,                .data
		...
		.cp_data                 (pio_0_s1_burst_adapter_source0_data),                                        //   input,  width = 131,                .data
		...
		.rf_sink_data            (pio_0_s1_agent_rsp_fifo_out_data),                                           //   input,  width = 132,                .data
		...
		.rf_source_data          (pio_0_s1_agent_rf_source_data),                                              //  output,  width = 132,                .data
	...
	qsys_top_altera_avalon_sc_fifo_1931_vhmcgqy #(
		...
		.clk               (clk_100_out_clk_clk),                                  //   input,    width = 1,       clk.clk
		.reset             (agilex_hps_h2f_axi_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
		.in_data           (pio_0_s1_agent_rf_source_data),                        //   input,  width = 132,        in.data
		...
		.out_data          (pio_0_s1_agent_rsp_fifo_out_data),                     //  output,  width = 132,       out.data
	...
	qsys_top_altera_merlin_router_1921_dbcm5ey router (
		...
		.sink_data          (agilex_hps_h2f_axi_master_agent_write_cp_data),                              //   input,  width = 131,          .data
	...
	qsys_top_altera_merlin_router_1921_dbcm5ey router_001 (
		...
		.sink_data          (agilex_hps_h2f_axi_master_agent_read_cp_data),                               //   input,  width = 131,          .data
	...
	qsys_top_altera_merlin_router_1921_gojpxbi router_002 (
		...
		.sink_data          (ram_controller_1_csr_agent_rp_data),                                         //   input,  width = 131,          .data
	...
	qsys_top_altera_merlin_traffic_limiter_191_6blplji #(
		...
		.cmd_src_data           (agilex_hps_h2f_axi_master_wr_limiter_cmd_src_data),                          //  output,  width = 131,          .data
		...
		.rsp_sink_data          (rsp_mux_src_data),                                                           //   input,  width = 131,          .data
		...
		.rsp_src_data           (agilex_hps_h2f_axi_master_wr_limiter_rsp_src_data),                          //  output,  width = 131,          .data
	...
	qsys_top_altera_merlin_traffic_limiter_191_6blplji #(
		...
		.cmd_src_data           (agilex_hps_h2f_axi_master_rd_limiter_cmd_src_data),                          //  output,  width = 131,          .data
		...
		.rsp_src_data           (agilex_hps_h2f_axi_master_rd_limiter_rsp_src_data),                          //  output,  width = 131,          .data
	...
	qsys_top_altera_merlin_burst_adapter_1923_au4lvyi #(
		.PKT_ADDR_H                (67),
		.PKT_ADDR_L                (36),
		.PKT_BEGIN_BURST           (99),
		.PKT_BYTE_CNT_H            (84),
		...
		.source0_data          (ram_controller_1_csr_burst_adapter_source0_data),                            //  output,  width = 131,          .data
	...
	qsys_top_altera_merlin_burst_adapter_1923_au4lvyi #(
		...
		.sink0_channel         (cmd_mux_001_src_channel),                                                    //   input,    width = 2,          .channel
		...
		.source0_data          (pio_0_s1_burst_adapter_source0_data),                                        //  output,  width = 131,          .data
	...
	qsys_top_altera_merlin_demultiplexer_1921_qapnatq cmd_demux (
		.clk                (clk_100_out_clk_clk),                                                        //   input,    width = 1,        clk.clk
		.reset              (agilex_hps_h2f_axi_master_translator_clk_reset_reset_bridge_in_reset_reset), //   input,    width = 1,  clk_reset.reset
		...
		.sink_data          (agilex_hps_h2f_axi_master_wr_limiter_cmd_src_data),                          //   input,  width = 131,           .data
	...
	qsys_top_altera_merlin_demultiplexer_1921_qapnatq cmd_demux_001 (
		.clk                (clk_100_out_clk_clk),                                                        //   input,    width = 1,        clk.clk
		.reset              (agilex_hps_h2f_axi_master_translator_clk_reset_reset_bridge_in_reset_reset), //   input,    width = 1,  clk_reset.reset
		...
		.sink_data          (agilex_hps_h2f_axi_master_rd_limiter_cmd_src_data),                          //   input,  width = 131,           .data
	...
	qsys_top_altera_merlin_multiplexer_1921_l3h6k3a cmd_mux (
		.clk                 (clk_100_out_clk_clk),                                                        //   input,    width = 1,       clk.clk
		.reset               (agilex_hps_h2f_axi_master_translator_clk_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	qsys_top_altera_merlin_multiplexer_1921_l3h6k3a cmd_mux_001 (
		.clk                 (clk_100_out_clk_clk),                                                        //   input,    width = 1,       clk.clk
		.reset               (agilex_hps_h2f_axi_master_translator_clk_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
		...
		.sink0_data          (cmd_demux_src1_data),                                                        //   input,  width = 131,          .data
		...
		.sink1_data          (cmd_demux_001_src1_data),                                                    //   input,  width = 131,          .data
	...
	qsys_top_altera_merlin_demultiplexer_1921_zjcvwny rsp_demux (
		.clk                (clk_100_out_clk_clk),                                                        //   input,    width = 1,       clk.clk
		.reset              (agilex_hps_h2f_axi_master_translator_clk_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	qsys_top_altera_merlin_demultiplexer_1921_zjcvwny rsp_demux_001 (
		.clk                (clk_100_out_clk_clk),                                                        //   input,    width = 1,       clk.clk
		.reset              (agilex_hps_h2f_axi_master_translator_clk_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
		...
		.src1_data          (rsp_demux_001_src1_data),                                                    //  output,  width = 131,          .data
	...
	qsys_top_altera_merlin_multiplexer_1921_csqaexi rsp_mux (
		.clk                 (clk_100_out_clk_clk),                                                        //   input,    width = 1,       clk.clk
		.reset               (agilex_hps_h2f_axi_master_translator_clk_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
		...
		.sink1_data          (rsp_demux_001_src0_data),                                                    //   input,  width = 131,          .data
	...
	qsys_top_altera_merlin_multiplexer_1921_csqaexi rsp_mux_001 (
		.clk                 (clk_100_out_clk_clk),                                                        //   input,    width = 1,       clk.clk
		.reset               (agilex_hps_h2f_axi_master_translator_clk_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
		...
		.sink1_data          (rsp_demux_001_src1_data),                                                    //   input,  width = 131,          .data
