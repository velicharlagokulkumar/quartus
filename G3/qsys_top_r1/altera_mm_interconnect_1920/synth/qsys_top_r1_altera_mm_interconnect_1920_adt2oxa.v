// qsys_top_r1_altera_mm_interconnect_1920_adt2oxa.v
...
`timescale 1 ps / 1 ps
module qsys_top_r1_altera_mm_interconnect_1920_adt2oxa (
	...
	wire  [157:0] rsp_mux_src_data;                                                                  // rsp_mux:src_data -> pattern_writer_1_avalon_master_agent:rp_data
	...
	wire  [157:0] pattern_writer_1_avalon_master_agent_cp_data;                                      // pattern_writer_1_avalon_master_agent:cp_data -> router:sink_data
	...
	wire  [157:0] router_src_data;                                                                   // router:src_data -> cmd_demux:sink_data
	...
	qsys_top_r1_altera_merlin_axi_translator_1921_uetfduq #(
		...
		.aresetn     (~pattern_writer_1_avalon_master_translator_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset_n
	...
	qsys_top_r1_altera_merlin_master_agent_191_mpbm6tq #(
		...
		.cp_data               (pattern_writer_1_avalon_master_agent_cp_data),                                      //  output,  width = 158,          .data
		...
		.rp_data               (rsp_mux_src_data),                                                                  //   input,  width = 158,          .data
	...
	qsys_top_r1_altera_merlin_axi_slave_ni_1941_5ooumii #(
		.PKT_QOS_H                   (673),
		.PKT_QOS_L                   (670),
		.PKT_THREAD_ID_H             (676),
		.PKT_THREAD_ID_L             (676),
	...
	qsys_top_r1_altera_merlin_router_1921_4zbrsli router (
		...
		.sink_data          (pattern_writer_1_avalon_master_agent_cp_data),                                //   input,  width = 158,          .data
	...
	qsys_top_r1_altera_merlin_router_1921_2t7r7zy router_001 (
	...
	qsys_top_r1_altera_merlin_router_1921_2t7r7zy router_002 (
	...
	qsys_top_r1_altera_merlin_demultiplexer_1921_pcump4i cmd_demux (
		.clk                (clk_100_out_clk_clk),                                                         //   input,    width = 1,       clk.clk
		.reset              (pattern_writer_1_avalon_master_translator_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
		.sink_ready         (router_src_ready),                                                            //  output,    width = 1,      sink.ready
		.sink_channel       (router_src_channel),                                                          //   input,    width = 2,          .channel
		.sink_data          (router_src_data),                                                             //   input,  width = 158,          .data
	...
	qsys_top_r1_altera_merlin_multiplexer_1921_fgpooby cmd_mux (
		.clk                 (clk_100_out_clk_clk),                                                         //   input,    width = 1,       clk.clk
		.reset               (pattern_writer_1_avalon_master_translator_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	qsys_top_r1_altera_merlin_multiplexer_1921_fgpooby cmd_mux_001 (
		.clk                 (clk_100_out_clk_clk),                                                         //   input,    width = 1,       clk.clk
		.reset               (pattern_writer_1_avalon_master_translator_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	qsys_top_r1_altera_merlin_demultiplexer_1921_e7g366y rsp_demux (
		.clk                (clk_100_out_clk_clk),                                                         //   input,    width = 1,       clk.clk
		.reset              (pattern_writer_1_avalon_master_translator_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	qsys_top_r1_altera_merlin_demultiplexer_1921_e7g366y rsp_demux_001 (
		.clk                (clk_100_out_clk_clk),                                                         //   input,    width = 1,       clk.clk
		.reset              (pattern_writer_1_avalon_master_translator_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	qsys_top_r1_altera_merlin_multiplexer_1921_5p55ega rsp_mux (
		.clk                 (clk_100_out_clk_clk),                                                         //   input,    width = 1,       clk.clk
		.reset               (pattern_writer_1_avalon_master_translator_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	qsys_top_r1_altera_merlin_width_adapter_1920_vczjhya #(
		.IN_PKT_ADDR_H                 (67),
		.IN_PKT_ADDR_L                 (36),
		.IN_PKT_DATA_H                 (31),
		.IN_PKT_DATA_L                 (0),
	...
	qsys_top_r1_altera_merlin_width_adapter_1920_tlmozpy #(
		.IN_PKT_ADDR_H                 (607),
		.IN_PKT_ADDR_L                 (576),
		.IN_PKT_DATA_H                 (511),
		.IN_PKT_DATA_L                 (0),
