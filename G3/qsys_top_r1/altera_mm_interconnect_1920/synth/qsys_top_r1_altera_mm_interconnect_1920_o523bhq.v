// qsys_top_r1_altera_mm_interconnect_1920_o523bhq.v
...
`timescale 1 ps / 1 ps
module qsys_top_r1_altera_mm_interconnect_1920_o523bhq (
		...
		input  wire [31:0] agilex_hps_h2f_axi_master_wdata,                                            //                                                                     .wdata
		input  wire [3:0]  agilex_hps_h2f_axi_master_wstrb,                                            //                                                                     .wstrb
		...
		output wire [31:0] agilex_hps_h2f_axi_master_rdata,                                            //                                                                     .rdata
	...
	wire    [3:0] agilex_hps_h2f_axi_master_translator_m0_wstrb;              // agilex_hps_h2f_axi_master_translator:m0_wstrb -> agilex_hps_h2f_axi_master_agent:wstrb
	...
	wire   [31:0] agilex_hps_h2f_axi_master_translator_m0_wdata;              // agilex_hps_h2f_axi_master_translator:m0_wdata -> agilex_hps_h2f_axi_master_agent:wdata
	...
	wire   [31:0] agilex_hps_h2f_axi_master_translator_m0_rdata;              // agilex_hps_h2f_axi_master_agent:rdata -> agilex_hps_h2f_axi_master_translator:m0_rdata
	...
	wire  [133:0] ram_controller_1_csr_agent_rf_source_data;                  // ram_controller_1_csr_agent:rf_source_data -> ram_controller_1_csr_agent_rsp_fifo:in_data
	...
	wire  [133:0] ram_controller_1_csr_agent_rsp_fifo_out_data;               // ram_controller_1_csr_agent_rsp_fifo:out_data -> ram_controller_1_csr_agent:rf_sink_data
	...
	wire  [133:0] prbs_generator_1_csr_agent_rf_source_data;                  // prbs_generator_1_csr_agent:rf_source_data -> prbs_generator_1_csr_agent_rsp_fifo:in_data
	...
	wire  [133:0] prbs_generator_1_csr_agent_rsp_fifo_out_data;               // prbs_generator_1_csr_agent_rsp_fifo:out_data -> prbs_generator_1_csr_agent:rf_sink_data
	...
	wire  [133:0] pio_0_s1_agent_rf_source_data;                              // pio_0_s1_agent:rf_source_data -> pio_0_s1_agent_rsp_fifo:in_data
	...
	wire  [133:0] pio_0_s1_agent_rsp_fifo_out_data;                           // pio_0_s1_agent_rsp_fifo:out_data -> pio_0_s1_agent:rf_sink_data
	...
	wire  [132:0] agilex_hps_h2f_axi_master_agent_write_cp_data;              // agilex_hps_h2f_axi_master_agent:write_cp_data -> router:sink_data
	...
	wire  [132:0] agilex_hps_h2f_axi_master_agent_read_cp_data;               // agilex_hps_h2f_axi_master_agent:read_cp_data -> router_001:sink_data
	...
	wire  [132:0] ram_controller_1_csr_agent_rp_data;                         // ram_controller_1_csr_agent:rp_data -> router_002:sink_data
	...
	wire  [132:0] router_002_src_data;                                        // router_002:src_data -> rsp_demux:sink_data
	...
	wire  [132:0] prbs_generator_1_csr_agent_rp_data;                         // prbs_generator_1_csr_agent:rp_data -> router_003:sink_data
	...
	wire  [132:0] router_003_src_data;                                        // router_003:src_data -> rsp_demux_001:sink_data
	...
	wire  [132:0] pio_0_s1_agent_rp_data;                                     // pio_0_s1_agent:rp_data -> router_004:sink_data
	...
	wire  [132:0] router_004_src_data;                                        // router_004:src_data -> rsp_demux_002:sink_data
	...
	wire  [132:0] router_src_data;                                            // router:src_data -> agilex_hps_h2f_axi_master_wr_limiter:cmd_sink_data
	...
	wire  [132:0] agilex_hps_h2f_axi_master_wr_limiter_cmd_src_data;          // agilex_hps_h2f_axi_master_wr_limiter:cmd_src_data -> cmd_demux:sink_data
	...
	wire  [132:0] rsp_mux_src_data;                                           // rsp_mux:src_data -> agilex_hps_h2f_axi_master_wr_limiter:rsp_sink_data
	...
	wire  [132:0] agilex_hps_h2f_axi_master_wr_limiter_rsp_src_data;          // agilex_hps_h2f_axi_master_wr_limiter:rsp_src_data -> agilex_hps_h2f_axi_master_agent:write_rp_data
	...
	wire  [132:0] router_001_src_data;                                        // router_001:src_data -> agilex_hps_h2f_axi_master_rd_limiter:cmd_sink_data
	...
	wire  [132:0] agilex_hps_h2f_axi_master_rd_limiter_cmd_src_data;          // agilex_hps_h2f_axi_master_rd_limiter:cmd_src_data -> cmd_demux_001:sink_data
	...
	wire  [132:0] rsp_mux_001_src_data;                                       // rsp_mux_001:src_data -> agilex_hps_h2f_axi_master_rd_limiter:rsp_sink_data
	...
	wire  [132:0] agilex_hps_h2f_axi_master_rd_limiter_rsp_src_data;          // agilex_hps_h2f_axi_master_rd_limiter:rsp_src_data -> agilex_hps_h2f_axi_master_agent:read_rp_data
	...
	wire          cmd_mux_src_valid;                                          // cmd_mux:src_valid -> ram_controller_1_csr_burst_adapter:sink0_valid
	wire  [132:0] cmd_mux_src_data;                                           // cmd_mux:src_data -> ram_controller_1_csr_burst_adapter:sink0_data
	wire          cmd_mux_src_ready;                                          // ram_controller_1_csr_burst_adapter:sink0_ready -> cmd_mux:src_ready
	wire    [2:0] cmd_mux_src_channel;                                        // cmd_mux:src_channel -> ram_controller_1_csr_burst_adapter:sink0_channel
	wire          cmd_mux_src_startofpacket;                                  // cmd_mux:src_startofpacket -> ram_controller_1_csr_burst_adapter:sink0_startofpacket
	wire          cmd_mux_src_endofpacket;                                    // cmd_mux:src_endofpacket -> ram_controller_1_csr_burst_adapter:sink0_endofpacket
	...
	wire  [132:0] ram_controller_1_csr_burst_adapter_source0_data;            // ram_controller_1_csr_burst_adapter:source0_data -> ram_controller_1_csr_agent:cp_data
	...
	wire          cmd_mux_001_src_valid;                                      // cmd_mux_001:src_valid -> prbs_generator_1_csr_burst_adapter:sink0_valid
	wire  [132:0] cmd_mux_001_src_data;                                       // cmd_mux_001:src_data -> prbs_generator_1_csr_burst_adapter:sink0_data
	wire          cmd_mux_001_src_ready;                                      // prbs_generator_1_csr_burst_adapter:sink0_ready -> cmd_mux_001:src_ready
	wire    [2:0] cmd_mux_001_src_channel;                                    // cmd_mux_001:src_channel -> prbs_generator_1_csr_burst_adapter:sink0_channel
	wire          cmd_mux_001_src_startofpacket;                              // cmd_mux_001:src_startofpacket -> prbs_generator_1_csr_burst_adapter:sink0_startofpacket
	wire          cmd_mux_001_src_endofpacket;                                // cmd_mux_001:src_endofpacket -> prbs_generator_1_csr_burst_adapter:sink0_endofpacket
	...
	wire  [132:0] prbs_generator_1_csr_burst_adapter_source0_data;            // prbs_generator_1_csr_burst_adapter:source0_data -> prbs_generator_1_csr_agent:cp_data
	...
	wire  [132:0] cmd_mux_002_src_data;                                       // cmd_mux_002:src_data -> pio_0_s1_burst_adapter:sink0_data
	...
	wire  [132:0] pio_0_s1_burst_adapter_source0_data;                        // pio_0_s1_burst_adapter:source0_data -> pio_0_s1_agent:cp_data
	...
	qsys_top_r1_altera_merlin_axi_translator_1921_uetfduq #(
		...
		.m0_wdata    (agilex_hps_h2f_axi_master_translator_m0_wdata),                               //  output,  width = 32,          .wdata
		.m0_wstrb    (agilex_hps_h2f_axi_master_translator_m0_wstrb),                               //  output,   width = 4,          .wstrb
		...
		.m0_rdata    (agilex_hps_h2f_axi_master_translator_m0_rdata),                               //   input,  width = 32,          .rdata
		...
		.s0_wdata    (agilex_hps_h2f_axi_master_wdata),                                             //   input,  width = 32,          .wdata
		.s0_wstrb    (agilex_hps_h2f_axi_master_wstrb),                                             //   input,   width = 4,          .wstrb
		...
		.s0_rdata    (agilex_hps_h2f_axi_master_rdata),                                             //  output,  width = 32,          .rdata
	...
	qsys_top_r1_altera_merlin_slave_translator_191_x56fcki #(
		.AV_ADDRESS_W                   (3),
		.AV_DATA_W                      (32),
		.UAV_DATA_W                     (32),
		.AV_BURSTCOUNT_W                (1),
	...
	qsys_top_r1_altera_merlin_axi_master_ni_1941_dfsyzvi #(
		...
		.write_cp_data          (agilex_hps_h2f_axi_master_agent_write_cp_data),                               //  output,  width = 133,                 .data
		...
		.write_rp_data          (agilex_hps_h2f_axi_master_wr_limiter_rsp_src_data),                           //   input,  width = 133,                 .data
		...
		.read_cp_data           (agilex_hps_h2f_axi_master_agent_read_cp_data),                                //  output,  width = 133,                 .data
		...
		.read_rp_data           (agilex_hps_h2f_axi_master_rd_limiter_rsp_src_data),                           //   input,  width = 133,                 .data
		...
		.wdata                  (agilex_hps_h2f_axi_master_translator_m0_wdata),                               //   input,   width = 32,                 .wdata
		.wstrb                  (agilex_hps_h2f_axi_master_translator_m0_wstrb),                               //   input,    width = 4,                 .wstrb
		...
		.rdata                  (agilex_hps_h2f_axi_master_translator_m0_rdata),                               //  output,   width = 32,                 .rdata
	...
	qsys_top_r1_altera_merlin_slave_agent_191_ncfkfri #(
		.PKT_ORI_BURST_SIZE_H      (123),
		.PKT_ORI_BURST_SIZE_L      (121),
		.PKT_RESPONSE_STATUS_H     (120),
		.PKT_RESPONSE_STATUS_L     (119),
		...
		.rp_data                 (ram_controller_1_csr_agent_rp_data),                                         //  output,  width = 133,                .data
		...
		.cp_data                 (ram_controller_1_csr_burst_adapter_source0_data),                            //   input,  width = 133,                .data
		...
		.rf_sink_data            (ram_controller_1_csr_agent_rsp_fifo_out_data),                               //   input,  width = 134,                .data
		...
		.rf_source_data          (ram_controller_1_csr_agent_rf_source_data),                                  //  output,  width = 134,                .data
	...
	qsys_top_r1_altera_avalon_sc_fifo_1931_vhmcgqy #(
		.SYMBOLS_PER_BEAT    (1),
		.BITS_PER_SYMBOL     (134),
		.FIFO_DEPTH          (2),
		.CHANNEL_WIDTH       (0),
		...
		.in_data           (ram_controller_1_csr_agent_rf_source_data),             //   input,  width = 134,        in.data
		...
		.out_data          (ram_controller_1_csr_agent_rsp_fifo_out_data),          //  output,  width = 134,       out.data
	...
	qsys_top_r1_altera_merlin_slave_agent_191_ncfkfri #(
		...
		.rp_data                 (prbs_generator_1_csr_agent_rp_data),                                         //  output,  width = 133,                .data
		...
		.cp_data                 (prbs_generator_1_csr_burst_adapter_source0_data),                            //   input,  width = 133,                .data
		...
		.rf_sink_data            (prbs_generator_1_csr_agent_rsp_fifo_out_data),                               //   input,  width = 134,                .data
		...
		.rf_source_data          (prbs_generator_1_csr_agent_rf_source_data),                                  //  output,  width = 134,                .data
	...
	qsys_top_r1_altera_avalon_sc_fifo_1931_vhmcgqy #(
		...
		.clk               (clk_100_out_clk_clk),                                   //   input,    width = 1,       clk.clk
		.reset             (agilex_hps_h2f_axi_reset_reset_bridge_in_reset_reset),  //   input,    width = 1, clk_reset.reset
		.in_data           (prbs_generator_1_csr_agent_rf_source_data),             //   input,  width = 134,        in.data
		...
		.out_data          (prbs_generator_1_csr_agent_rsp_fifo_out_data),          //  output,  width = 134,       out.data
	...
	qsys_top_r1_altera_merlin_slave_agent_191_ncfkfri #(
		...
		.rp_data                 (pio_0_s1_agent_rp_data),                                                     //  output,  width = 133,                .data
		...
		.cp_data                 (pio_0_s1_burst_adapter_source0_data),                                        //   input,  width = 133,                .data
		...
		.rf_sink_data            (pio_0_s1_agent_rsp_fifo_out_data),                                           //   input,  width = 134,                .data
		...
		.rf_source_data          (pio_0_s1_agent_rf_source_data),                                              //  output,  width = 134,                .data
	...
	qsys_top_r1_altera_avalon_sc_fifo_1931_vhmcgqy #(
		...
		.clk               (clk_100_out_clk_clk),                                  //   input,    width = 1,       clk.clk
		.reset             (agilex_hps_h2f_axi_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
		.in_data           (pio_0_s1_agent_rf_source_data),                        //   input,  width = 134,        in.data
		...
		.out_data          (pio_0_s1_agent_rsp_fifo_out_data),                     //  output,  width = 134,       out.data
	...
	qsys_top_r1_altera_merlin_router_1921_tgshxyy router (
		...
		.sink_data          (agilex_hps_h2f_axi_master_agent_write_cp_data),                              //   input,  width = 133,          .data
		...
		.src_data           (router_src_data),                                                            //  output,  width = 133,          .data
		.src_channel        (router_src_channel),                                                         //  output,    width = 3,          .channel
		.src_startofpacket  (router_src_startofpacket),                                                   //  output,    width = 1,          .startofpacket
		.src_endofpacket    (router_src_endofpacket)                                                      //  output,    width = 1,          .endofpacket
	);

	qsys_top_r1_altera_merlin_router_1921_tgshxyy router_001 (
		...
		.sink_data          (agilex_hps_h2f_axi_master_agent_read_cp_data),                               //   input,  width = 133,          .data
		...
		.src_data           (router_001_src_data),                                                        //  output,  width = 133,          .data
		.src_channel        (router_001_src_channel),                                                     //  output,    width = 3,          .channel
		.src_startofpacket  (router_001_src_startofpacket),                                               //  output,    width = 1,          .startofpacket
		.src_endofpacket    (router_001_src_endofpacket)                                                  //  output,    width = 1,          .endofpacket
	);

	qsys_top_r1_altera_merlin_router_1921_yx72a5q router_002 (
		...
		.sink_data          (ram_controller_1_csr_agent_rp_data),                                         //   input,  width = 133,          .data
		...
		.src_data           (router_002_src_data),                                                        //  output,  width = 133,          .data
		.src_channel        (router_002_src_channel),                                                     //  output,    width = 3,          .channel
		.src_startofpacket  (router_002_src_startofpacket),                                               //  output,    width = 1,          .startofpacket
		.src_endofpacket    (router_002_src_endofpacket)                                                  //  output,    width = 1,          .endofpacket
	);

	qsys_top_r1_altera_merlin_router_1921_yx72a5q router_003 (
		...
		.sink_data          (prbs_generator_1_csr_agent_rp_data),                                         //   input,  width = 133,          .data
		...
		.src_data           (router_003_src_data),                                                        //  output,  width = 133,          .data
	...
	qsys_top_r1_altera_merlin_router_1921_yx72a5q router_004 (
		...
		.src_data           (router_004_src_data),                                                        //  output,  width = 133,          .data
	...
	qsys_top_r1_altera_merlin_traffic_limiter_191_6blplji #(
		.SYNC_RESET                (1),
		.PKT_DEST_ID_H             (107),
		.PKT_DEST_ID_L             (106),
		.PKT_SRC_ID_H              (105),
		...
		.cmd_sink_data          (router_src_data),                                                            //   input,  width = 133,          .data
		...
		.cmd_src_data           (agilex_hps_h2f_axi_master_wr_limiter_cmd_src_data),                          //  output,  width = 133,          .data
		...
		.rsp_sink_data          (rsp_mux_src_data),                                                           //   input,  width = 133,          .data
		...
		.rsp_src_data           (agilex_hps_h2f_axi_master_wr_limiter_rsp_src_data),                          //  output,  width = 133,          .data
	...
	qsys_top_r1_altera_merlin_traffic_limiter_191_6blplji #(
		...
		.cmd_sink_data          (router_001_src_data),                                                        //   input,  width = 133,          .data
		...
		.cmd_src_data           (agilex_hps_h2f_axi_master_rd_limiter_cmd_src_data),                          //  output,  width = 133,          .data
		...
		.rsp_sink_data          (rsp_mux_001_src_data),                                                       //   input,  width = 133,          .data
		...
		.rsp_src_data           (agilex_hps_h2f_axi_master_rd_limiter_rsp_src_data),                          //  output,  width = 133,          .data
	...
	qsys_top_r1_altera_merlin_burst_adapter_1923_lovcyaa #(
		.PKT_ADDR_H                (67),
		.PKT_ADDR_L                (36),
		.PKT_BEGIN_BURST           (99),
		.PKT_BYTE_CNT_H            (84),
		...
		.sink0_data            (cmd_mux_src_data),                                                           //   input,  width = 133,          .data
		...
		.source0_data          (ram_controller_1_csr_burst_adapter_source0_data),                            //  output,  width = 133,          .data
	...
	qsys_top_r1_altera_merlin_burst_adapter_1923_lovcyaa #(
		...
		.sink0_data            (cmd_mux_001_src_data),                                                       //   input,  width = 133,          .data
		...
		.source0_data          (prbs_generator_1_csr_burst_adapter_source0_data),                            //  output,  width = 133,          .data
	...
	qsys_top_r1_altera_merlin_burst_adapter_1923_lovcyaa #(
		...
		.sink0_data            (cmd_mux_002_src_data),                                                       //   input,  width = 133,          .data
		...
		.source0_data          (pio_0_s1_burst_adapter_source0_data),                                        //  output,  width = 133,          .data
	...
	qsys_top_r1_altera_merlin_demultiplexer_1921_3ub3axq cmd_demux (
		.clk                (clk_100_out_clk_clk),                                                        //   input,    width = 1,        clk.clk
		.reset              (agilex_hps_h2f_axi_master_translator_clk_reset_reset_bridge_in_reset_reset), //   input,    width = 1,  clk_reset.reset
		...
		.sink_data          (agilex_hps_h2f_axi_master_wr_limiter_cmd_src_data),                          //   input,  width = 133,           .data
		...
		.src2_data          (cmd_demux_src2_data),                                                        //  output,  width = 133,           .data
	...
	qsys_top_r1_altera_merlin_demultiplexer_1921_3ub3axq cmd_demux_001 (
		.clk                (clk_100_out_clk_clk),                                                        //   input,    width = 1,        clk.clk
		.reset              (agilex_hps_h2f_axi_master_translator_clk_reset_reset_bridge_in_reset_reset), //   input,    width = 1,  clk_reset.reset
		...
		.sink_data          (agilex_hps_h2f_axi_master_rd_limiter_cmd_src_data),                          //   input,  width = 133,           .data
		...
		.src0_data          (cmd_demux_001_src0_data),                                                    //  output,  width = 133,           .data
		...
		.src1_data          (cmd_demux_001_src1_data),                                                    //  output,  width = 133,           .data
		...
		.src2_data          (cmd_demux_001_src2_data),                                                    //  output,  width = 133,           .data
	...
	qsys_top_r1_altera_merlin_multiplexer_1921_zybekxy cmd_mux (
		.clk                 (clk_100_out_clk_clk),                                                        //   input,    width = 1,       clk.clk
		.reset               (agilex_hps_h2f_axi_master_translator_clk_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
		.src_ready           (cmd_mux_src_ready),                                                          //   input,    width = 1,       src.ready
		.src_valid           (cmd_mux_src_valid),                                                          //  output,    width = 1,          .valid
		.src_data            (cmd_mux_src_data),                                                           //  output,  width = 133,          .data
		...
		.sink0_data          (cmd_demux_src0_data),                                                        //   input,  width = 133,          .data
		...
		.sink1_data          (cmd_demux_001_src0_data),                                                    //   input,  width = 133,          .data
	...
	qsys_top_r1_altera_merlin_multiplexer_1921_zybekxy cmd_mux_001 (
		.clk                 (clk_100_out_clk_clk),                                                        //   input,    width = 1,       clk.clk
		.reset               (agilex_hps_h2f_axi_master_translator_clk_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
		.src_ready           (cmd_mux_001_src_ready),                                                      //   input,    width = 1,       src.ready
		.src_valid           (cmd_mux_001_src_valid),                                                      //  output,    width = 1,          .valid
		.src_data            (cmd_mux_001_src_data),                                                       //  output,  width = 133,          .data
		...
		.sink0_data          (cmd_demux_src1_data),                                                        //   input,  width = 133,          .data
		...
		.sink1_data          (cmd_demux_001_src1_data),                                                    //   input,  width = 133,          .data
	...
	qsys_top_r1_altera_merlin_multiplexer_1921_zybekxy cmd_mux_002 (
		.clk                 (clk_100_out_clk_clk),                                                        //   input,    width = 1,       clk.clk
		.reset               (agilex_hps_h2f_axi_master_translator_clk_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
		.src_ready           (cmd_mux_002_src_ready),                                                      //   input,    width = 1,       src.ready
		.src_valid           (cmd_mux_002_src_valid),                                                      //  output,    width = 1,          .valid
		.src_data            (cmd_mux_002_src_data),                                                       //  output,  width = 133,          .data
		...
		.sink0_data          (cmd_demux_src2_data),                                                        //   input,  width = 133,          .data
		...
		.sink1_data          (cmd_demux_001_src2_data),                                                    //   input,  width = 133,          .data
	...
	qsys_top_r1_altera_merlin_demultiplexer_1921_o2qhgby rsp_demux (
		...
		.src0_data          (rsp_demux_src0_data),                                                        //  output,  width = 133,          .data
		...
		.src1_data          (rsp_demux_src1_data),                                                        //  output,  width = 133,          .data
	...
	qsys_top_r1_altera_merlin_demultiplexer_1921_o2qhgby rsp_demux_001 (
		.clk                (clk_100_out_clk_clk),                                                        //   input,    width = 1,       clk.clk
		.reset              (agilex_hps_h2f_axi_master_translator_clk_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
		.sink_ready         (router_003_src_ready),                                                       //  output,    width = 1,      sink.ready
		.sink_channel       (router_003_src_channel),                                                     //   input,    width = 3,          .channel
		.sink_data          (router_003_src_data),                                                        //   input,  width = 133,          .data
		...
		.src0_data          (rsp_demux_001_src0_data),                                                    //  output,  width = 133,          .data
		...
		.src1_data          (rsp_demux_001_src1_data),                                                    //  output,  width = 133,          .data
	...
	qsys_top_r1_altera_merlin_demultiplexer_1921_o2qhgby rsp_demux_002 (
		.clk                (clk_100_out_clk_clk),                                                        //   input,    width = 1,       clk.clk
		.reset              (agilex_hps_h2f_axi_master_translator_clk_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
		.sink_ready         (router_004_src_ready),                                                       //  output,    width = 1,      sink.ready
		.sink_channel       (router_004_src_channel),                                                     //   input,    width = 3,          .channel
		.sink_data          (router_004_src_data),                                                        //   input,  width = 133,          .data
		...
		.src0_data          (rsp_demux_002_src0_data),                                                    //  output,  width = 133,          .data
		...
		.src1_data          (rsp_demux_002_src1_data),                                                    //  output,  width = 133,          .data
	...
	qsys_top_r1_altera_merlin_multiplexer_1921_3szlfoa rsp_mux (
		.clk                 (clk_100_out_clk_clk),                                                        //   input,    width = 1,       clk.clk
		.reset               (agilex_hps_h2f_axi_master_translator_clk_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
		.src_ready           (rsp_mux_src_ready),                                                          //   input,    width = 1,       src.ready
		.src_valid           (rsp_mux_src_valid),                                                          //  output,    width = 1,          .valid
		.src_data            (rsp_mux_src_data),                                                           //  output,  width = 133,          .data
		...
		.sink0_data          (rsp_demux_src0_data),                                                        //   input,  width = 133,          .data
		...
		.sink1_data          (rsp_demux_001_src0_data),                                                    //   input,  width = 133,          .data
		...
		.sink2_data          (rsp_demux_002_src0_data),                                                    //   input,  width = 133,          .data
	...
	qsys_top_r1_altera_merlin_multiplexer_1921_3szlfoa rsp_mux_001 (
		.clk                 (clk_100_out_clk_clk),                                                        //   input,    width = 1,       clk.clk
		.reset               (agilex_hps_h2f_axi_master_translator_clk_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
		.src_ready           (rsp_mux_001_src_ready),                                                      //   input,    width = 1,       src.ready
		.src_valid           (rsp_mux_001_src_valid),                                                      //  output,    width = 1,          .valid
		.src_data            (rsp_mux_001_src_data),                                                       //  output,  width = 133,          .data
		...
		.sink0_data          (rsp_demux_src1_data),                                                        //   input,  width = 133,          .data
		...
		.sink1_data          (rsp_demux_001_src1_data),                                                    //   input,  width = 133,          .data
		...
		.sink2_data          (rsp_demux_002_src1_data),                                                    //   input,  width = 133,          .data
